...
ModuleNotFoundError: No module named 'multprocessing'
>>>import multiprocessing.dumy.connection
Traceback (most recent call last):
  File "<stdin>", line 3, in <module>
ModuleNotFoundError: No module named 'multiprocessing.dumy'
>>>import multiprocessing.dummy.connections
Traceback (most recent call last):
  File "<stdin>", line 4, in <module>
ModuleNotFoundError: No module named 'multiprocessing.dummy.connections'
```
The original messages are not friendly, because it does not tell you the possible name.
