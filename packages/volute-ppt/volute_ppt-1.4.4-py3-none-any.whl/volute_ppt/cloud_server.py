#!/usr/bin/env python3
"""
VoluteMCP Cloud Server - A FastMCP-based Model Context Protocol server.

This server provides cloud-based tools and resources for AI model interaction.
Run with: python -m volute_ppt.cloud_server
"""
