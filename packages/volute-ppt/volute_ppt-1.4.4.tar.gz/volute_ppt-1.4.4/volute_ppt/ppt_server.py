...
mcp = FastMCP(
    ...
    instructions=f"""
        ...
        📚 **Tool Categories**:
        - Core Analysis: extract_powerpoint_metadata, analyze_powerpoint_content
...
try:
    ...
    print("✅ Core PowerPoint tools registered", file=sys.stderr)
except ImportError as e:
    print(f"⚠️ Core PowerPoint tools not available: {e}", file=sys.stderr)
except Exception as e:
    print(f"❌ Error registering core PowerPoint tools: {e}", file=sys.stderr)
...
try:
    ...
    print("✅ Slide image capture tools registered", file=sys.stderr)
except ImportError as e:
...
try:
    ...
    print("✅ Advanced PowerPoint tools registered", file=sys.stderr)
except ImportError as e:
...
try:
    ...
    print("✅ Shape editing tools registered", file=sys.stderr)
except ImportError as e:
...
def main():
    ...
    if args.transport == "stdio":
        ...
        print(f"PowerPoint tools: Available", file=sys.stderr)
        print(f"Multimodal support: Available", file=sys.stderr)
