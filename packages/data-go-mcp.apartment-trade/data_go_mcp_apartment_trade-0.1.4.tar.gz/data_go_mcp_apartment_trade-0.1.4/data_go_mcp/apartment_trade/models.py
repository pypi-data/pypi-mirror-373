...
class ApartmentTradeItem(BaseModel):
    """Individual apartment trade record - 상세 자료"""
    
    # 지역 코드
    sgg_cd: Optional[str] = Field(None, alias="sggCd", description="시군구 코드")
    umd_cd: Optional[str] = Field(None, alias="umdCd", description="읍면동 코드")
    land_cd: Optional[str] = Field(None, alias="landCd", description="지번 코드")
    ...
    apt_seq: Optional[str] = Field(None, alias="aptSeq", description="아파트 일련번호")
    jibun: Optional[str] = Field(None, alias="jibun", description="지번")
    bonbun: Optional[str] = Field(None, alias="bonbun", description="본번")
    bubun: Optional[str] = Field(None, alias="bubun", description="부번")
    
    # 도로명 주소
    road_nm: Optional[str] = Field(None, alias="roadNm", description="도로명")
    road_nm_sgg_cd: Optional[str] = Field(None, alias="roadNmSggCd", description="도로명 시군구 코드")
    road_nm_cd: Optional[str] = Field(None, alias="roadNmCd", description="도로명 코드")
    road_nm_seq: Optional[str] = Field(None, alias="roadNmSeq", description="도로명 일련번호")
    road_nmb_cd: Optional[str] = Field(None, alias="roadNmbCd", description="도로명 건물 코드")
    road_nm_bonbun: Optional[str] = Field(None, alias="roadNmBonbun", description="도로명 건물 본번")
    road_nm_bubun: Optional[str] = Field(None, alias="roadNmBubun", description="도로명 건물 부번")
