...
async def completion(params: CompletionParams) -> CompletionList:
    ...
    try:
        ...
        # Convert to inlineCompletion request using proper LSP types
        from lsprotocol.types import InlineCompletionParams, InlineCompletionContext, InlineCompletionTriggerKind
