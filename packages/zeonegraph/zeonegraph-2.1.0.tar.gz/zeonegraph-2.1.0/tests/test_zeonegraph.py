...
dbname = os.environ.get('ZEONEGRAPH_TESTDB', 'zeonegraph_test')
dbhost = os.environ.get('ZEONEGRAPH_TESTDB_HOST', None)
dbport = os.environ.get('ZEONEGRAPH_TESTDB_PORT', None)
dbuser = os.environ.get('ZEONEGRAPH_TESTDB_USER', None)
dbpass = os.environ.get('ZEONEGRAPH_TESTDB_PASSWORD', None)
...
class TestParam(TestConnection):
    def setUp(self):
        ...
        self.name = "'Zeone\"Graph'"

    def test_param_dict(self):
        d = {'name': self.name, 'since': 2016}
        p = zeonegraph.Property(d)
    ...
    def test_param_list_and_tuple(self):
        a = [self.name, 2016]
        t = (self.name, 2016)
        pa = zeonegraph.Property(a)
        pt = zeonegraph.Property(t)
