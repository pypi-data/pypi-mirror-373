...
def entrypoint(tag: Optional[str] = None, capture: Optional[str] = None, attrs: Optional[Dict[str, str]] = None) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        # Preserve the original function signature completely for FastAPI compatibility
        if inspect.iscoroutinefunction(fn):
            ...
            # Preserve ALL function metadata that FastAPI needs for complex signatures
            ...
            # Critical: Preserve the original function for FastAPI inspection
