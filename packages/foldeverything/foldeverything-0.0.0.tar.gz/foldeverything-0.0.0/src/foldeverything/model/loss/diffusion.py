...
# testing
# from foldeverything.model.modules.utils import random_rotations
# x = torch.randn(2, 10, 3)
# w = torch.ones(2, 10)
# mask = torch.ones(2, 10)

# random_rot = random_rotations(2)
# x_rotated = torch.bmm(x, random_rot)
# out = weighted_rigid_align(x_rotated, x, w, mask)
# assert torch.allclose(out, x)

# x_reflected = x * torch.tensor([1, -1, 1])
# out = weighted_rigid_align(x_reflected, x, w, mask)
