...
class Validator(nn.Module):
    ...
    def __init__(
        self, val_names: List[str], confidence_prediction: bool = False,override_val_method: Optional[str] = None,
        ...
        for idx_dataset in range(self.num_val_datasets):
            ...
            for m_ in [
                *const.out_types,
                ...
                m = m_ + ":recall"
                avg_lddt[idx_dataset][m] = self.folding_metrics["lddt"][idx_dataset][
                    m
                ].compute()
