...
from foldeverything.model.layers import initialize
from foldeverything.model.openfold.openfold_utils import (
    flatten_final_dims,
    is_fp16_enabled,
    permute_final_dims,
)
...
if fa_is_installed:
    ...
    try:
        ...
        warnings.warn(
            f"flash-attention v{fa_version} is installed but lacks required symbols: "
            f"{e}. Disabling flash attention."
        )
