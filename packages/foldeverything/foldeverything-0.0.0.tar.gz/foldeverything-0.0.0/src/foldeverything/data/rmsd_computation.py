...
from foldeverything.data.mol import minimum_lddt_symmetry_coords
from foldeverything.model.loss.validation import weighted_minimum_rmsd
...
def get_true_coordinates(
    ...
    if (
        symmetry_correction
        and batch["has_structure"].sum() == batch["has_structure"].shape[0]
    ):
        ...
        true_coords_resolved_mask = batch["atom_resolved_mask"] * batch["has_structure"]
        ...
        if protein_lig_rmsd:
            ...
            return_dict["rmsd_prot"] = rmsd_prot
            return_dict["best_rmsd_prot"] = best_rmsd_prot
            return_dict["rmsd_lig"] = rmsd_lig
            return_dict["best_rmsd_lig"] = best_rmsd_lig
