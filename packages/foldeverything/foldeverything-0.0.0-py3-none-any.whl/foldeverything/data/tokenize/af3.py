...
from foldeverything.data.const import (
    ...
    def tokenize(
        ...
        for chain in chains:
            ...
            for res_index_local, res in enumerate(struct.residues[res_start:res_end]):
                ...
                # Get min ligand distance
                if (struct.pocket is not None) and (struct.pocket.shape[0] > 0):
                    min_dist_ligand = (
                        struct.pocket[atom_start:atom_end]["min_dist_ligand"]
                        .min()
                        .item()
                    )
                else:
                ...
                if res["is_standard"]:
                    ...
                    token = TokenData(
                        ...
                        min_dist_ligand=min_dist_ligand,
