...
class AlertRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["severity", "created_at", "check_name", "channel_ids", "condition", "name", "condition_parameters", "check_id", "auto_resolve", "updated_at", "channels", "cooldown_period", "id", "enabled"]
