...
class ExcelDataWorkbook:
    ...
    @overload
    def get_cell(self, worksheet_index: int, row: int, column: int) -> aspose.slides.excel.IExcelDataCell:
    ...
    @overload
    def get_cell(self, worksheet_name: str, row: int, column: int) -> aspose.slides.excel.IExcelDataCell:
    ...
    @overload
    def get_cell(self, worksheet_index: int, cell_name: str) -> aspose.slides.excel.IExcelDataCell:
    ...
    @overload
    def get_cell(self, worksheet_name: str, cell_name: str) -> aspose.slides.excel.IExcelDataCell:
    ...
    def get_cells(self, formula: str, skip_hidden_cells: bool) -> System.Collections.ObjectModel.ReadOnlyCollection`1[[Aspose.Slides.Excel.IExcelDataCell]]:
        ...

    def get_charts_from_worksheet(self, worksheet_name: str) -> System.Collections.Generic.IList`1[[Aspose.Slides.PositionedString]]:
    ...
    def get_worksheet_names(self) -> System.Collections.Generic.IList`1[[System.String]]:
