...
class IAIWebClient:
    def create_conversation(self) -> aspose.slides.ai.IAIConversation:
        ...
...
class SlidesAIAgent:
    ...
    def __init__(self, ai_client: aspose.slides.ai.IAIWebClient):
        '''SlidesAIAgent constructor'''
        ...

    @overload
    def generate_presentation(self, description: str, presentation_content_amount: aspose.slides.ai.PresentationContentAmountType) -> aspose.slides.IPresentation:
    ...
    @overload
    def generate_presentation(self, description: str, presentation_content_amount: aspose.slides.ai.PresentationContentAmountType, presentation_template: aspose.slides.IPresentation) -> aspose.slides.IPresentation:
        '''Generates a presentation instance from a text description. Provide a topic, ideas, quotes, or text snippets in the required language.
        :param description: The topic, ideas, quotes, or text snippets.
        :param presentation_content_amount: The amount of content in the resulting presentation.
    ...
    def translate(self, presentation: aspose.slides.IPresentation, language: str) -> None:
