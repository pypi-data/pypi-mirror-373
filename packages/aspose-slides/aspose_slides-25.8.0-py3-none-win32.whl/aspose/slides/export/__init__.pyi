...
class EmbedAllFontsHtmlController:
    ...
    def write_document_start(self, generator: aspose.slides.export.IHtmlGenerator, presentation: aspose.slides.IPresentation) -> None:
    ...
    def write_document_end(self, generator: aspose.slides.export.IHtmlGenerator, presentation: aspose.slides.IPresentation) -> None:
        '''Called to write html document footer. Called once per presentation conversion.
        :param generator: Output object.
        :param presentation: Presentation which being currently rendered.'''
        ...

    def write_slide_start(self, generator: aspose.slides.export.IHtmlGenerator, slide: aspose.slides.ISlide) -> None:
        '''Called to write html slide header. Called once per each of slides.
        :param generator: Output object.
        :param slide: Slide which being currently rendered.'''
        ...

    def write_slide_end(self, generator: aspose.slides.export.IHtmlGenerator, slide: aspose.slides.ISlide) -> None:
        '''Called to write html slide footer. Called once per each of slides.
        :param generator: Output object.
        :param slide: Slide which being currently rendered.'''
        ...

    def write_shape_start(self, generator: aspose.slides.export.IHtmlGenerator, shape: aspose.slides.IShape) -> None:
    ...
    def write_shape_end(self, generator: aspose.slides.export.IHtmlGenerator, shape: aspose.slides.IShape) -> None:
        '''Called before shape's rendering. Called once per each of shape. If this function writes anything to generator, current slide image generation will be finished, added html fragment inserted and new image will be started atop of the previous.
        :param generator: Output object.
        :param shape: Shape which is rendered last.'''
        ...

    def write_all_fonts(self, generator: aspose.slides.export.IHtmlGenerator, presentation: aspose.slides.IPresentation) -> None:
        '''Write all fonts contained in :py:class:`aspose.slides.Presentation`.
        :param generator: Output object.
        :param presentation: Presentation which being currently rendered.'''
        ...

    def write_font(self, generator: aspose.slides.export.IHtmlGenerator, original_font: aspose.slides.IFontData, substituted_font: aspose.slides.IFontData, font_style: str, font_weight: str, font_data: bytes) -> None:
...
class EmbeddedEotFontsHtmlController:
    ...
    def __init__(self, controller: aspose.slides.export.IHtmlFormattingController):
        '''Creates new instance.
...
class EnumerableFrameArgs:
    ...
    def get_frame(self) -> aspose.slides.IImage:
        '''Get the current :py:class:`aspose.slides.export.PresentationEnumerableFramesGenerator` frame.'''
        ...

    @property
    def frames_generator(self) -> aspose.slides.export.PresentationEnumerableFramesGenerator:
        ...
...
class FrameTickEventArgs:
    ...
    @property
    def player(self) -> aspose.slides.export.PresentationPlayer:
...
class GifOptions(SaveOptions):
    ...
    @property
    def progress_callback(self) -> aspose.slides.IProgressCallback:
        ...

    @progress_callback.setter
    def progress_callback(self, value: aspose.slides.IProgressCallback):
        ...
    ...
    @property
    def gradient_style(self) -> aspose.slides.GradientStyle:
        ...

    @gradient_style.setter
    def gradient_style(self, value: aspose.slides.GradientStyle):
        ...
...
class Html5Options(SaveOptions):
    ...
    @property
    def notes_comments_layouting(self) -> aspose.slides.export.INotesCommentsLayoutingOptions:
        ...

    @notes_comments_layouting.setter
    def notes_comments_layouting(self, value: aspose.slides.export.INotesCommentsLayoutingOptions):
        ...
    ...
    @property
    def slides_layout_options(self) -> aspose.slides.export.ISlidesLayoutOptions:
        ...

    @slides_layout_options.setter
    def slides_layout_options(self, value: aspose.slides.export.ISlidesLayoutOptions):
        ...
...
class HtmlFormatter:
    ...
    @staticmethod
    def create_document_formatter(css: str, show_slide_title: bool) -> aspose.slides.export.HtmlFormatter:
    ...
    @staticmethod
    def create_slide_show_formatter(css: str, show_slide_title: bool) -> aspose.slides.export.HtmlFormatter:
    ...
    @staticmethod
    def create_custom_formatter(formatting_controller: aspose.slides.export.IHtmlFormattingController) -> aspose.slides.export.HtmlFormatter:
...
class HtmlGenerator:
    ...
    @overload
    def add_html(self, html: List[System.Char]) -> None:
        '''Adds formatted HTML text.
        :param html: Text to add.'''
        ...

    @overload
    def add_html(self, html: List[System.Char], start_index: int, length: int) -> None:
        '''Adds formatted HTML text.
        :param html: Text to add.
    ...
    @overload
    def add_text(self, text: List[System.Char]) -> None:
        '''Adds plain text to the html files, replacing special characters with html entities.
                    Linebreaks and whitespaces aren't replaced.
        :param text: Text to add.'''
        ...
    ...
    @overload
    def add_text(self, text: List[System.Char], start_index: int, length: int) -> None:
        '''Adds plain text to the html files, replacing special characters with html entities.
                    Linebreaks and whitespaces aren't replaced.
        :param text: Text to add.
        :param start_index: Start index of the portion to add.
    ...
    @overload
    def add_attribute_value(self, value: List[System.Char]) -> None:
        '''Quotes attribute value and adds it to the html file.
        :param value: Attribute value string.'''
        ...

    @overload
    def add_attribute_value(self, value: List[System.Char], start_index: int, length: int) -> None:
        '''Quotes attribute value and adds it to the html file.
        :param value: Attribute value string.
        :param start_index: Start index of the portion to add.
        :param length: Length of the portion to add.'''
    ...
    @property
    def slide_image_size_unit(self) -> aspose.slides.export.SvgCoordinateUnit:
        ...
...
class HtmlOptions(SaveOptions):
    ...
    def __init__(self, link_embed_controller: aspose.slides.export.ILinkEmbedController):
    ...
    @property
    def ink_options(self) -> aspose.slides.export.IInkOptions:
        ...
    ...
    @property
    def html_formatter(self) -> aspose.slides.export.IHtmlFormatter:
        ...

    @html_formatter.setter
    def html_formatter(self, value: aspose.slides.export.IHtmlFormatter):
        ...
    ...
    @property
    def slide_image_format(self) -> aspose.slides.export.ISlideImageFormat:
        ...

    @slide_image_format.setter
    def slide_image_format(self, value: aspose.slides.export.ISlideImageFormat):
        ...
    ...
    @property
    def pictures_compression(self) -> aspose.slides.export.PicturesCompression:
        ...

    @pictures_compression.setter
    def pictures_compression(self, value: aspose.slides.export.PicturesCompression):
        ...
...
class IEmbeddedEotFontsHtmlController:
    ...
    @property
    def as_i_html_formatting_controller(self) -> aspose.slides.export.IHtmlFormattingController:
        ...
...
class IGifOptions:
    ...
    @property
    def as_i_save_options(self) -> aspose.slides.export.ISaveOptions:
        ...
...
class ILinkEmbedController:
    ...
    def get_object_storing_location(self, id: int, entity_data: bytes, semantic_name: str, content_type: str, recomended_extension: str) -> aspose.slides.export.LinkEmbedDecision:
...
class INotesCommentsLayoutingOptions:
    ...
    @property
    def notes_position(self) -> aspose.slides.export.NotesPositions:
        ...

    @notes_position.setter
    def notes_position(self, value: aspose.slides.export.NotesPositions):
        ...

    @property
    def comments_position(self) -> aspose.slides.export.CommentsPositions:
        ...

    @comments_position.setter
    def comments_position(self, value: aspose.slides.export.CommentsPositions):
        ...
...
class IPdfOptions:
    ...
    @property
    def text_compression(self) -> aspose.slides.export.PdfTextCompression:
        ...

    @text_compression.setter
    def text_compression(self, value: aspose.slides.export.PdfTextCompression):
        ...
    ...
    @property
    def compliance(self) -> aspose.slides.export.PdfCompliance:
        '''Desired conformance level for generated PDF document.
                    Read/write :py:enum:`aspose.slides.export.PdfCompliance`.'''
        ...

    @compliance.setter
    def compliance(self, value: aspose.slides.export.PdfCompliance):
        '''Desired conformance level for generated PDF document.
                    Read/write :py:enum:`aspose.slides.export.PdfCompliance`.'''
        ...
    ...
    @property
    def access_permissions(self) -> aspose.slides.export.PdfAccessPermissions:
        ...

    @access_permissions.setter
    def access_permissions(self, value: aspose.slides.export.PdfAccessPermissions):
        ...
...
class IPptOptions:
    ...
    @property
    def root_directory_clsid(self) -> System.Guid:
        ...

    @root_directory_clsid.setter
    def root_directory_clsid(self, value: System.Guid):
        ...
...
class IPptxOptions:
    ...
    @property
    def conformance(self) -> aspose.slides.export.Conformance:
    ...
    @conformance.setter
    def conformance(self, value: aspose.slides.export.Conformance):
        '''Specifies the conformance class to which the Presentation document conforms.
                    Default value is :py:attr:`aspose.slides.export.Conformance.ECMA_376_2006`'''
        ...

    @property
    def zip_64_mode(self) -> aspose.slides.export.Zip64Mode:
        ...

    @zip_64_mode.setter
    def zip_64_mode(self, value: aspose.slides.export.Zip64Mode):
        ...
...
class ISVGOptions:
    ...
    @property
    def shape_formatting_controller(self) -> aspose.slides.export.ISvgShapeFormattingController:
        ...

    @shape_formatting_controller.setter
    def shape_formatting_controller(self, value: aspose.slides.export.ISvgShapeFormattingController):
        ...
    ...
    @property
    def external_fonts_handling(self) -> aspose.slides.export.SvgExternalFontsHandling:
        ...

    @external_fonts_handling.setter
    def external_fonts_handling(self, value: aspose.slides.export.SvgExternalFontsHandling):
        ...
...
class ISaveOptionsFactory:
    ...
    def create_pptx_options(self) -> aspose.slides.export.IPptxOptions:
...
class ISvgShape:
    ...
    def set_event_handler(self, event_type: aspose.slides.export.SvgEvent, handler: str) -> None:
...
class ISvgShapeAndTextFormattingController:
    ...
    def format_text(self, svg_t_span: aspose.slides.export.ISvgTSpan, portion: aspose.slides.IPortion, text_frame: aspose.slides.ITextFrame) -> None:
    ...
    @property
    def as_i_svg_shape_formatting_controller(self) -> aspose.slides.export.ISvgShapeFormattingController:
        ...
...
class ISvgShapeFormattingController:
    ...
    def format_shape(self, svg_shape: aspose.slides.export.ISvgShape, shape: aspose.slides.IShape) -> None:
...
class ITextToHtmlConversionOptions:
    ...
    @property
    def text_inheritance_limit(self) -> aspose.slides.export.TextInheritanceLimit:
        ...

    @text_inheritance_limit.setter
    def text_inheritance_limit(self, value: aspose.slides.export.TextInheritanceLimit):
        ...

    @property
    def link_embed_controller(self) -> aspose.slides.export.ILinkEmbedController:
        ...

    @link_embed_controller.setter
    def link_embed_controller(self, value: aspose.slides.export.ILinkEmbedController):
        ...
...
class ITiffOptions:
    ...
    @property
    def compression_type(self) -> aspose.slides.export.TiffCompressionTypes:
        ...

    @compression_type.setter
    def compression_type(self, value: aspose.slides.export.TiffCompressionTypes):
        ...

    @property
    def pixel_format(self) -> aspose.slides.export.ImagePixelFormat:
        ...

    @pixel_format.setter
    def pixel_format(self, value: aspose.slides.export.ImagePixelFormat):
        ...
    ...
    @property
    def bw_conversion_mode(self) -> aspose.slides.export.BlackWhiteConversionMode:
        ...

    @bw_conversion_mode.setter
    def bw_conversion_mode(self, value: aspose.slides.export.BlackWhiteConversionMode):
        ...
...
class IVideoPlayerHtmlController:
    ...
    @property
    def as_i_link_embed_controller(self) -> aspose.slides.export.ILinkEmbedController:
        ...
...
class IVideoPlayerHtmlControllerFactory:
    ...
    def create_video_player_html_controller(self, path: str, file_name: str, base_uri: str) -> aspose.slides.export.IVideoPlayerHtmlController:
...
class MarkdownSaveOptions(SaveOptions):
    ...
    @property
    def export_type(self) -> aspose.slides.export.MarkdownExportType:
        ...

    @export_type.setter
    def export_type(self, value: aspose.slides.export.MarkdownExportType):
        ...
    ...
    @property
    def new_line_type(self) -> aspose.slides.export.NewLineType:
        ...

    @new_line_type.setter
    def new_line_type(self, value: aspose.slides.export.NewLineType):
        ...
    ...
    @property
    def flavor(self) -> aspose.slides.export.Flavor:
        '''Specifies markdown specification to convert presentation.
                    Default is ``Multi-markdown``.'''
        ...

    @flavor.setter
    def flavor(self, value: aspose.slides.export.Flavor):
        '''Specifies markdown specification to convert presentation.
                    Default is ``Multi-markdown``.'''
        ...
    ...
    @property
    def handle_repeated_spaces(self) -> aspose.slides.export.HandleRepeatedSpaces:
        ...

    @handle_repeated_spaces.setter
    def handle_repeated_spaces(self, value: aspose.slides.export.HandleRepeatedSpaces):
        ...
...
class PresentationAnimationsGenerator:
    ...
    def __init__(self, presentation: aspose.slides.Presentation):
    ...
    def run(self, slides: System.Collections.Generic.IEnumerable`1[[Aspose.Slides.ISlide]]) -> None:
        ...
...
class PresentationEnumerableFramesGenerator:
    '''Represents a generator of the animations in the :py:class:`aspose.slides.Presentation`.'''
    def __init__(self, presentation: aspose.slides.Presentation, fps: float):
    ...
    def enumerate_frames(self, slides: System.Collections.Generic.IEnumerable`1[[Aspose.Slides.ISlide]]) -> System.Collections.Generic.IEnumerable`1[[Aspose.Slides.Export.EnumerableFrameArgs]]:
        ...
...
class PresentationPlayer:
    ...
    def __init__(self, generator: aspose.slides.export.PresentationAnimationsGenerator, fps: float):
        '''Creates new instance of the :py:class:`aspose.slides.export.PresentationPlayer`.
        :param fps: Frames per second (FPS)'''
        ...
...
class SVGOptions(SaveOptions):
    ...
    @classmethod
    @property
    def default(cls) -> aspose.slides.export.SVGOptions:
    ...
    @classmethod
    @property
    def simple(cls) -> aspose.slides.export.SVGOptions:
    ...
    @classmethod
    @property
    def wysiwyg(cls) -> aspose.slides.export.SVGOptions:
...
class SlideImageFormat:
    ...
    @staticmethod
    def svg(options: aspose.slides.export.SVGOptions) -> aspose.slides.export.SlideImageFormat:
        '''Slides should converted to a SVG format.
        :param options: Options for SVG export.'''
        ...

    @staticmethod
    def bitmap(scale: float, img_format: aspose.pydrawing.Imaging.ImageFormat) -> aspose.slides.export.SlideImageFormat:
