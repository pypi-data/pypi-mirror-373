...
class IVbaModuleCollection:
    ...
    def add_empty_module(self, name: str) -> aspose.slides.vba.IVbaModule:
        '''Adds a new empty module to the VBA Project.
        :param name: Name of the module
        :returns: Added module.'''
        ...

    def remove(self, value: aspose.slides.vba.IVbaModule) -> None:
    ...
    def __getitem__(self, key: int) -> aspose.slides.vba.IVbaModule
...
class IVbaProject:
    ...
    @property
    def modules(self) -> aspose.slides.vba.IVbaModuleCollection:
    ...
    @property
    def references(self) -> aspose.slides.vba.IVbaReferenceCollection:
...
class IVbaProjectFactory:
    ...
    def create_vba_project(self) -> aspose.slides.vba.IVbaProject:
        '''Creates new VBA project.
        :returns: New VBA project'''
        ...

    def read_vba_project(self, data: bytes) -> aspose.slides.vba.IVbaProject:
...
class IVbaReferenceCollection:
    ...
    def add(self, value: aspose.slides.vba.IVbaReference) -> None:
    ...
    def __getitem__(self, key: int) -> aspose.slides.vba.IVbaReference
        '''Gets the element at the specified index.'''
        ...
...
class IVbaReferenceFactory:
    ...
    def create_ole_type_lib_reference(self, name: str, libid: str) -> aspose.slides.vba.IVbaReferenceOleTypeLib:
...
class IVbaReferenceOleTwiddledTypeLib:
    ...
    @property
    def as_i_vba_reference(self) -> aspose.slides.vba.IVbaReference:
        ...
...
class VbaProjectFactory:
    ...
    @classmethod
    @property
    def instance(cls) -> aspose.slides.vba.VbaProjectFactory:
...
class VbaReferenceFactory:
    ...
    @classmethod
    @property
    def instance(cls) -> aspose.slides.vba.VbaReferenceFactory:
