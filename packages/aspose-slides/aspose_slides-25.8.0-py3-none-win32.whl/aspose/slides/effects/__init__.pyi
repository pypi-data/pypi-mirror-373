...
class AlphaBiLevel(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaBiLevelEffectiveData:
...
class AlphaCeiling(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaCeilingEffectiveData:
...
class AlphaFloor(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaFloorEffectiveData:
...
class AlphaInverse(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaInverseEffectiveData:
...
class AlphaModulate(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaModulateEffectiveData:
...
class AlphaModulateFixed(ImageTransformOperation):
    '''Represents an Alpha Modulate Fixed effect.
                Effect alpha (opacity) values are multiplied by a fixed percentage.'''
    def get_effective(self) -> aspose.slides.effects.IAlphaModulateFixedEffectiveData:
...
class AlphaReplace(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IAlphaReplaceEffectiveData:
...
class BiLevel(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IBiLevelEffectiveData:
...
class Blur(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IBlurEffectiveData:
...
class BrightnessContrast(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IBrightnessContrastEffectiveData:
...
class ColorChange(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IColorChangeEffectiveData:
    ...
    @property
    def from_color(self) -> aspose.slides.IColorFormat:
        ...

    @property
    def to_color(self) -> aspose.slides.IColorFormat:
        ...
...
class ColorReplace(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IColorReplaceEffectiveData:
    ...
    @property
    def color(self) -> aspose.slides.IColorFormat:
...
class Duotone(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IDuotoneEffectiveData:
    ...
    @property
    def color1(self) -> aspose.slides.IColorFormat:
        '''Returns target color format for dark pixels.
                    Read-only :py:class:`aspose.slides.IColorFormat`.'''
        ...

    @property
    def color2(self) -> aspose.slides.IColorFormat:
...
class EffectFactory:
    ...
    def create_glow(self) -> aspose.slides.effects.IGlow:
        '''Creates Glow effect.
        :returns: Glow effect.'''
        ...

    def create_inner_shadow(self) -> aspose.slides.effects.IInnerShadow:
        '''Creates Inner shafow effect.
        :returns: Inner shafow effect.'''
        ...

    def create_outer_shadow(self) -> aspose.slides.effects.IOuterShadow:
        '''Creates Outer shadow effect.
        :returns: Outer shadow effect.'''
        ...

    def create_preset_shadow(self) -> aspose.slides.effects.IPresetShadow:
        '''Creates Preset shadow effect.
        :returns: Preset shadow effect.'''
        ...

    def create_reflection(self) -> aspose.slides.effects.IReflection:
        '''Creates Reflection effect.
        :returns: Reflection effect.'''
        ...

    def create_soft_edge(self) -> aspose.slides.effects.ISoftEdge:
        '''Creates Soft Edge effect.
        :returns: Soft Edge effect.'''
        ...

    @property
    def image_transform_operation_factory(self) -> aspose.slides.effects.IImageTransformOperationFactory:
        ...
...
class FillOverlay(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IFillOverlayEffectiveData:
    ...
    @property
    def fill_format(self) -> aspose.slides.IFillFormat:
        ...

    @property
    def blend(self) -> aspose.slides.FillBlendMode:
        '''FillBlendMode.
                    Read/write :py:enum:`aspose.slides.FillBlendMode`.'''
        ...

    @blend.setter
    def blend(self, value: aspose.slides.FillBlendMode):
        '''FillBlendMode.
                    Read/write :py:enum:`aspose.slides.FillBlendMode`.'''
        ...
...
class Glow:
    ...
    def get_effective(self) -> aspose.slides.effects.IGlowEffectiveData:
...
class GrayScale(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IGrayScaleEffectiveData:
...
class HSL(ImageTransformOperation):
    ...
    def get_effective(self) -> aspose.slides.effects.IHSLEffectiveData:
...
class IAlphaBiLevel:
    ...
    @property
    def as_i_image_transform_operation(self) -> aspose.slides.effects.IImageTransformOperation:
        ...
...
class IAlphaBiLevelEffectiveData:
    ...
    @property
    def as_i_effect_effective_data(self) -> aspose.slides.effects.IEffectEffectiveData:
        ...
...
class IFillOverlayEffectiveData:
    ...
    @property
    def fill_format(self) -> aspose.slides.IFillFormatEffectiveData:
        ...
...
class IImageTransformOCollectionEffectiveData:
    ...
    def __getitem__(self, key: int) -> aspose.slides.effects.IEffectEffectiveData
...
class IImageTransformOperationCollection:
    ...
    def add_alpha_bi_level_effect(self, threshold: float) -> aspose.slides.effects.IAlphaBiLevel:
    ...
    def add_alpha_ceiling_effect(self) -> aspose.slides.effects.IAlphaCeiling:
        '''Adds the new Alpha Ceiling effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_alpha_floor_effect(self) -> aspose.slides.effects.IAlphaFloor:
        '''Adds the new Alpha Floor effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_alpha_inverse_effect(self) -> aspose.slides.effects.IAlphaInverse:
        '''Adds the new Alpha Inverse effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_alpha_modulate_effect(self) -> aspose.slides.effects.IAlphaModulate:
        '''Adds the new Alpha Modulate effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_alpha_modulate_fixed_effect(self, amount: float) -> aspose.slides.effects.IAlphaModulateFixed:
        '''Adds the new Alpha Modulate Fixed effect to the end of a collection.
        :param amount: The percentage amount to scale the alpha.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_alpha_replace_effect(self, alpha: float) -> aspose.slides.effects.IAlphaReplace:
        '''Adds the new Alpha Replace effect to the end of a collection.
        :param alpha: The new opacity value.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_bi_level_effect(self, threshold: float) -> aspose.slides.effects.IBiLevel:
    ...
    def add_blur_effect(self, radius: float, grow: bool) -> aspose.slides.effects.IBlur:
    ...
    def add_color_change_effect(self) -> aspose.slides.effects.IColorChange:
        '''Adds the new Color Change effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_color_replace_effect(self) -> aspose.slides.effects.IColorReplace:
        '''Adds the new Color Replacement effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_duotone_effect(self) -> aspose.slides.effects.IDuotone:
        '''Adds the new Duotone effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_fill_overlay_effect(self) -> aspose.slides.effects.IFillOverlay:
        '''Adds the new Fill Overlay effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_gray_scale_effect(self) -> aspose.slides.effects.IGrayScale:
        '''Adds the new Gray Scale effect to the end of a collection.
        :returns: Index of the new image effect in a collection.'''
        ...

    def add_hsl_effect(self, hue: float, saturation: float, luminance: float) -> aspose.slides.effects.IHSL:
    ...
    def add_luminance_effect(self, brightness: float, contrast: float) -> aspose.slides.effects.ILuminance:
    ...
    def add_tint_effect(self, hue: float, amount: float) -> aspose.slides.effects.ITint:
    ...
    def add_brightness_contrast_effect(self, brightness: float, contrast: float) -> aspose.slides.effects.IBrightnessContrast:
    ...
    def __getitem__(self, key: int) -> aspose.slides.effects.IImageTransformOperation
        '''Returns an :py:class:`aspose.slides.effects.IImageTransformOperation` from the collection by it's index.'''
        ...
...
class IImageTransformOperationFactory:
    ...
    def create_alpha_bi_level(self, threshold: float) -> aspose.slides.effects.IAlphaBiLevel:
        '''Creates Alpha BiLevel effect.
        :param threshold: Threshold.
        :returns: Alpha BiLevel effect.'''
        ...

    def create_alph_ceiling(self) -> aspose.slides.effects.IAlphaCeiling:
        '''Creates Alpha Ceiling effect.
        :returns: Alpha Ceiling effect.'''
        ...

    def create_alpha_floor(self) -> aspose.slides.effects.IAlphaFloor:
        '''Creates Alpha floor effect.
        :returns: Alpha floor effect.'''
        ...

    def create_alpha_inverse(self) -> aspose.slides.effects.IAlphaInverse:
        '''Creates Alpha inverse effect.
        :returns: Alpha inverst effect.'''
        ...

    def create_alpha_modulate(self) -> aspose.slides.effects.IAlphaModulate:
        '''Creates Alpha modulate effect.
        :returns: Alpha modulate effect.'''
        ...

    def create_alpha_modulate_fixed(self, amount: float) -> aspose.slides.effects.IAlphaModulateFixed:
        '''Creates Alpha modulate fixed effect.
        :param amount: Amount.
        :returns: Alpha modulate fixed effect.'''
        ...

    def create_alpha_replace(self, alpha: float) -> aspose.slides.effects.IAlphaReplace:
        '''Creates Alpha replace effect.
        :param alpha: Alpha
        :returns: Alpha replace effect.'''
        ...

    def create_bi_level(self, threshold: float) -> aspose.slides.effects.IBiLevel:
        '''Creates BiLevel effect.
        :param threshold: Threshold.
        :returns: BiLevel effect.'''
        ...

    def create_blur(self, radius: float, grow: bool) -> aspose.slides.effects.IBlur:
        '''Creates Blur effect.
        :param radius: Radius.
        :param grow: Grow.
        :returns: Blur effect.'''
    ...
    def create_color_change(self) -> aspose.slides.effects.IColorChange:
        '''Creates Color change effect.
        :returns: Color change effect.'''
        ...

    def create_color_replace(self) -> aspose.slides.effects.IColorReplace:
        '''Creates Color replace effect.
        :returns: Color replace effect.'''
        ...

    def create_duotone(self) -> aspose.slides.effects.IDuotone:
        '''Creates Duotone effect.
        :returns: Duotone effect.'''
        ...

    def create_fill_overlay(self) -> aspose.slides.effects.IFillOverlay:
        '''Creates Fill overlay effect.
        :returns: Fill overlay effect.'''
        ...

    def create_gray_scale(self) -> aspose.slides.effects.IGrayScale:
        '''Creates Gray scale effect.
        :returns: Returns gray scale effect.'''
        ...

    def create_hsl(self, hue: float, saturation: float, luminance: float) -> aspose.slides.effects.IHSL:
    ...
    def create_luminance(self, brightness: float, contrast: float) -> aspose.slides.effects.ILuminance:
    ...
    def create_tint(self, hue: float, amount: float) -> aspose.slides.effects.ITint:
        '''Creates Tint effect.
        :param hue: Hue.
        :param amount: Amount.
        :returns: Tint effect.'''
...
class IInnerShadow:
    ...
    def get_effective(self) -> aspose.slides.effects.IInnerShadowEffectiveData:
        ...
    ...
    @property
    def shadow_color(self) -> aspose.slides.IColorFormat:
        ...
...
class ILuminance:
    ...
    def get_effective(self) -> aspose.slides.effects.ILuminanceEffectiveData:
        ...
...
class IOuterShadow:
    ...
    def get_effective(self) -> aspose.slides.effects.IOuterShadowEffectiveData:
        ...
    ...
    @property
    def rectangle_align(self) -> aspose.slides.RectangleAlignment:
        ...

    @rectangle_align.setter
    def rectangle_align(self, value: aspose.slides.RectangleAlignment):
        ...
...
class IPresetShadow:
    ...
    def get_effective(self) -> aspose.slides.effects.IPresetShadowEffectiveData:
        ...
    ...
    @property
    def preset(self) -> aspose.slides.PresetShadowType:
        '''Preset.
                    Read/write :py:enum:`aspose.slides.PresetShadowType`.'''
        ...

    @preset.setter
    def preset(self, value: aspose.slides.PresetShadowType):
        '''Preset.
                    Read/write :py:enum:`aspose.slides.PresetShadowType`.'''
        ...
...
class IReflection:
    ...
    def get_effective(self) -> aspose.slides.effects.IReflectionEffectiveData:
        ...
...
class ISoftEdge:
    ...
    def get_effective(self) -> aspose.slides.effects.ISoftEdgeEffectiveData:
        ...
...
class ITint:
    ...
    def get_effective(self) -> aspose.slides.effects.ITintEffectiveData:
        ...
