...
class Collect:
    ...
    @staticmethod
    def shapes(pres: aspose.slides.Presentation) -> System.Collections.Generic.IEnumerable`1[[Aspose.Slides.Shape]]:
...
class Compress:
    ...
    @staticmethod
    def remove_unused_master_slides(pres: aspose.slides.Presentation) -> None:
    ...
    @staticmethod
    def remove_unused_layout_slides(pres: aspose.slides.Presentation) -> None:
        '''Makes compression of the :py:class:`aspose.slides.Presentation` by removing unused layout slides.
        :param pres: The presentation instance'''
        ...

    @staticmethod
    def compress_embedded_fonts(pres: aspose.slides.Presentation) -> None:
...
class Convert:
    ...
    @overload
    @staticmethod
    def to_pdf(pres: aspose.slides.Presentation, out_path: str) -> None:
        '''Converts :py:class:`aspose.slides.Presentation` to PDF.
    ...
    @overload
    @staticmethod
    def to_pdf(pres: aspose.slides.Presentation, out_path: str, options: aspose.slides.export.IPdfOptions) -> None:
        '''Converts :py:class:`aspose.slides.Presentation` to PDF.
        :param pres: Input presentation
        :param out_path: Output path
        :param options: Output PDF options'''
    ...
    @overload
    @staticmethod
    def to_svg(pres: aspose.slides.Presentation, options: aspose.slides.export.ISVGOptions) -> None:
        '''Converts :py:class:`aspose.slides.Presentation` to SVG.
        :param pres: Input presentation
