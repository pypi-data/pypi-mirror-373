...
class IKnownIssueWarningInfo:
    ...
    @property
    def as_i_warning_info(self) -> aspose.slides.warnings.IWarningInfo:
        ...
...
class IWarningCallback:
    ...
    def warning(self, warning: aspose.slides.warnings.IWarningInfo) -> aspose.slides.warnings.ReturnAction:
...
class IWarningInfo:
    ...
    def send_warning(self, receiver: aspose.slides.warnings.IWarningCallback) -> None:
    ...
    @property
    def warning_type(self) -> aspose.slides.warnings.WarningType:
        ...
