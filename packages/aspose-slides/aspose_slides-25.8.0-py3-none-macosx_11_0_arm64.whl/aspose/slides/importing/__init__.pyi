...
class ExcelWorkbookImporter:
    ...
    @overload
    @staticmethod
    def add_chart_from_workbook(shapes: aspose.slides.IShapeCollection, x: float, y: float, workbook: aspose.slides.excel.IExcelDataWorkbook, worksheet_name: str, chart_index: int, embed_all_workbook: bool) -> aspose.slides.charts.IChart:
    ...
    @overload
    @staticmethod
    def add_chart_from_workbook(shapes: aspose.slides.IShapeCollection, x: float, y: float, workbook: aspose.slides.excel.IExcelDataWorkbook, worksheet_name: str, chart_name: str, embed_all_workbook: bool) -> aspose.slides.charts.IChart:
        '''Retrieves a chart from the specified Excel workbook and adds it to the end of the given shape collection at the specified coordinates.
        :param shapes: The shape collection to which the chart will be added.
        :param x: The X coordinate for positioning the chart.
        :param y: The Y coordinate for positioning the chart.
    ...
    @overload
    @staticmethod
    def add_chart_from_workbook(shapes: aspose.slides.IShapeCollection, x: float, y: float, workbook_stream: io.RawIOBase, worksheet_name: str, chart_name: str, embed_all_workbook: bool) -> aspose.slides.charts.IChart:
        '''Retrieves a chart from the specified Excel workbook and adds it to the end of the given shape collection at the specified coordinates.
        :param shapes: The shape collection to which the chart will be added.
        :param x: The X coordinate for positioning the chart.
        :param y: The Y coordinate for positioning the chart.
    ...
    @overload
    @staticmethod
    def add_chart_from_workbook(shapes: aspose.slides.IShapeCollection, x: float, y: float, workbook_path: str, worksheet_name: str, chart_name: str, embed_workbook: bool) -> aspose.slides.charts.IChart:
        '''Retrieves a chart from the specified Excel workbook and adds it to the end of the given shape collection at the specified coordinates.
        :param shapes: The shape collection to which the chart will be added.
        :param x: The X coordinate for positioning the chart.
        :param y: The Y coordinate for positioning the chart.
...
class IHtmlExternalResolver:
    ...
    @property
    def as_i_external_resource_resolver(self) -> aspose.slides.importing.IExternalResourceResolver:
        ...
