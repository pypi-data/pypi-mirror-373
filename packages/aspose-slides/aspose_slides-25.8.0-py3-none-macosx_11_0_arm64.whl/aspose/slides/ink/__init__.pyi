...
class IInk:
    ...
    @property
    def traces(self) -> List[aspose.slides.ink.IInkTrace]:
...
class IInkBrush:
    ...
    @property
    def ink_effect(self) -> aspose.slides.ink.InkEffectType:
        ...
...
class IInkTrace:
    ...
    @property
    def brush(self) -> aspose.slides.ink.IInkBrush:
...
class Ink(aspose.slides.GraphicalObject):
    ...
    @staticmethod
    def register_ink_effect_image(effect_type: aspose.slides.ink.InkEffectType, image: aspose.slides.IImage) -> None:
    ...
    @staticmethod
    def unregister_ink_effect_image(effect_type: aspose.slides.ink.InkEffectType) -> None:
