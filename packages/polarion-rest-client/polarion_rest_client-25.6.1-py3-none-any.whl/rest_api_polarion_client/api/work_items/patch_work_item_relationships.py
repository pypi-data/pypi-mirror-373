...
from ...models.relationship_data_list_request import RelationshipDataListRequest
from ...models.relationship_data_single_request import RelationshipDataSingleRequest
...
def _get_kwargs(
    ...
    relationship_id: str,
    *,
    body: Union["RelationshipDataListRequest", "RelationshipDataSingleRequest"],
) -> dict[str, Any]:
