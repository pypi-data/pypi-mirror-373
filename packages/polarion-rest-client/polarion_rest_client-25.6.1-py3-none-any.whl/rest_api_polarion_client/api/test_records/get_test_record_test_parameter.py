...
from ...models.testparameters_single_get_response import TestparametersSingleGetResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TestparametersSingleGetResponse.from_dict(response.json())
