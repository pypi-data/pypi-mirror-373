...
from ...models.testparameters_list_post_request import TestparametersListPostRequest
from ...models.testparameters_list_post_response import TestparametersListPostResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TestparametersListPostResponse.from_dict(response.json())
