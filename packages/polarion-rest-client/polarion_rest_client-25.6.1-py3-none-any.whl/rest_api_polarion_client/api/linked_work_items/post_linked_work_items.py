...
from ...models.linkedworkitems_list_post_request import LinkedworkitemsListPostRequest
from ...models.linkedworkitems_list_post_response import LinkedworkitemsListPostResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = LinkedworkitemsListPostResponse.from_dict(response.json())
