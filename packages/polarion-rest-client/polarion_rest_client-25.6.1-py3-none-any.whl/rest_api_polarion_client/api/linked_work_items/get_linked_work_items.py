...
from ...models.linkedworkitems_list_get_response import LinkedworkitemsListGetResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LinkedworkitemsListGetResponse.from_dict(response.json())
