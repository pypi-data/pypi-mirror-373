...
from ...models.post_page_attachments_request_body import PostPageAttachmentsRequestBody
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = PageAttachmentsListPostResponse.from_dict(response.json())
