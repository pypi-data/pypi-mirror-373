...
from ...models.testrun_comments_list_get_response import TestrunCommentsListGetResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TestrunCommentsListGetResponse.from_dict(response.json())
