...
from ...models.projecttemplates_list_get_response import ProjecttemplatesListGetResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProjecttemplatesListGetResponse.from_dict(response.json())
