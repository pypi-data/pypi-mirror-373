...
from ...models.teststep_results_list_get_response import TeststepResultsListGetResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TeststepResultsListGetResponse.from_dict(response.json())
