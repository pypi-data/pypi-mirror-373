import os
import click
from gdcmd.helm.deployment_test import deployment_test
...
@helm.command("deployment-test", short_help="Tests the griddot/suite deployment installation")
@click.option('--path', '-p', help='Path to the values.yaml file, generated by the griddot/suite deployment itself.')
@click.option('--verbose', '-v', help='Verbose output', is_flag=True, default=False)
def helm_deployment_test(path: str, verbose: bool):
    deployment_test(path, verbose)
