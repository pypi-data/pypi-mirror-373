...
class AtsPurchaseOrder(BaseModel):
  ...
  delivered_at: datetime = Field(description='Timestamp when the operation was delivered')
  eta: datetime = Field(description='Estimated time of arrival to the destination')
  eta_updated_at: datetime = Field(description='Timestamp when the ETA was last updated')
