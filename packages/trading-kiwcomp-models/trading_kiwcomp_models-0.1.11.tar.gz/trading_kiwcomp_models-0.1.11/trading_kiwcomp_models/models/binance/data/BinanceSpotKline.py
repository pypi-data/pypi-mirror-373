...
from .base import BinanceKline  # your declarative base (like ExchangeInfoSymbol before)
...
class BinanceSpotKlineMapper:
    ...
    @staticmethod
    def to_table(symbol: str, interval: str, event: BinanceSpotKline) -> BinanceSpotKlineTable:
