...
# ✅ Pydantic Model
class BinanceFutureCOINMKline(BaseModel):
    symbol: str
    interval: str
    open_time: datetime
    open: float
...
# ✅ ORM Table
class BinanceFutureCOINMKlineTable(BinanceKline):
...
# ✅ Mapper
class BinanceFutureCOINMKlineMapper:
    @staticmethod
    def from_raw(symbol: str, interval: str, raw: list) -> BinanceFutureCOINMKline:
        return BinanceFutureCOINMKline(
            symbol=symbol,
            interval=interval,
    ...
    @staticmethod
    def to_table(event: BinanceFutureCOINMKline) -> BinanceFutureCOINMKlineTable:
        return BinanceFutureCOINMKlineTable(**event.model_dump())
