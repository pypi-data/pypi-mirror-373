...
# ✅ Pydantic Model
class BinanceCoinMFutureKline(BaseModel):
    symbol: str
    interval: str
    open_time: datetime
    open: float
    ...
    low: float
    close: float
    volume: float                  # contract volume for COIN-M
    close_time: datetime
...
# ✅ ORM Table
class BinanceCoinMFutureKlineTable(BinanceKline):
    __tablename__ = "binance_future_coinm_kline"
...
# ✅ Mapper
class BinanceCoinMFutureKlineMapper:
    @staticmethod
    def from_raw(symbol: str, interval: str, raw: list) -> BinanceCoinMFutureKline:
        return BinanceCoinMFutureKline(
            symbol=symbol,
            interval=interval,
    ...
    @staticmethod
    def to_table(event: BinanceCoinMFutureKline) -> BinanceCoinMFutureKlineTable:
        return BinanceCoinMFutureKlineTable(**event.model_dump())
