...
class HookIntegrationManager:
    ...
    def handle_session_start(self, hook_data: Dict[str, Any]) -> bool:
        ...
        """
        return self.circuit_breaker.call(self._handle_session_start_impl, hook_data) is not None
    ...
    def handle_session_end(self, hook_data: Dict[str, Any]) -> bool:
        ...
        Returns:
            True if handled successfully, False if failed/skipped
        """
        return self.circuit_breaker.call(self._handle_session_end_impl, hook_data) is not None
    ...
    def handle_context_change(self, hook_data: Dict[str, Any]) -> bool:
        ...
        Returns:
            True if handled successfully, False if failed/skipped
        """
        return self.circuit_breaker.call(self._handle_context_change_impl, hook_data) is not None
    ...
    def _handle_session_end_impl(self, hook_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.current_session['performance_metrics'].update({
                ...
                'average_hook_time_ms': (self.total_hook_time / max(self.hook_call_count, 1)) * 1000
            })
    ...
    def _handle_context_change_impl(self, hook_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if len(self.current_session['context_events']) > max_events:
                self.current_session['context_events'] = self.current_session['context_events'][-max_events:]
    ...
    def _sanitize_hook_data(self, hook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            safe_fields = {
                'session_id', 'timestamp', 'event_type', 'model', 'version',
                'workspace', 'cost', 'exceeds_200k_tokens'
            }
            ...
            return {'_sanitization_error': str(e), '_timestamp': datetime.now().isoformat()}
    ...
    def cleanup_old_sessions(self, days_to_keep: int = None):
        ...
        try:
            ...
            if deleted_count > 0:
                logger.info(f"Cleaned up {deleted_count} old session files (>{retention_days} days)")
