...
class PerformanceOptimizer:
    ...
    def track_operation(self, operation_name: str, context_tokens: Optional[int] = None):
        """
    ...
    def get_performance_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        health_score = self._calculate_performance_health(avg_cpu, avg_memory, operation_stats)
            ...
            if timings:
                ...
                stats[operation] = {
                    ...
                    "performance_rating": "excellent" if avg_time < 50 else
                                        ...
                                        "acceptable" if avg_time < 200 else "slow"
                }
        
        return stats
    
    def _calculate_performance_health(self, avg_cpu: float, avg_memory: float, 
                                    operation_stats: Dict[str, Any]) -> int:
        ...
        slow_operations = sum(1 for op in operation_stats.values() 
    ...
    def _generate_optimization_recommendations(self, avg_cpu: float, max_cpu: float,
                                             avg_memory: float, max_memory: float,
    ...
    def _load_performance_history(self):
        ...
        try:
            ...
            if data:
                ...
                logger.info(f"Loaded {len(self.snapshots)} performance snapshots from history")
