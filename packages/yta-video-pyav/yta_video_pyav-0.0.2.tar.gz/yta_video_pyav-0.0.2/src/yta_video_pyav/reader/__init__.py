...
from yta_video_pyav.utils import iterate_stream_frames_demuxing
from yta_video_frame_time.t_fraction import T
...
class VideoReader:
    ...
    def iterate_video_frames(
        ...
        This method returns the VideoFrame instance:
        """
    ...
    def iterate_audio_frames(
        ...
        This method returns the AudioFrame instance.
        """
        for frame in iterate_stream_frames_demuxing(
            container = self.container,
            video_stream = None,
