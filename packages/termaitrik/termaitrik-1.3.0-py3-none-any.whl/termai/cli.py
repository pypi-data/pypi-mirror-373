...
def chat(
    ...
    if prompt:
        ...
        _process_messages(messages, cfg, model, stream, temperature, console)
    ...
    while True:
        try:
            ...
            # Process the conversation and get AI response
            response = _process_messages(messages, cfg, model, stream, temperature, console)
...
def _process_messages(messages, cfg, model, stream, temperature, console):
