"""
Base producer implementation with common functionality
"""
...
class BaseProducer(MessageProducer):
    """Base producer with common functionality"""
    ...
    async def connect(self) -> None:
        ...
        self.connected = True
        self.logger.info("Producer connected successfully")
    ...
    async def disconnect(self) -> None:
        ...
        try:
            ...
            self.connected = False
            self._connection = None
            self.logger.info("Producer disconnected")
    ...
    def _increment_batch_count(self) -> None:
