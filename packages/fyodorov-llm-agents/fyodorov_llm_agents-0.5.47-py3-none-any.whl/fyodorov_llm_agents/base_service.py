...
class BaseService(Generic[T], ABC):
    ...
    async def update_in_db(
        ...
        try:
            ...
            return await self._dict_to_model(updated_dict)
        except Exception as e:
        ...
        try:
            ...
            for record in result.data:
                try:
                    ...
                    model_instance = await self._dict_to_model(record)
