...
_AI_tools = _LazyLoader("dearning.AI_tools", [
    "DLP", "AImemory", "TTS", "RLTools", "Qkanalyze", "video", "DOaudio", "image", "DOtext", "DOvideo"
])
...
__all__ = [
    "CustomAIModel", "Dense", "Activation", "Dropout", "DOtensor",
    "DLP", "AImemory", "TTS", "RLTools", "DOaudio", "image", "video", "Qkanalyze",
    "CodeTracker", "BinaryConverter", "ByteConverter", "AImodel", "Quantum",
    "preprocess_data", "evaluate_model", "LogEkstrainnix", "test_model"
]
