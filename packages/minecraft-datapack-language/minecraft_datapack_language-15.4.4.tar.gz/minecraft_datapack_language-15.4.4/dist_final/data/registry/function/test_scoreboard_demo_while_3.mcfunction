...
execute if score @e[type=armor_stand,tag=mdl_server,limit=1] player_score > = @e[type=armor_stand,tag=mdl_server,limit=1] target_score run function registry:test_scoreboard_demo_while_3_if_1
