...
scoreboard players add @e[type=armor_stand,tag=mdl_server,limit=1] player_score 10
scoreboard players add @e[type=armor_stand,tag=mdl_server,limit=1] team_score 5
scoreboard players add @e[type=armor_stand,tag=mdl_server,limit=1] world_timer 1