...
scoreboard players set @e[type=armor_stand,tag=mdl_server,limit=1] maxCount 0
scoreboard objectives add countdown dummy
scoreboard players set @e[type=armor_stand,tag=mdl_server,limit=1] countdown 0