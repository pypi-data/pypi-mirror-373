...
scoreboard players operation @e[type=armor_stand,tag=mdl_server,limit=1] global_counter = global_counter global
scoreboard players add @e[type=armor_stand,tag=mdl_server,limit=1] global_counter 1
scoreboard players operation @a player_kills = player_kills @s
scoreboard players add @a player_kills 1
scoreboard players operation @a[team=red] red_team_score = red_team_score @a[team=red]
