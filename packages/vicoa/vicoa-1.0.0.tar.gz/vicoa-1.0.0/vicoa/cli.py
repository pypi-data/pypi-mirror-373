            ...
            if "state" in params and params["state"][0] == server.state:
                if "api_key" in params:
                    ...
                    <head>
                        ...
                        <meta http-equiv="refresh" content="1;url=https://vicoa.com/dashboard">
                        <style>
                            body {
                                margin: 0;
                                padding: 0;
                    ...
                    <body>
                        <div class="card">
                            ...
                            <p style="margin-top: 20px; font-size: 12px;">
                                ...
                                <a href="https://vicoa.com/dashboard" style="color: #86efac;">click here</a>.
                            </p>
                        </div>
                        <script>
                            setTimeout(() => {
                                window.location.href = 'https://vicoa.com/dashboard';
                            }, 500);
                        </script>
                    </body>
                    </html>
...
def authenticate_via_browser(auth_url="https://vicoa.com"):
...
def ensure_api_key(args):
    ...
    auth_url = getattr(args, "auth_url", "https://vicoa.com")
    try:
