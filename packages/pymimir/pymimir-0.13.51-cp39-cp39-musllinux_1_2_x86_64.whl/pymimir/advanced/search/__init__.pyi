...
class PackedState:
    ...
    def get_fluent_atoms(self, problem: pymimir.advanced.formalism.Problem) -> Iterator[int]: ...

    def get_derived_atoms(self, problem: pymimir.advanced.formalism.Problem) -> Iterator[int]: ...

    def get_numeric_variables(self, problem: pymimir.advanced.formalism.Problem) -> list[float]: ...

    @overload
    def literal_holds(self, literal: pymimir.advanced.formalism.FluentGroundLiteral, problem: pymimir.advanced.formalism.Problem) -> bool: ...

    @overload
    def literal_holds(self, literal: pymimir.advanced.formalism.DerivedGroundLiteral, problem: pymimir.advanced.formalism.Problem) -> bool: ...

    @overload
    def literal_holds(self, literals: pymimir.advanced.formalism.FluentGroundLiteralList, problem: pymimir.advanced.formalism.Problem) -> bool: ...

    @overload
    def literal_holds(self, literals: pymimir.advanced.formalism.DerivedGroundLiteralList, problem: pymimir.advanced.formalism.Problem) -> bool: ...
...
class DefaultLiftedApplicableActionGeneratorEventHandler(ILiftedApplicableActionGeneratorEventHandler):
    @staticmethod
    def create(quiet: bool = True) -> DefaultLiftedApplicableActionGeneratorEventHandler: ...

class DebugLiftedApplicableActionGeneratorEventHandler(ILiftedApplicableActionGeneratorEventHandler):
    @staticmethod
    def create(quiet: bool = True) -> DebugLiftedApplicableActionGeneratorEventHandler: ...

class LiftedApplicableActionGenerator(IApplicableActionGenerator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: Optional[ILiftedApplicableActionGeneratorEventHandler] = None) -> LiftedApplicableActionGenerator: ...
...
class DefaultLiftedAxiomEvaluatorEventHandler(ILiftedAxiomEvaluatorEventHandler):
    @staticmethod
    def create(quiet: bool = True) -> DefaultLiftedAxiomEvaluatorEventHandler: ...

class DebugLiftedAxiomEvaluatorEventHandler(ILiftedAxiomEvaluatorEventHandler):
    @staticmethod
    def create(quiet: bool = True) -> DebugLiftedAxiomEvaluatorEventHandler: ...

class LiftedAxiomEvaluator(IAxiomEvaluator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: Optional[ILiftedAxiomEvaluatorEventHandler] = None) -> LiftedAxiomEvaluator: ...
