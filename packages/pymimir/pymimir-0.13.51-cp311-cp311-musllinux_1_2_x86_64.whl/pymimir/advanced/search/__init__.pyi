...
class LiftedApplicableActionGenerator(IApplicableActionGenerator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: ILiftedApplicableActionGeneratorEventHandler | None = None) -> LiftedApplicableActionGenerator: ...
...
class LiftedAxiomEvaluator(IAxiomEvaluator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: ILiftedAxiomEvaluatorEventHandler | None = None) -> LiftedAxiomEvaluator: ...
