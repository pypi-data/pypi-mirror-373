...
class CommandWrapper:
    ...
    def _convert_type(self, value: str, type_hint: type, param_name: str = None, 
        ...
        # Check if this is a simple type (like int, str, bytes) or a Union type
        if hasattr(type_hint, '__origin__') and type_hint.__origin__ == Union:
            ...
            for arg in type_hint.__args__:
                ...
                if hasattr(arg, '__name__'):
                    hints.append(arg.__name__)
                else:
                    hints.append(str(arg))
        else:
            # Handle simple types
            if hasattr(type_hint, '__name__'):
                hints.append(type_hint.__name__)
            else:
