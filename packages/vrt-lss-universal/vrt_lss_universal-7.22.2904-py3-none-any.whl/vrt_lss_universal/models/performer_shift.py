...
class PerformerShift(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_locations": obj.get("max_locations") if obj.get("max_locations") is not None else null,
            "max_stops": obj.get("max_stops") if obj.get("max_stops") is not None else null,
