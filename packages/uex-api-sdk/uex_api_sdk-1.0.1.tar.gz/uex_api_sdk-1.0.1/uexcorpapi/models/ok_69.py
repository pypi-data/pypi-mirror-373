...
from uexcorpapi.models.data_33 import Data33
...
class Ok69(object):
    ...
    Attributes:
        data (List[Data33]): The model property of type List[Data33].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data33.from_dictionary(x) for x in dictionary.get('data')]
