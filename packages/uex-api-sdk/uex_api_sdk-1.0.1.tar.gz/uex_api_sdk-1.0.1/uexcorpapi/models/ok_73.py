...
from uexcorpapi.models.data_37 import Data37


class Ok73(object):

    """Implementation of the 'OK73' model.

    Attributes:
        data (List[Data37]): The model property of type List[Data37].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok73 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data37.from_dictionary(x) for x in dictionary.get('data')]
