...
from uexcorpapi.models.data_34 import Data34
...
class Ok70(object):
    ...
    Attributes:
        data (List[Data34]): The model property of type List[Data34].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data34.from_dictionary(x) for x in dictionary.get('data')]
