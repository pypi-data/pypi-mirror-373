...
from uexcorpapi.models.data_14 import Data14


class Ok49(object):

    """Implementation of the 'OK49' model.

    Attributes:
        data (List[Data14]): The model property of type List[Data14].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok49 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data14.from_dictionary(x) for x in dictionary.get('data')]
