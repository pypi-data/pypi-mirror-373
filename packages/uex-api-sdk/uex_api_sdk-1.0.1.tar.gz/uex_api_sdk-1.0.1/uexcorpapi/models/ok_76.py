...
from uexcorpapi.models.data_40 import Data40


class Ok76(object):

    """Implementation of the 'OK76' model.

    Attributes:
        data (List[Data40]): The model property of type List[Data40].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok76 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data40.from_dictionary(x) for x in dictionary.get('data')]
