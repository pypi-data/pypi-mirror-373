...
from uexcorpapi.models.data_38 import Data38
...
class Ok74(object):
    ...
    Attributes:
        data (List[Data38]): The model property of type List[Data38].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data38.from_dictionary(x) for x in dictionary.get('data')]
