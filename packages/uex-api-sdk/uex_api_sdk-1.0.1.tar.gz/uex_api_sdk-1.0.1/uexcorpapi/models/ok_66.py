...
from uexcorpapi.models.data_30 import Data30


class Ok66(object):

    """Implementation of the 'OK66' model.

    Attributes:
        data (List[Data30]): The model property of type List[Data30].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok66 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data30.from_dictionary(x) for x in dictionary.get('data')]
