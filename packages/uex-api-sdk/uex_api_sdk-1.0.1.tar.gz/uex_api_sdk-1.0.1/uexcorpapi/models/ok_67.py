...
from uexcorpapi.models.data_31 import Data31
...
class Ok67(object):
    ...
    Attributes:
        data (List[Data31]): The model property of type List[Data31].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data31.from_dictionary(x) for x in dictionary.get('data')]
