...
from uexcorpapi.models.data_39 import Data39


class Ok75(object):

    """Implementation of the 'OK75' model.

    Attributes:
        data (List[Data39]): The model property of type List[Data39].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok75 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data39.from_dictionary(x) for x in dictionary.get('data')]
