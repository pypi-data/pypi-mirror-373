...
from uexcorpapi.models.data_11 import Data11
...
class Ok46(object):
    ...
    Attributes:
        data (List[Data11]): The model property of type List[Data11].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data11.from_dictionary(x) for x in dictionary.get('data')]
