...
from uexcorpapi.models.data_41 import Data41


class Ok77(object):

    """Implementation of the 'OK77' model.

    Attributes:
        data (List[Data41]): The model property of type List[Data41].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok77 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data41.from_dictionary(x) for x in dictionary.get('data')]
