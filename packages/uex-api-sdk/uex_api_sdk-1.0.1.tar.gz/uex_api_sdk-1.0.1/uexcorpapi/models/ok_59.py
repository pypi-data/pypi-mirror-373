...
from uexcorpapi.models.data_23 import Data23


class Ok59(object):

    """Implementation of the 'OK59' model.

    Attributes:
        data (List[Data23]): The model property of type List[Data23].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok59 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data23.from_dictionary(x) for x in dictionary.get('data')]
