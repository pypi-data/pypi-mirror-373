...
from uexcorpapi.models.datum_18 import Datum18


class Ok20(object):

    """Implementation of the 'OK20' model.

    Attributes:
        data (List[Datum18]): The model property of type List[Datum18].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok20 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum18.from_dictionary(x) for x in dictionary.get('data')]
