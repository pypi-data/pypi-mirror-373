...
from uexcorpapi.models.datum_16 import Datum16
...
class Ok18(object):
    ...
    Attributes:
        data (List[Datum16]): The model property of type List[Datum16].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum16.from_dictionary(x) for x in dictionary.get('data')]
