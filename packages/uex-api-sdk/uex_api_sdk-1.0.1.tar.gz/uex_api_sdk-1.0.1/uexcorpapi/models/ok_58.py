...
from uexcorpapi.models.data_22 import Data22


class Ok58(object):

    """Implementation of the 'OK58' model.

    Attributes:
        data (List[Data22]): The model property of type List[Data22].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok58 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data22.from_dictionary(x) for x in dictionary.get('data')]
