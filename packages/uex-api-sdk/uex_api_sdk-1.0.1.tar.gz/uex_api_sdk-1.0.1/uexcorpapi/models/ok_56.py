...
from uexcorpapi.models.data_20 import Data20


class Ok56(object):

    """Implementation of the 'OK56' model.

    Attributes:
        data (List[Data20]): The model property of type List[Data20].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok56 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data20.from_dictionary(x) for x in dictionary.get('data')]
