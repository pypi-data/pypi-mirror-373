...
from uexcorpapi.models.ok_52 import Ok52


class ItemsPricesAllController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(ItemsPricesAllController, self).__init__(config)

    def retrieve_a_list_of_prices_for_all_items_in_all_terminals_all_at_once(self,
                                                                             accept):
        """Does a GET request to /items_prices_all.
