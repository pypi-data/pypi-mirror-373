...
class MIdPlanetOriginController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MIdPlanetOriginController, self).__init__(config)

    def retrieve_a_list_of_common_routes_calculated_based_on_data_reports(self,
                                                                          id_planet_origin,
                                                                          accept):
        """Does a GET request to /commodities_routes/id_planet_origin/{id_planet_origin}.

        Args:
            id_planet_origin (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/commodities_routes/id_planet_origin/{id_planet_origin}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('id_planet_origin')
                            .value(id_planet_origin)
                            .is_required(True)
                            .should_encode(True))
