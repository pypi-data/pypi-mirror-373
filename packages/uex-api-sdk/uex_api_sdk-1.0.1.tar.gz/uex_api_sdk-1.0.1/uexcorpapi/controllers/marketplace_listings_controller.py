...
from uexcorpapi.models.ok_56 import Ok56
...
class MarketplaceListingsController(BaseController):
    ...
    def __init__(self, config):
        super(MarketplaceListingsController, self).__init__(config)

    def list_all_active_marketplace_advertisements_limited_by_100(self,
                                                                  slug,
                                                                  accept):
        """Does a GET request to /marketplace_listings.

        Args:
            slug (str): The request query parameter.
