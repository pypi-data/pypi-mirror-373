...
class MarketplaceFavoritesController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MarketplaceFavoritesController, self).__init__(config)

    def list_all_advertisements_favorited_by_an_user(self,
                                                     accept):
        """Does a GET request to /marketplace_favorites.
