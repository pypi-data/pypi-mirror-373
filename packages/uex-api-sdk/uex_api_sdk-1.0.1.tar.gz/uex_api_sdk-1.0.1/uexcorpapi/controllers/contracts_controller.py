...
from uexcorpapi.models.ok_28 import Ok28
...
class ContractsController(BaseController):
    ...
    def __init__(self, config):
        super(ContractsController, self).__init__(config)

    def obtain_a_list_of_all_known_star_citizen_contacts_mission_givers(self,
                                                                        accept):
