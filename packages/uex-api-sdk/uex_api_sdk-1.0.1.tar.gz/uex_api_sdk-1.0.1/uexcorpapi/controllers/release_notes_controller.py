...
from uexcorpapi.models.ok_68 import Ok68
...
class ReleaseNotesController(BaseController):
    ...
    def __init__(self, config):
        super(ReleaseNotesController, self).__init__(config)

    def output_uex_dev_notes(self,
                             accept):
        """Does a GET request to /release_notes.
