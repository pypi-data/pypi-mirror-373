...
from uexcorpapi.models.ok_74 import Ok74


class VehiclesLoanersController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(VehiclesLoanersController, self).__init__(config)

    def retrieve_a_list_of_star_citizen_vehicles_loaners_for_a_specific_vehicle_id(self,
                                                                                   id_vehicle,
                                                                                   accept):
        """Does a GET request to /vehicles_loaners.
