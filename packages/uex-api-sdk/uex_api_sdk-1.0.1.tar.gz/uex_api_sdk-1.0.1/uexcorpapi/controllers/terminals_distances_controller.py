...
class TerminalsDistancesController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(TerminalsDistancesController, self).__init__(config)

    def estimate_the_distance_in_gigameters_between_two_terminals_within_the_star_citizen_universe(self,
                                                                                                   accept):
        """Does a GET request to /terminals_distances.
