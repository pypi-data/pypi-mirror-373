...
class MIdOrbitOriginController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MIdOrbitOriginController, self).__init__(config)

    def retrieve_a_list_of_common_routes_calculated_based_on_data_reports(self,
                                                                          id_orbit_origin,
                                                                          accept):
        """Does a GET request to /commodities_routes/id_orbit_origin/{id_orbit_origin}.

        Args:
            id_orbit_origin (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/commodities_routes/id_orbit_origin/{id_orbit_origin}')
