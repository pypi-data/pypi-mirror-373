...
class UserRefineriesJobsController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(UserRefineriesJobsController, self).__init__(config)

    def obtain_a_list_of_refinery_jobs_made_by_an_user(self,
                                                       accept):
        """Does a GET request to /user_refineries_jobs.
