...
from uexcorpapi.models.ok_67 import Ok67


class RefineriesYieldsController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(RefineriesYieldsController, self).__init__(config)

    def retrieve_a_list_of_all_refineries_yields_bonuses_per_commodity(self,
                                                                       accept):
        """Does a GET request to /refineries_yields.
