...
from uexcorpapi.models.ok_59 import Ok59


class MIdOrganizationController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MIdOrganizationController, self).__init__(config)

    def retrieve_a_list_of_all_organizations_added_to_the_uex_website(self,
                                                                      id_organization,
                                                                      accept):
        """Does a GET request to /organizations/id_organization/{id_organization}.

        Args:
            id_organization (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/organizations/id_organization/{id_organization}')
