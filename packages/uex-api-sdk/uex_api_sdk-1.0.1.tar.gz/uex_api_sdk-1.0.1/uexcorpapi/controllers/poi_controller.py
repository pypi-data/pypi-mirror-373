...
from uexcorpapi.models.ok_63 import Ok63


class PoiController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(PoiController, self).__init__(config)

    def retrieve_a_list_of_points_of_interest(self,
                                              id_outpost,
                                              accept):
        """Does a GET request to /poi.
