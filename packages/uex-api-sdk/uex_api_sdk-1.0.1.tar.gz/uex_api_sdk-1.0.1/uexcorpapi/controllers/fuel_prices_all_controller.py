...
from uexcorpapi.models.ok_41 import Ok41


class FuelPricesAllController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(FuelPricesAllController, self).__init__(config)

    def retrieve_a_list_of_all_fuel_prices_in_all_terminals_all_at_once(self,
                                                                        accept):
        """Does a GET request to /fuel_prices_all.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(Ok41.from_dictionary)
