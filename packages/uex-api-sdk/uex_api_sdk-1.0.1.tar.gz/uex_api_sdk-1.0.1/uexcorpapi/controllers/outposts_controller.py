...
from uexcorpapi.models.ok_61 import Ok61


class OutpostsController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(OutpostsController, self).__init__(config)

    def retrieve_a_list_of_all_outposts_within_a_star_system(self,
                                                             id_moon,
                                                             accept):
        """Does a GET request to /outposts.

        Args:
            id_moon (str): The request query parameter.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(Ok61.from_dictionary)
