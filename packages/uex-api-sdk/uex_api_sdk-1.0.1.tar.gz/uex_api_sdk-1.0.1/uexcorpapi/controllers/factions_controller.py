...
from uexcorpapi.models.ok_31 import Ok31
...
class FactionsController(BaseController):
    ...
    def __init__(self, config):
        super(FactionsController, self).__init__(config)

    def retrieve_a_list_of_all_known_star_citizen_factions(self,
                                                           accept):
        """Does a GET request to /factions.
