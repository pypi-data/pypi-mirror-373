...
from uexcorpapi.models.ok_16 import Ok16


class CommoditiesRankingController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(CommoditiesRankingController, self).__init__(config)

    def retrieves_the_uex_commodities_average_index_ranking(self,
                                                            accept):
        """Does a GET request to /commodities_ranking.
