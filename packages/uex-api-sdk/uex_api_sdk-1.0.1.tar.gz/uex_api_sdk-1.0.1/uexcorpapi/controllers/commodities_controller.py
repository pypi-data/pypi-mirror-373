...
from uexcorpapi.models.ok_3 import Ok3
...
class CommoditiesController(BaseController):
    ...
    def __init__(self, config):
        super(CommoditiesController, self).__init__(config)

    def get_a_list_of_all_commodities_covered_by_uex(self,
                                                     accept):
        """Does a GET request to /commodities.
