...
from uexcorpapi.models.ok_30 import Ok30


class DataParametersController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(DataParametersController, self).__init__(config)

    def retrieve_a_list_of_specific_parameters_that_uex_uses_for_managing_prices_and_updates(self,
                                                                                             accept):
        """Does a GET request to /data_parameters.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(Ok30.from_dictionary)
