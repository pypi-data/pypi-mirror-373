...
from uexcorpapi.models.ok_65 import Ok65


class RefineriesCapacitiesController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(RefineriesCapacitiesController, self).__init__(config)

    def retrieve_a_list_of_the_estimated_capacity_percentages_for_all_refineries(self,
                                                                                 accept):
        """Does a GET request to /refineries_capacities.
