...
from uexcorpapi.models.ok_79 import Ok79


class VehiclesRentalsPricesAllController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(VehiclesRentalsPricesAllController, self).__init__(config)

    def retrieve_a_list_of_prices_for_all_vehicles_rentals_in_all_terminals_all_at_once(self,
                                                                                        accept):
        """Does a GET request to /vehicles_rentals_prices_all.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/vehicles_rentals_prices_all')
