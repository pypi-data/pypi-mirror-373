...
from uexcorpapi.models.ok_69 import Ok69


class SpaceStationsController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(SpaceStationsController, self).__init__(config)

    def retrieve_a_list_of_all_space_stations_within_a_star_system(self,
                                                                   id_moon,
                                                                   accept):
        """Does a GET request to /space_stations.
