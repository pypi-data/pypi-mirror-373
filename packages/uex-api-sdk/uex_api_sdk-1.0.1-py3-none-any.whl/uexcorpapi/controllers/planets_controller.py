...
from uexcorpapi.models.ok_62 import Ok62
...
class PlanetsController(BaseController):
    ...
    def __init__(self, config):
        super(PlanetsController, self).__init__(config)

    def retrieve_a_list_of_all_planets_within_a_star_system(self,
                                                            id_star_system,
                                                            accept):
        """Does a GET request to /planets.
