...
from uexcorpapi.models.ok_26 import Ok26
...
class CompaniesController(BaseController):
    ...
    def __init__(self, config):
        super(CompaniesController, self).__init__(config)

    def retrieve_a_list_of_all_companies_in_the_star_citizen_universe(self,
                                                                      is_item_manufacturer,
                                                                      accept):
        """Does a GET request to /companies.

        Args:
            is_item_manufacturer (str): The request query parameter.
        ...
        return super().new_api_call_builder.request(
            ...
            .query_param(Parameter()
                         .key('is_item_manufacturer')
                         .value(is_item_manufacturer)
                         .is_required(True))
            ...
            .deserialize_into(Ok26.from_dictionary)
