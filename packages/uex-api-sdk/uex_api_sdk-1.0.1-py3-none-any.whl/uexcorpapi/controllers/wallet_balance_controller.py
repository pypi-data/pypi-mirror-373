...
from uexcorpapi.models.ok_80 import Ok80


class WalletBalanceController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(WalletBalanceController, self).__init__(config)

    def retrieve_user_wallet_balance(self,
                                     accept):
        """Does a GET request to /wallet_balance.
