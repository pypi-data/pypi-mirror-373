...
class MCommodityCodeController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MCommodityCodeController, self).__init__(config)

    def retrieve_a_list_of_prices_for_all_commodities(self,
                                                      commodity_code,
                                                      accept):
        """Does a GET request to /commodities_prices/commodity_code/{commodity_code}.

        Args:
            commodity_code (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/commodities_prices/commodity_code/{commodity_code}')
    ...
    def retrieve_a_list_of_all_fuel_prices(self,
                                           commodity_code,
                                           accept):
        """Does a GET request to /fuel_prices/commodity_code/{commodity_code}.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.SERVER_1)
            .path('/fuel_prices/commodity_code/{commodity_code}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('commodity_code')
                            .value(commodity_code)
