...
class OrbitsDistancesController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(OrbitsDistancesController, self).__init__(config)

    def obtain_the_last_orbital_distances_reported_by_datarunners(self,
                                                                  accept):
        """Does a GET request to /orbits_distances.
