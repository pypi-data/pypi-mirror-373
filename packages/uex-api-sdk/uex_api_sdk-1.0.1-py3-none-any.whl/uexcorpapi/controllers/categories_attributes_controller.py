...
from uexcorpapi.models.ok_1 import Ok1
...
class CategoriesAttributesController(BaseController):
    ...
    def __init__(self, config):
        super(CategoriesAttributesController, self).__init__(config)

    def get_attributes_from_categories_type_item_only(self,
                                                      id_category,
                                                      accept):
        """Does a GET request to /categories_attributes.

        Args:
            id_category (str): The request query parameter.
