...
class MSpecializationController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MSpecializationController, self).__init__(config)

    def search_for_users_listed_in_the_crew_directory(self,
                                                      specialization,
                                                      accept):
        """Does a GET request to /crew/specialization/{specialization}.

        Args:
            specialization (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/crew/specialization/{specialization}')
