...
from uexcorpapi.models.ok_54 import Ok54
...
class JurisdictionsController(BaseController):
    ...
    def __init__(self, config):
        super(JurisdictionsController, self).__init__(config)

    def retrieve_a_list_of_all_known_star_citizen_jurisdictions(self,
                                                                accept):
        """Does a GET request to /jurisdictions.
