...
from uexcorpapi.models.ok_14 import Ok14


class CommoditiesPricesAllController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(CommoditiesPricesAllController, self).__init__(config)

    def retrieve_a_list_of_prices_for_all_commodities_in_all_terminals_all_at_once(self,
                                                                                   accept):
        """Does a GET request to /commodities_prices_all.
