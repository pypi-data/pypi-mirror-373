...
class MCommoditySlugController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(MCommoditySlugController, self).__init__(config)

    def retrieve_a_list_of_prices_for_all_commodities(self,
                                                      commodity_slug,
                                                      accept):
        """Does a GET request to /commodities_prices/commodity_slug/{commodity_slug}.

        Args:
            commodity_slug (str): (Required)
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/commodities_prices/commodity_slug/{commodity_slug}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('commodity_slug')
                            .value(commodity_slug)
                            .is_required(True)
                            .should_encode(True))
    ...
    def retrieve_a_list_of_all_fuel_prices(self,
                                           commodity_slug,
                                           accept):
        """Does a GET request to /fuel_prices/commodity_slug/{commodity_slug}.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.SERVER_1)
            .path('/fuel_prices/commodity_slug/{commodity_slug}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('commodity_slug')
                            .value(commodity_slug)
