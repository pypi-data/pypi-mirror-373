...
from uexcorpapi.models.ok_57 import Ok57
...
class MoonsController(BaseController):
    ...
    def __init__(self, config):
        super(MoonsController, self).__init__(config)

    def retrieve_a_list_of_all_moons_within_a_star_system(self,
                                                          id_star_system,
                                                          accept):
        """Does a GET request to /moons.
