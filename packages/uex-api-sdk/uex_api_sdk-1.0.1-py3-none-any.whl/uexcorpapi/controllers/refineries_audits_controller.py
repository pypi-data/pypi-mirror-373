...
from uexcorpapi.models.ok_64 import Ok64


class RefineriesAuditsController(BaseController):

    """A Controller to access Endpoints in the uexcorpapi API."""
    def __init__(self, config):
        super(RefineriesAuditsController, self).__init__(config)

    def retrieve_a_list_of_all_refinery_audits_submitted_by_data_runners(self,
                                                                         accept):
        """Does a GET request to /refineries_audits.
