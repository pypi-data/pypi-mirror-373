...
from uexcorpapi.models.data_17 import Data17


class Ok52(object):

    """Implementation of the 'OK52' model.

    Attributes:
        data (List[Data17]): The model property of type List[Data17].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok52 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data17.from_dictionary(x) for x in dictionary.get('data')]
