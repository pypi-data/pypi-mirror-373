...
from uexcorpapi.models.datum_15 import Datum15
...
class Ok16(object):
    ...
    Attributes:
        data (List[Datum15]): The model property of type List[Datum15].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum15.from_dictionary(x) for x in dictionary.get('data')]
