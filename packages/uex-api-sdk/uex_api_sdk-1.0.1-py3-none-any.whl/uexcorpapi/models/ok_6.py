...
from uexcorpapi.models.datum_5 import Datum5


class Ok6(object):

    """Implementation of the 'OK6' model.

    Attributes:
        data (List[Datum5]): The model property of type List[Datum5].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum5.from_dictionary(x) for x in dictionary.get('data')]
