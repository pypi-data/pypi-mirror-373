...
from uexcorpapi.models.data_42 import Data42
...
class Ok78(object):
    ...
    Attributes:
        data (List[Data42]): The model property of type List[Data42].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data42.from_dictionary(x) for x in dictionary.get('data')]
