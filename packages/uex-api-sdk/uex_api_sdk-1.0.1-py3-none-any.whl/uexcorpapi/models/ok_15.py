...
from uexcorpapi.models.datum_14 import Datum14


class Ok15(object):

    """Implementation of the 'OK15' model.

    Attributes:
        data (List[Datum14]): The model property of type List[Datum14].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok15 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum14.from_dictionary(x) for x in dictionary.get('data')]
