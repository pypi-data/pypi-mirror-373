...
from uexcorpapi.models.data_25 import Data25


class Ok61(object):

    """Implementation of the 'OK61' model.

    Attributes:
        data (List[Data25]): The model property of type List[Data25].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok61 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data25.from_dictionary(x) for x in dictionary.get('data')]
