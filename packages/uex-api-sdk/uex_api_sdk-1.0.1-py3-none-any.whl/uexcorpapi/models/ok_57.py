...
from uexcorpapi.models.data_21 import Data21
...
class Ok57(object):
    ...
    Attributes:
        data (List[Data21]): The model property of type List[Data21].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data21.from_dictionary(x) for x in dictionary.get('data')]
