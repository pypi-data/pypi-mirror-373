...
from uexcorpapi.models.data_28 import Data28


class Ok64(object):

    """Implementation of the 'OK64' model.

    Attributes:
        data (List[Data28]): The model property of type List[Data28].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok64 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data28.from_dictionary(x) for x in dictionary.get('data')]
