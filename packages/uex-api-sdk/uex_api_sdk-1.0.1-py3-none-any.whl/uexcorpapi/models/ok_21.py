...
from uexcorpapi.models.datum_19 import Datum19
...
class Ok21(object):
    ...
    Attributes:
        data (List[Datum19]): The model property of type List[Datum19].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum19.from_dictionary(x) for x in dictionary.get('data')]
