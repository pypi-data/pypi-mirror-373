...
from uexcorpapi.models.data_43 import Data43
...
class Ok79(object):
    ...
    Attributes:
        data (List[Data43]): The model property of type List[Data43].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data43.from_dictionary(x) for x in dictionary.get('data')]
