...
from uexcorpapi.models.data_29 import Data29


class Ok65(object):

    """Implementation of the 'OK65' model.

    Attributes:
        data (List[Data29]): The model property of type List[Data29].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok65 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data29.from_dictionary(x) for x in dictionary.get('data')]
