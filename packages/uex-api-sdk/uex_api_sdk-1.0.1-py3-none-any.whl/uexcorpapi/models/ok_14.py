...
from uexcorpapi.models.datum_13 import Datum13


class Ok14(object):

    """Implementation of the 'OK14' model.

    Attributes:
        data (List[Datum13]): The model property of type List[Datum13].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok14 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum13.from_dictionary(x) for x in dictionary.get('data')]
