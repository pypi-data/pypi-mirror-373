...
from uexcorpapi.models.data_19 import Data19


class Ok54(object):

    """Implementation of the 'OK54' model.

    Attributes:
        data (List[Data19]): The model property of type List[Data19].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok54 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data19.from_dictionary(x) for x in dictionary.get('data')]
