...
from uexcorpapi.models.data_35 import Data35


class Ok71(object):

    """Implementation of the 'OK71' model.

    Attributes:
        data (List[Data35]): The model property of type List[Data35].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok71 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data35.from_dictionary(x) for x in dictionary.get('data')]
