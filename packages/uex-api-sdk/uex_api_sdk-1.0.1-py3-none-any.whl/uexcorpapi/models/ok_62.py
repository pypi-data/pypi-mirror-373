...
from uexcorpapi.models.data_26 import Data26
...
class Ok62(object):
    ...
    Attributes:
        data (List[Data26]): The model property of type List[Data26].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data26.from_dictionary(x) for x in dictionary.get('data')]
