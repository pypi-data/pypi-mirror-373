...
from uexcorpapi.models.data_27 import Data27
...
class Ok63(object):
    ...
    Attributes:
        data (List[Data27]): The model property of type List[Data27].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data27.from_dictionary(x) for x in dictionary.get('data')]
