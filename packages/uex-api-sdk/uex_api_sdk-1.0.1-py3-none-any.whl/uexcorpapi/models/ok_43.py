...
from uexcorpapi.models.data_8 import Data8


class Ok43(object):

    """Implementation of the 'OK43' model.

    Attributes:
        data (List[Data8]): The model property of type List[Data8].
    ...
    def __init__(self,
        ...
        """Constructor for the Ok43 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Data8.from_dictionary(x) for x in dictionary.get('data')]
