...
def register_imports_flat(
    ...
    Args:
        target_package: Target package path (e.g., "src.xlib.xcombot")
    ...
    Example:
        register_imports_flat(
            target_package="src.xlib.xcombot",
            source_folders=["src/xlib/xcombot/core", "src/xlib/xcombot/platforms"]
        )
    """
    if logger_instance:
        global logger
...
def register_imports_batch(
    ...
    Example:
        tasks = [
            {
                "target_package": "src.xlib.xcombot.core",
                "source_folders": ["src/xlib/xcombot/core"]
            },
            {
                "target_package": "src.xlib.xcombot.platforms",
                "source_folders": ["src/xlib/xcombot/platforms"]
            }
        ]
