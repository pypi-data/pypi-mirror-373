...
class ChatbotConversationModel(BaseModel):
    ...
    number_of_files: Optional[StrictInt] = 0
    size_of_files: Optional[Union[StrictFloat, StrictInt]] = 0.0
    is_shared: Optional[StrictBool] = False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "number_of_files": obj.get("number_of_files") if obj.get("number_of_files") is not None else 0,
            "size_of_files": obj.get("size_of_files") if obj.get("size_of_files") is not None else 0.0,
