...
class CallbackState(BaseModel):
    ...
    callback_status: StrictStr
    message: StrictStr
    __properties: ClassVar[List[str]] = ["status", "username", "dataset", "connector_id", "connector_type", "chatting_origin", "conversation_id", "callback_status", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallbackState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallbackState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "chatting_origin": obj.get("chatting_origin"),
