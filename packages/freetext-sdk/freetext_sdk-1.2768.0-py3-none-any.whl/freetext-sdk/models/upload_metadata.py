...
class UploadMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file_name", "original_file_name", "file_extension", "file_id", "connector_type", "connector_id", "source", "display_name", "title", "additional_fields", "weight", "do_ocr"]
