...
class SocketReportCopilotGenerationFromTemplateResponse(BaseModel):
    """
    ...
    total: StrictInt
    __properties: ClassVar[List[str]] = ["slots", "text", "username", "dataset", "jwt", "api_key", "conversation_id", "user", "status", "done", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SocketReportCopilotGenerationFromTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SocketReportCopilotGenerationFromTemplateResponse from a dict"""
        if obj is None:
            return None
