...
class SearchPayload(BaseModel):
    ...
    username: StrictStr
    dataset: StrictStr
    auto_apply_filters: Optional[StrictBool] = True
    text_fragmentation: Optional[StrictBool] = False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_apply_filters": obj.get("auto_apply_filters") if obj.get("auto_apply_filters") is not None else True,
            "text_fragmentation": obj.get("text_fragmentation") if obj.get("text_fragmentation") is not None else False,
