...
class Source(BaseModel):
    ...
    from_page: Optional[StrictInt] = Field(default=-1, description="The starting page number of the document section, if applicable.")
    to_page: Optional[StrictInt] = Field(default=-1, description="The ending page number of the document section, if applicable.")
    ...
    file_id: Optional[StrictStr] = Field(default='', description="The unique identifier of the file in the system.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from_page": obj.get("from_page") if obj.get("from_page") is not None else -1,
            "to_page": obj.get("to_page") if obj.get("to_page") is not None else -1,
