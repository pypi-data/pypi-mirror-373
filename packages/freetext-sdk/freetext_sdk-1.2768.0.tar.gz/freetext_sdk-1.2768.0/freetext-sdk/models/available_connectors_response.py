...
class AvailableConnectorsResponse(BaseModel):
    ...
    message: Optional[StrictStr] = 'Available Connectors Retrieved Successfully'
    available_connectors: List[ConnectorType]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": obj.get("message") if obj.get("message") is not None else 'Available Connectors Retrieved Successfully',
