...
class ChatbotDefaultSettingsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["system_message", "llm_choice", "llm_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatbotDefaultSettingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatbotDefaultSettingsResponse from a dict"""
        if obj is None:
            return None
