...
class RAGResponse(BaseModel):
    ...
    is_regenerate: Optional[StrictBool] = Field(default=False, description="Specifies whether the response was regenerated.")
    ...
    mode: Optional[DataFillingMode] = Field(default=None, description="The mode of the response generation.")
