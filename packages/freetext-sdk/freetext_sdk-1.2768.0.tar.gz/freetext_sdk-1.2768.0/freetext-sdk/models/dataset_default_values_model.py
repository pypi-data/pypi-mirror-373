...
class DatasetDefaultValuesModel(BaseModel):
    ...
    stream_speed: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Stream speed")
    top_k_retriever: Optional[StrictInt] = Field(default=128, description="Number of retriever results")
    do_ocr: Optional[StrictBool] = Field(default=False, description="Flag for OCR usage")
    weight_title: Optional[Union[StrictFloat, StrictInt]] = Field(default=1.0, description="Weight of title in ranking")
    weight_text: Optional[Union[StrictFloat, StrictInt]] = Field(default=1.0, description="Weight of text in ranking")
    track_geo: Optional[StrictBool] = Field(default=None, description="Flag to track geo location")
    use_training: Optional[StrictBool] = Field(default=True, description="Flag to use training data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stream_speed": obj.get("stream_speed") if obj.get("stream_speed") is not None else 0.0,
            "top_k_retriever": obj.get("top_k_retriever") if obj.get("top_k_retriever") is not None else 128,
            "do_ocr": obj.get("do_ocr") if obj.get("do_ocr") is not None else False,
            "weight_title": obj.get("weight_title") if obj.get("weight_title") is not None else 1.0,
            "weight_text": obj.get("weight_text") if obj.get("weight_text") is not None else 1.0,
            "track_geo": obj.get("track_geo"),
            "use_training": obj.get("use_training") if obj.get("use_training") is not None else True,
