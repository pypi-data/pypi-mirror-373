...
class ChatbotChatPayload(BaseModel):
    ...
    is_regenerate: Optional[StrictBool] = False
    ...
    bypass_guardrail: Optional[StrictBool] = False
    ...
    agentic_chatbot_enabled: Optional[StrictBool] = Field(default=False, description="Whether to enable agentic chatbot")
