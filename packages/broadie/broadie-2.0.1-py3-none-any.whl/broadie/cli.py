...
def ensure_env_file():
    ...
    if not env_path.exists():
        ...
        click.secho(
            "✅ Created .env file with API_KEY, you will use this when APIKeyHeader (apiKey) is needed example to call /invoke",
            fg="green")
    else:
        click.secho(
            "🔍 Found existing .env file, you will use this when APIKeyHeader (apiKey) is needed example to call /invoke",
            fg="blue")
...
@click.option("--host", default=settings.API_HOST, type=str)
