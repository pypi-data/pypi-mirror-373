...
from octavia_loxilb_driver.controller.worker.flows import loxilb_flows
from octavia_loxilb_driver.controller.worker.flows import loxilb_load_balancer_flows
...
LOXILB_FLOWS = loxilb_flows.LoxiLBFlows()
LOXILB_LB_FLOWS = loxilb_load_balancer_flows.LoxiLBLoadBalancerFlows()
def get_create_loxilb_load_balancer_flow():
    return LOXILB_LB_FLOWS.get_create_load_balancer_flow()

def get_delete_loxilb_load_balancer_flow():
    return LOXILB_LB_FLOWS.get_delete_load_balancer_flow()

def get_create_loxilb_flow():
    return LOXILB_FLOWS.get_create_loxilb_flow()

def get_delete_loxilb_flow():
    return LOXILB_FLOWS.get_delete_loxilb_flow()
