...
class BrowserConfig:
    ...
    browser_data_dir: str = "tmp/browser-data"
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'BrowserConfig':
        ...
        known_keys = {
            'browser_data_dir', 'headless', 'timeout', 'min_browsers', 'max_browsers',
...
def create_basic_config(browser_data_dir: str = "tmp/browser-data", headless: bool = True) -> BrowserConfig:
...
def create_scaling_config(min_browsers: int = 2, max_browsers: int = 6, 
                         browser_data_dir: str = "tmp/browser-data") -> BrowserConfig:
...
def create_proxy_config(proxy_url: str, browser_data_dir: str = "tmp/browser-data") -> BrowserConfig:
...
def create_legacy_config(browsers_count: int = 4, browser_data_dir: str = "tmp/browser-data") -> BrowserConfig:
