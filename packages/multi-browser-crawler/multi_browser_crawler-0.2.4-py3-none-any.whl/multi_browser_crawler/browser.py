...
class Browser:
    ...
    def __init__(self, session_id: str, config: Dict[str, Any], debug_port_manager: DebugPortManager,
        ...
        self._user_data_dir = self._setup_user_data_directory()
    ...
    async def _cleanup_internal(self) -> None:
        ...
        try:
            ...
            if self._user_data_dir and os.path.exists(self._user_data_dir):
                safe_remove_directory(self._user_data_dir, f"user data for {self.browser_id}")
    ...
    def _setup_user_data_directory(self) -> str:
        """Setup user data directory for this browser session"""
