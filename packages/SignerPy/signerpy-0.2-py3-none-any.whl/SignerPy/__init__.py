...
def xtoken(params: dict = None, sessionid: bytes = None):
    ...
    x = hmac.new(sessionid, (ms_token + ts).encode() + sessionid, hashlib.sha256).hexdigest()
        
    x_tt_token = f"{ms_token}--{x}-3.0.0" #L7N
