...
class BulkOperationsMixin:
    ...
    def create(self, request, *args, **kwargs):
        ...
        if unique_fields_param and isinstance(request.data, list):
            print(f"BulkOperationsMixin.create() - Routing to _sync_upsert with unique_fields: {unique_fields_param}", file=sys.stderr)
            return self._sync_upsert(request, unique_fields_param)

        print(f"BulkOperationsMixin.create() - Using standard create behavior", file=sys.stderr)
