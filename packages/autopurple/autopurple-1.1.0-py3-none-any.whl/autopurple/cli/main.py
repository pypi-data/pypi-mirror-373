...
# Import and add setup command
@app.command("setup", help="Interactive setup wizard for AutoPurple")
def setup():
    ...
    try:
        ...
        console.print("Please install AutoPurple with: pip install autopurple --upgrade")
