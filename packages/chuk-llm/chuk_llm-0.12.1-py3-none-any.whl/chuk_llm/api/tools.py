...
class ToolKit:
    ...
    async def ask(self, prompt: str, auto_execute: bool = True, **kwargs) -> str:
        ...
        if auto_execute:
            ...
            tool_functions = {name: tool.func for name, tool in self.tools.items() if tool.func}
...
def tool(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        func._tool_description = description or func.__doc__ or f"Function {func.__name__}"
        func._is_tool = True
        return func
...
def _python_type_to_json_schema(python_type: type) -> str:
    ...
    if hasattr(python_type, "__origin__"):
        if python_type.__origin__ is type(Optional):
            ...
            inner_type = python_type.__args__[0] if python_type.__args__ else Any
