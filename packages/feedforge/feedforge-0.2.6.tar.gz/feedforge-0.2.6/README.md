...
By default, FeedForge uses a separate Chrome profile to avoid conflicts. To use your existing Chrome profile (with all your logins):

```bash
# Use your default Chrome profile (may fail if Chrome is already running)
export FEEDFORGE_USE_DEFAULT_CHROME=true
feedforge "your interests"
```
