...
def dggsinspect() -> gpd.GeoDataFrame:
    """
    Generate comprehensive inspection data for multiple DGGS types using DGGS_INSPECT configuration.
    
    This function calls the individual inspect functions for all DGGS types defined in DGGS_INSPECT
    ...
    Returns:
        geopandas.GeoDataFrame: Combined DataFrame containing inspection data from all DGGS types
            with columns:
            - dggs_type: Type of DGGS (h3, s2, a5, rhealpix, isea4t, etc.)
...
def dggsinspect_cli():
    ...
    try:
        ...
        output_file = "dggs_inspect.parquet"
