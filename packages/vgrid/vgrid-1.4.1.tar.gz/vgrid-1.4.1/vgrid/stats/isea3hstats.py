...
def isea3h_metrics(res, unit: str = "km"):                   # length unit is km, area unit is km2
    """
    ...
    if unit == "m":
        avg_edge_len = avg_edge_len * 1000 # edge length in m
        avg_cell_area = avg_cell_area * (10**6) # cell area in m²
    
    return num_cells, avg_edge_len, avg_cell_area, cls


def isea3hstats(unit: str = "km"):                   # length unit is km, area unit is km2
    """
