...
def maidenhead_metrics(res, unit: str = "km"):    # length unit is km, area unit is km2
    """
    ...
    if unit == "m":
        ...
        avg_edge_len = avg_edge_len * 1000  # Convert km to m
    
    return num_cells, avg_edge_len, avg_cell_area, cls


def maidenheadstats(unit: str = "km"):                        # length unit is km, area unit is km2
    """
