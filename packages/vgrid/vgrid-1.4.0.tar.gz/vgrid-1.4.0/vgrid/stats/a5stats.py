...
def a5_metrics(res, unit: str = "km"):                         # length unit is km, area unit is km2
    """
    ...
    avg_edge_len = round(math.sqrt(4*avg_cell_area/k), 3) # edge length in m
    
    # Convert to requested unit
    if unit == "km":
        avg_edge_len = avg_edge_len / 1000.0
        avg_cell_area = avg_cell_area / (1000.0 ** 2)
