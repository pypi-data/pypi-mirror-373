...
@pytest.mark.parametrize("tool_name,command,expected_continue,expected_exit_code", [
...
def test_command_validator(tool_name, command, expected_continue, expected_exit_code):
    ...
    validator_script = Path(__file__).parent.parent / "examples" / "simple_command_validator.py"
