...
try:
    ...
    from pycw7_ansible.features.l2vpn import L2VPN
    from pycw7_ansible.features.interface import Interface
    from pycw7_ansible.utils.validate import valid_ip_network
    from pycw7_ansible.features.vsi_intf import Vsi
