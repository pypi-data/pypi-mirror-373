...
try:
    ...
    from pycw7_ansible.features.file_copy import FileCopy
    from pycw7_ansible.features.install_os import InstallOs
    from pycw7_ansible.features.reboot import Reboot
