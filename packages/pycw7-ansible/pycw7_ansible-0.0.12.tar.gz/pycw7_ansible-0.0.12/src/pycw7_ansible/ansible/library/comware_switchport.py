...
try:
    ...
    from pycw7_ansible.features.switchport import Switchport
    from pycw7_ansible.features.vlan import Vlan
    from pycw7_ansible.features.portchannel import Portchannel
    from pycw7_ansible.errors import PYCW7Error
