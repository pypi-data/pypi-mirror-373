...
``tendril-i4-types`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-i4-types/releases>`_.
...
``tendril-i4-types``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-i4-types.git
    $ cd tendril-i4-types
    $ pip install -e .
