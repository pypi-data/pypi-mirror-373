...
setup(
    name='tendril-i4-types',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Primitives and Types for i4 Tendril Deployments",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-i4-types',
    project_urls={
        'Documentation': 'https://tendril-i4-types.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-i4-types/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-i4-types',
    },
