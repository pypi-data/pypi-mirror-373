...
from proalgotrader_core.candle_processors import CandleProcessorFactory
...
class Chart:
    ...
    async def update_existing_candle(self, tick: "Tick"):
        ...
        processed_data = await self.__candle_processor.process_existing_candle(
    ...
    async def add_new_candle(self, tick: "Tick"):
        # Process new candle data using the appropriate processor
        processed_data = await self.__candle_processor.process_new_candle(
    ...
    async def update_chart(self, tick: "Tick"):
        try:
    ...
    async def add_indicator(self, *, key: str, indicator: Indicator | Any) -> Indicator:
        ...
        await indicator.initialize(self.__df, self.algo_session)
