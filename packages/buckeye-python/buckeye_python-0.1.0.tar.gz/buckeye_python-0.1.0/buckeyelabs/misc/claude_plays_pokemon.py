...
from buckeyelabs.adapters import Adapter
from buckeyelabs.adapters.common.types import CLA

# Update import to current API; if this script is legacy, keep it optional
try:
    from buckeyelabs.agents import MCPAgent as Agent  # type: ignore[assignment]
except Exception:  # pragma: no cover - optional example script
    from buckeyelabs.agents import MCPAgent as Agent  # fallback
...
if TYPE_CHECKING:
    ...
    from buckeyelabs.env.environment import Observation
