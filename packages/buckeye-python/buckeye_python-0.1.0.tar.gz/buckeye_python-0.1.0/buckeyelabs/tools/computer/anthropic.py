...
class AnthropicComputerTool(BuckEyeComputerTool):
    """
    ...
    async def __call__(
        ...
        This converts Anthropic's action format to BuckEyeComputerTool's format.
        ...
        # Map Anthropic actions to BuckEyeComputerTool actions
        if action == "screenshot":
            ...
            # Convert seconds to milliseconds for BuckEyeComputerTool
