...
from buckeyelabs.tools.base import BaseTool
from buckeyelabs.tools.executors.base import BaseExecutor
from buckeyelabs.tools.executors.pyautogui import PyAutoGUIExecutor
from buckeyelabs.tools.executors.xdo import XDOExecutor
from buckeyelabs.tools.types import ContentResult, ToolError
...
class BuckEyeComputerTool(BaseTool):
    """
    ...
    def __init__(
        ...
        width: int | None = computer_settings.BUCKEYE_COMPUTER_WIDTH,
        height: int | None = computer_settings.BUCKEYE_COMPUTER_HEIGHT,
        rescale_images: bool = computer_settings.BUCKEYE_RESCALE_IMAGES,
        ...
        """
        Initialize the Buckeye computer tool.
    ...
    async def __call__(
        ...
        """
        logger.info("BuckEyeComputerTool executing action: %s", action)
