...
class MCPToolCall(CallToolRequestParams):
    ...
    def __str__(self) -> str:
        """Format tool call with Rich markup for Buckeye design."""
        from buckeyelabs.utils.design import design
...
class MCPToolResult(CallToolResult):
    ...
    def __str__(self) -> str:
        """Format tool result with Rich markup for Buckeye design - compact version."""
        from buckeyelabs.utils.design import design
...
class AgentResponse(BaseModel):
    ...
    # --- TELEMETRY [app.hud.so] # TODO: change to buckeye.so or localhost:8765
    # Responses
