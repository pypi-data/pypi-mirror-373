...
from buckeyelabs.server.low_level import LowLevelServerWithInit
...
class MCPServer(FastMCP):
    ...
    4. Enhanced ``add_tool`` that accepts instances of
       :class:`buckeyelabs.tools.base.BaseTool` which are classes that implement the
