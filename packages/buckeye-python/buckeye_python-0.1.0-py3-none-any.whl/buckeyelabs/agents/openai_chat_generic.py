...
through the existing :class:`buckeyelabs.agent.MCPAgent` scaffolding.
...
- All buckeye features (step_count, OTel spans, tool filtering, screenshots, …)
...
from buckeyelabs.types import AgentResponse, MCPToolCall, MCPToolResult
...
if TYPE_CHECKING:
    ...
    from buckeyelabs.clients import AgentMCPClient
