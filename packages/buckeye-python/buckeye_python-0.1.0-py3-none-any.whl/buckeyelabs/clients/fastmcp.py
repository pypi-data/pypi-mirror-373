...
from .base import BaseBUCKEYEClient
...
class FastMCPBUCKClient(BaseBUCKEYEClient):
    """FastMCP-based implementation of Buckeye MCP client."""

    client_info = Implementation(
        name="buckeye-fastmcp", title="buckeye FastMCP Client", version=buckeye_version
    )
