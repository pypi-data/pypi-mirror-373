"""Remote runner for Buckeye MCP servers."""
...
def build_remote_headers(
    ...
    """Build headers for remote Buckeye MCP server.
...
def run_remote_stdio(
    ...
    async def run() -> None:
        ...
        try:
            ...
            proxy = FastMCP.as_proxy(proxy_config, name="Buckeye Remote Proxy")
...
async def run_remote_http(
    ...
    proxy = FastMCP.as_proxy(config, name="Buckeye Remote Proxy")
