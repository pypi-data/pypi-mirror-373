"""Remove Buckeye environments from local registry."""
...
def remove_environment(
    ...
    design = BUCKDesign()
    design.header("Buckeye Environment Removal")
    ...
    if not found_entry:
        ...
        design.info("Use 'buckeye list' to see available environments")
        raise typer.Exit(1)
...
def remove_all_environments(
    ...
    design = BUCKDesign()
    design.header("Remove All Buckeye Environments")
