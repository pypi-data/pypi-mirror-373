"""Buckeye Design System - Consistent styling utilities for CLI output.

This module provides a unified design system for Buckeye CLI commands,
...
class BUCKDesign:
    """Design system for Buckeye CLI output."""
    ...
    def format_tool_call(self, name: str, arguments: dict[str, Any] | None = None) -> str:
        """Format a tool call in compact Buckeye style.
    ...
    def format_tool_result(self, content: str, is_error: bool = False) -> str:
        """Format a tool result in compact Buckeye style.
        ...
        # Format with status using Buckeye colors
        if is_error:
