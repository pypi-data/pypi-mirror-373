...
class ComputerSettings(BaseSettings):
    """
    Local computer settings for the Buckeye SDK.

    This class manages local computer settings for the Buckeye SDK.
    """
    ...
    BUCKEYE_COMPUTER_WIDTH: int | None = Field(
        default=None,
        description="Width of the display to use for the computer tools",
        validation_alias="BUCKEYE_COMPUTER_WIDTH",
    )
    BUCKEYE_COMPUTER_HEIGHT: int | None = Field(
        default=None,
        description="Height of the display to use for the computer tools",
        validation_alias="BUCKEYE_COMPUTER_HEIGHT",
    )
    ...
    BUCKEYE_RESCALE_IMAGES: bool = Field(
        default=False,
        description="Whether to rescale images to the agent width and height",
        validation_alias="BUCKEYE_RESCALE_IMAGES",
    )
