    ...
    def info(cls, *content:str) -> None:
        ...
        *Example*:
        ...
        if LogLevel.INFO in cls._active_levels:
            print(f'{Fore.MAGENTA}[{timestamp()}] {Fore.GREEN}[i] {" ".join(content)}{Fore.WHITE}')
    ...
    def warn(cls, *content:str) -> None:
        ...
        *Example*:
        ...
        if LogLevel.WARN in cls._active_levels:
            print(f'{Fore.MAGENTA}[{timestamp()}] {Fore.YELLOW}[w] {" ".join(content)}{Fore.WHITE}')
    ...
    def error(cls, *content:str, quit_after_log:bool=False) -> None:
        ...
        *Example*:
        ...
        if LogLevel.ERROR in cls._active_levels:
            print(f'{Fore.MAGENTA}[{timestamp()}] {Fore.RED}[!] {" ".join(content)}{Fore.WHITE}')
    ...
    def debug(cls, *content:str) -> None:
        ...
        *Example*:
        ...
        if LogLevel.DEBUG in cls._active_levels:
         print(f'{Fore.MAGENTA}[{timestamp()}] {Fore.LIGHTBLACK_EX}[?] {" ".join(content)}{Fore.WHITE}')
