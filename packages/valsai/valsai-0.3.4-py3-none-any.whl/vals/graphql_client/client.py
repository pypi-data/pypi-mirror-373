...
class Client(AsyncBaseClient):
    ...
    async def add_all_tests_to_queue_single(
        ...
        **kwargs: Any
        ...
        query = gql(
            """
            mutation AddAllTestsToQueueSingle($runId: String!, $templateIds: [String!], $assignedReviewers: [String!], $numberOfReviews: Int!, $rereviewAutoEval: Boolean!, $projectId: String!) {
    ...
    async def add_or_remove_users_to_run_review(
        ...
        **kwargs: Any
        ...
        query = gql(
            """
            mutation AddOrRemoveUsersToRunReview($singleRunReviewId: String!, $projectId: String!, $assignedReviewers: [String!]!) {
