...
class DocumentConverter(BaseConverter):
    ...
    async def to_dict(self):
        ...
        for attr in obj_attrs:
            ...
            if is_ref or is_embed:
                ...
                obj_attr = await converter.to_dict()
            elif is_list:
    ...
    async def to_json(self):
        dict_to_convert = await self.to_dict()
...
class RequestConverter(BaseConverter):
    ...
    async def _parse(self, obj, care_about_lists=False):
        ...
        for key, value in obj.items():
            ...
            if is_reference and is_join:
                key, value = await self._get_reference(key, value)
    ...
    async def get_query(self):
        ...
        get() or filter()
        """
        r = await self._parse(self.arguments, care_about_lists=True)
        return r
    ...
    async def _get_reference(self, key, value):
        ...
        try:
            ...
            value = await ref_class.objects.get(**kwargs)
