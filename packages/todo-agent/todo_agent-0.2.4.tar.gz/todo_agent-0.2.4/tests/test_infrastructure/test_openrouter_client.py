...
class TestOpenRouterClient:
    ...
    def test_chat_with_tools_success(self):
        ...
        with patch("requests.post") as mock_post, patch.object(
        ...
        ) as mock_info, patch.object(self.client.logger, "debug") as mock_debug:
            mock_response = Mock()
            ...
            assert (
                mock_debug.call_count >= 1
            )  # Raw response log (request debug is commented out)
    ...
    def test_extract_tool_calls_no_tool_calls(self):
        ...
        response = {"choices": [{"message": {"content": "Just a regular response"}}]}
    ...
    def test_extract_content_success(self):
        ...
        response = {"choices": [{"message": {"content": "Here's your task list"}}]}
    ...
    def test_logging_functionality(self):
        ...
        with patch("requests.post") as mock_post, patch.object(
            ...
            raw_request_logs = [
                log for log in debug_calls if "Raw request payload" in log
            ]
