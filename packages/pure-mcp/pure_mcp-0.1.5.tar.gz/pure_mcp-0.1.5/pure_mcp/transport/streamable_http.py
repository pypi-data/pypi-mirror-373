...
from ..core.message import ClientMessageMetadata, SessionMessage
...
from .http_utils import McpHttpClientFactory, create_mcp_http_client

logger = logging.getLogger(__name__)


SessionMessageOrError = Union[SessionMessage, Exception]
StreamWriter = MemoryObjectSendStream[SessionMessageOrError]
StreamReader = MemoryObjectReceiveStream[SessionMessage]
GetSessionIdCallback = Callable[[], Union[str, None]]
...
class RequestContext:
    ...
    metadata: Union[ClientMessageMetadata, None]
...
class StreamableHTTPTransport:
    ...
    def __init__(
        ...
        timeout: Union[float, timedelta] = 30,
        sse_read_timeout: Union[float, timedelta] = 60 * 5,
    ...
    async def _handle_sse_event(
        ...
        sse: ServerSentEvent,
        read_stream_writer: StreamWriter,
        original_request_id: Union[RequestId, None] = None,
        resumption_callback: Union[Callable[[str], Awaitable[None]], None] = None,
