...
class CommandBuffer(GfxObject):
    ...
    def image_barrier(self, image: Image, dst_layout: ImageLayout, src_usage: MemoryUsage, dst_usage: MemoryUsage, src_queue_family_index: int = 4294967295, dst_queue_family_index: int = 4294967295, aspect_mask: ImageAspectFlags = 1, undefined: bool = False) -> None: ...
    ...
    def bind_pipeline(self, pipeline: GraphicsPipeline | ComputePipeline) -> None: ...

    def bind_descriptor_sets(self, pipeline: GraphicsPipeline | ComputePipeline, descriptor_sets: Sequence[DescriptorSet], dynamic_offsets: Sequence[int] = [], first_descriptor_set: int = 0) -> None: ...

    def push_constants(self, pipeline: GraphicsPipeline | ComputePipeline, push_constants: bytes, offset: int = 0) -> None: ...

    def bind_compute_pipeline(self, pipeline: ComputePipeline, descriptor_sets: Sequence[DescriptorSet] = [], dynamic_offsets: Sequence[int] = [], first_descriptor_set: int = 0, push_constants: bytes | None = None, push_constants_offset: int = 0) -> None: ...

    def bind_vertex_buffers(self, vertex_buffers: Sequence[Buffer | tuple[Buffer, int]], first_vertex_buffer_binding: int = 0) -> None: ...

    def bind_index_buffers(self, index_buffer: Buffer, index_buffer_offset: int = 0, index_type: IndexType = IndexType.UINT32) -> None: ...

    def bind_graphics_pipeline(self, pipeline: GraphicsPipeline, descriptor_sets: Sequence[DescriptorSet] = [], dynamic_offsets: Sequence[int] = [], first_descriptor_set: int = 0, push_constants: bytes | None = None, push_constants_offset: int = 0, vertex_buffers: Sequence[Buffer | tuple[Buffer, int]] = [], first_vertex_buffer_binding: int = 0, index_buffer: Buffer | None = None, index_buffer_offset: int = 0, index_type: IndexType = IndexType.UINT32) -> None: ...
    ...
    def blit_image(self, src: Image, dst: Image, filter: Filter = Filter.NEAREST, src_aspect: ImageAspectFlags = 1, dst_aspect: ImageAspectFlags = 1) -> None: ...

    def blit_image_range(self, src: Image, src_width: Image, src_height: Filter, dst: int, dst_width: int, dst_height: int, filter: int = Filter.NEAREST, src_x: ImageAspectFlags = 0, src_y: int = 0, src_aspect: int = 1, dst_x: int = 0, dst_y: int = 0, dst_aspect: ImageAspectFlags = 1) -> None: ...

    def resolve_image(self, src: Image, dst: Image, src_aspect: ImageAspectFlags = 1, dst_aspect: ImageAspectFlags = 1) -> None: ...

    def resolve_image_range(self, src: Image, dst: Image, width: int, height: int, src_x: int = 0, src_y: int = 0, src_aspect: ImageAspectFlags = 1, dst_x: int = 0, dst_y: int = 0, dst_aspect: ImageAspectFlags = 1) -> None: ...
