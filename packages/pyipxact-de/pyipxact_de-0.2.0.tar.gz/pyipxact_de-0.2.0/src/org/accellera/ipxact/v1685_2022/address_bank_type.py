...
from org.accellera.ipxact.v1685_2022.banked_bank_type import BankedBankType
...
class AddressBankType:
    ...
    access_handles: Optional["AddressBankType.AccessHandles"] = field(
        default=None,
        metadata={
            "name": "accessHandles",
            "type": "Element",
    ...
    bank_definition_ref: Optional["AddressBankType.BankDefinitionRef"] = field(
        default=None,
        metadata={
    ...
    bank: Iterable["AddressBankType.Bank"] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.accellera.org/XMLSchema/IPXACT/1685-2022",
