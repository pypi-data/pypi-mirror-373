...
class PreCompile:
    ...
    def _get_base_commit_id(self, product_config: product_config.ProductConfig, depot_name: str = "", stream_name: str = ""):
        '''
    ...
    def run(self, product_config: product_config.ProductConfig, mr_id: str, p4_edit_list: List = [], diff_ninja_log_filter_func: Callable[[str], bool] = None, depot_name: str = "", stream_name: str = ""):
        ...
        base_commit_id, labels = self._get_base_commit_id(product_config=product_config, depot_name=depot_name, stream_name=stream_name)
