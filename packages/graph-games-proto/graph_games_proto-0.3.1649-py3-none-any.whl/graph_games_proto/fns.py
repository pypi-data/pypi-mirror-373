...
def get_player_max_allotted_time(s, player_idx):
    ...
    for legal_action in s.legal_actions_2:
        if legal_action.player_idx == player_idx:
            if legal_action.allotted_time and legal_action.allotted_time.seconds > max_alotted_seconds:
                max_alotted_seconds = legal_action.allotted_time.seconds
                since_action_idx_of_max = legal_action.since_action_idx
