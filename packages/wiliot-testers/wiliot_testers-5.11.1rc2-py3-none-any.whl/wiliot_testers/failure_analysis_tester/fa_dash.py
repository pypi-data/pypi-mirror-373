...
def update_graph(value, tag_alias):
    ...
    if value == 'Empty' or (value + '_current_uA' not in df.columns or value + '_voltage_V' not in df.columns):
...
def run_test(disabled, test_type, tag_type, tag_type_disabled, folder_name, tag_alias, comment, test_fields):
    test_result = ''
    if not tag_alias or not folder_name:
        return False, False, False, tag_type_disabled, False, False, test_result, None, folder_name is not None, True
    if disabled and FAT.is_app_running:
        ...
        return False, False, False, tag_type_disabled, False, False, test_result, None, True, False
    else:
        return True, True, True, True, True, True, '', None, True, False
