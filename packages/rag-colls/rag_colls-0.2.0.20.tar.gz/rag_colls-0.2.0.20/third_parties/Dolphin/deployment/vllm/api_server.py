...
async def custom_process_prompt(
    encoder_prompt: str, decoder_prompt: str, image_base64: str
    ...
    if decoder_prompt == "":
        ...
        decoder_prompt_ids = tokenizer(decoder_prompt, add_special_tokens=False)[
            "input_ids"
        ]
...
async def _generate(request_dict: dict, raw_request: Request) -> Response:
    ...
    enc_dec_prompt = await custom_process_prompt(
        encoder_prompt, decoder_prompt, image_base64
    )
