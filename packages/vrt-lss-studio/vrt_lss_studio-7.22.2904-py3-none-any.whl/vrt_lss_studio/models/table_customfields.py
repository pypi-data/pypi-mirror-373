...
class TableCustomfields(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "int_1": obj.get("int_1") if obj.get("int_1") is not None else null,
            "int_2": obj.get("int_2") if obj.get("int_2") is not None else null,
            "int_3": obj.get("int_3") if obj.get("int_3") is not None else null,
            "int_4": obj.get("int_4") if obj.get("int_4") is not None else null,
            "int_5": obj.get("int_5") if obj.get("int_5") is not None else null,
            "float_1": obj.get("float_1") if obj.get("float_1") is not None else null,
            "float_2": obj.get("float_2") if obj.get("float_2") is not None else null,
            "float_3": obj.get("float_3") if obj.get("float_3") is not None else null,
            "float_4": obj.get("float_4") if obj.get("float_4") is not None else null,
            "float_5": obj.get("float_5") if obj.get("float_5") is not None else null,
