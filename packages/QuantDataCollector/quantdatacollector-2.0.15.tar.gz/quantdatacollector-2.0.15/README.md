...
* 输入参数
    * index_code_list: 类型为list，指定需要的指数代码列表，格式为['000001.SH','000002.SH']，可选参数，如果不指定，则返回所有指数的基本信息
* 输出参数
...
* 输入参数
    * index_code_list: 指数代码列表, 比如['000001.SH', '000002.SH']，可选参数，如果不指定，则返回所有指数的基本信息
    * date: 行情数据日期
    * start_date: 指定需要的起始日期，比如2020-01-01，不指定表示从1990-12-19号开始
    * end_date：指定需要的结束日期，比如2023-12-30，不指定表示到今天截止
* 输出参数
