<h1 align="center">This is a fork with zoom support in nodes.</h1>
<h2 align="center">The goal of this package is to provide support for zoom in nodes while the main package doesn't, waiting for it to align with upstream dependencies. As soon DearPyGui will have this capability, this present package will be removed.</h2>
