...
L_LTOCR_API L_INT EXT_FUNCTION L_OcrPage_GetPreprocessedRotationAngle(L_OcrPage page, L_INT* value);
L_LTOCR_API L_INT EXT_FUNCTION L_OcrPage_AutoZone(L_OcrPage page, L_OcrProgressCallback callback, L_VOID* userData);
L_LTOCR_API L_INT EXT_FUNCTION L_OcrPage_SetBlackListZones(L_OcrPage page, RECT * rcBuffer, int rcCount);
