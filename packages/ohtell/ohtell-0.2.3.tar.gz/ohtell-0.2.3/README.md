...
What OpenTelemetry gives you: 47 lines of boilerplate, 12 imports, and 100 backends that works just a little bit different.
...
**ohtell's philosophy**: Your code does the work, telemetry - observe. If it can't connect? Log a warning and **get out of your way**. **Because unreliable observability is worse than no observability.**
