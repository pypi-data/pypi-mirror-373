...
# Export configuration - Environment variables with sensible defaults
SPAN_EXPORT_INTERVAL_MS = int(os.getenv("OTEL_SPAN_EXPORT_INTERVAL_MS", "500"))   # 0.5 seconds
LOG_EXPORT_INTERVAL_MS = int(os.getenv("OTEL_LOG_EXPORT_INTERVAL_MS", "500"))     # 0.5 seconds  
METRIC_EXPORT_INTERVAL_MS = int(os.getenv("OTEL_METRIC_EXPORT_INTERVAL_MS", "30000"))  # 30 seconds

# Batch sizes - smaller for faster export
MAX_EXPORT_BATCH_SIZE = int(os.getenv("OTEL_MAX_EXPORT_BATCH_SIZE", "50"))  # Small batches
MAX_QUEUE_SIZE = int(os.getenv("OTEL_MAX_QUEUE_SIZE", "512"))  # Smaller queue

# Metrics sampling configuration to reduce volume
METRICS_SAMPLING_RATE = float(os.getenv("OTEL_METRICS_SAMPLING_RATE", "0.1"))  # Sample 10% of metrics
METRICS_ENABLED = os.getenv("OTEL_METRICS_ENABLED", "true").lower() == "true"

# Cleanup configuration
SKIP_CLEANUP = os.getenv("OTEL_WRAPPER_SKIP_CLEANUP", "true").lower() == "true"
