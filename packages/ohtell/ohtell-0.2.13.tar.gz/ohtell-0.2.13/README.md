...
### No Configuration Required (Console Output)

ohtell works out of the box with zero configuration:

```python
import asyncio
from ohtell import task

@task(name="No Config Example")
async def hello():
    print("This works without any setup!")
    return "success"
...
**If you don't understand what entrypoint is you don't need it. Just use `@task`.**
