...
class TestSwapOperation(unittest.TestCase):
    """SwapOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwapOperation:
        """Test SwapOperation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SwapOperation`
        """
        model = SwapOperation()
        if include_optional:
