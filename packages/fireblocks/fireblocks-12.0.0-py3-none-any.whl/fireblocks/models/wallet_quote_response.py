...
class WalletQuoteResponse(BaseModel):
    ...
    provider_quote_id: StrictStr = Field(description="An identifier that uniquely identifies the received quote", alias="providerQuoteId")
    expired_at: datetime = Field(description="When was the received `providerQuoteId` is expired (ISO Date time).", alias="expiredAt")
    required_actions: List[SwapRequiredActionsEnum] = Field(description="The required actions for completing a swap operation", alias="requiredActions")
    estimated_fees: QuoteFee = Field(alias="estimatedFees")
    __properties: ClassVar[List[str]] = ["protocol", "inputAmount", "inputAsset", "slippageTolerance", "outputMinAmount", "outputMaxAmount", "outputAsset", "additionalData", "providerQuoteId", "expiredAt", "requiredActions", "estimatedFees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerQuoteId": obj.get("providerQuoteId"),
            "expiredAt": obj.get("expiredAt"),
            "requiredActions": obj.get("requiredActions"),
            "estimatedFees": QuoteFee.from_dict(obj["estimatedFees"]) if obj.get("estimatedFees") is not None else None
        })
        return _obj
