...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_labels", "content_guard", "name", "base_path", "pulp_href", "hidden", "base_url", "pulp_created", "prn", "pulp_last_updated"]
