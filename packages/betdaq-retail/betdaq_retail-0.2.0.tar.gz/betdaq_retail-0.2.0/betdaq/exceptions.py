...
class ResourceError(BetdaqError):
    def __init__(self):
        message = (
            "The API call was not processed successfully because of some critical resource constraint."
...
class InsufficientVirtualPunterFunds(BetdaqError):
    def __init__(self):
        message = (
            "The Order specified could not be placed because the increase in the amount of the Virtual "
...
class MaximumInputRecordsExceeded(BetdaqError):
    def __init__(self):
        message = (
            "Exceeded the limit on the number of parameters that can be specified."
        )
...
class OrderAPIInProgress(BetdaqError):
    def __init__(self):
        message = (
            "Another order API is currently in progress for this Punter. A Punter can not issue more "
...
class PunterOrderMismatch(BetdaqError):
    def __init__(self):
        message = (
            "One or more of the Orders specified were not issued by the Punter specified or there is a "
...
class MarketNotEnabledForMultiples(BetdaqError):
    def __init__(self):
        message = (
            "The market of one or more selections does not support multiple bets.	"
        )
...
class MultipleSelectionsUnderSameEvent(BetdaqError):
    def __init__(self):
        message = (
            "An attempt was made to place a multiple bet that contained two or more "
...
class MultipleSelectionsWithSameName(BetdaqError):
    def __init__(self):
        message = (
            "An attempt was made to place a multiple bet that contained two or more selections "
...
class PunterHasActiveOrders(BetdaqError):
    def __init__(self):
        message = (
            "An attempt was made to unsuspend Punter from trading. A Punter can only be "
...
class MultipleCombinationExlcusionDoesNotExist(BetdaqError):
    def __init__(self):
        message = (
            "There is not currently an active MultipleCombinationExclusion with the set of Selections specified "
...
class InvalidPassword(BetdaqError):
    def __init__(self):
        message = (
            "The password specified is not a valid password. Specifically it does not conform to the rules "
...
class PunterIsBlacklisted(BetdaqError):
    def __init__(self):
        message = (
            "The operation requested was not executed because the Punter concerned is currently "
...
class PunterNotRegisteredAsMultipleLayer(BetdaqError):
    def __init__(self):
        message = (
            "The requested action could not be performed because the Punter concerned has not been "
...
class UnmatchedOrderCouldResult(BetdaqError):
    def __init__(self):
        message = (
            "The attempt to place an order was not successful because it could result in an unmatched order "
...
class MarketIsForRealMoney(BetdaqError):
    def __init__(self):
        message = (
            "The requested operation cannot be performed because the market concerned is not a play market "
...
class MarketIsForPlayMoney(BetdaqError):
    def __init__(self):
        message = (
            "The requested operation cannot be performed because the market concerned is a plat market "
...
class CannotChangeToSPIfUnmatched(BetdaqError):
    def __init__(self):
        message = (
            "The requested operation could not be performed because the orderFillType of the order "
