...
from .._blackops_java_interop import (
    ensure_init,
    _generate_constraint_provider_class,
    register_java_class,
    wrap_errors,
)
...
def constraint_provider(
    constraint_provider_function: Callable[[ConstraintFactory], list[Constraint]], /
    ...
    def constraint_provider_wrapper(function):
        ...
        java_class = _generate_constraint_provider_class(
...
def easy_score_calculator(
    easy_score_calculator_function: Callable[[Solution_], "Score"]
    ...
    Examples
    --------
    >>> from blackops_legacy.solver.score import SimpleScore, easy_score_calculator
    ...
    java_class = generate_proxy_class_for_translated_function(
        EasyScoreCalculator,
        translate_python_bytecode_to_java_bytecode(
