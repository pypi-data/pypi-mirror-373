...
class _ConstraintCollectorData:
    def __hash__(self):
        raise TypeError(
            "A ConstraintCollector should not be used as a key. "
...
def extract_collector(collector_info, *type_arguments):
    if isinstance(collector_info, NoArgsConstraintCollector):
        ...
        return collector_info.collector_creator(
            function_cast(collector_info.group_mapping, *type_arguments)
        )
    elif isinstance(collector_info, KeyValueMappingConstraintCollector):
        return collector_info.collector_creator(
            function_cast(collector_info.key_mapping, *type_arguments),
        ...
        return collector_info.collector_creator(
            to_int_function_cast(collector_info.group_mapping, *type_arguments)
        )
    elif isinstance(collector_info, GroupMappingIntMappingTwoArgConstraintCollector):
        return collector_info.collector_creator(
            function_cast(collector_info.group_mapping, *type_arguments),
            to_int_function_cast(
                collector_info.index_mapping, JClass("java.lang.Object")
            ),
        )
    elif isinstance(collector_info, ComposeConstraintCollector):
        subcollectors = tuple(
            map(
                lambda subcollector_info: extract_collector(
                    subcollector_info, *type_arguments
                ),
                collector_info.subcollectors,
            )
        )
        compose_parameters = (JClass("java.lang.Object"),) * len(subcollectors)
        compose_function = function_cast(
            collector_info.compose_function, *compose_parameters
        )
        ...
        delegate_collector = extract_collector(
            collector_info.delegate_collector, *type_arguments
        )
        mapping_function = function_cast(
            collector_info.mapping_function, JClass("java.lang.Object")
        )
        ...
        balanced_item_function = function_cast(
            collector_info.balanced_item_function, *type_arguments
        )
        if collector_info.load_function is None:
            return collector_info.collector_creator(balanced_item_function)
        load_function = to_long_function_cast(
            collector_info.load_function, *type_arguments
        )
        if collector_info.initial_load_function is None:
            return collector_info.collector_creator(
                balanced_item_function, load_function
            )
        initial_load_function = to_long_function_cast(
            collector_info.initial_load_function, *type_arguments
        )
        return collector_info.collector_creator(
            balanced_item_function, load_function, initial_load_function
        )
    else:
        raise ValueError(
            f"Invalid Collector: {collector_info}. "
            f"Create Collectors via blackops_legacy.solver.constraint.ConstraintCollectors."
        )
...
def perform_group_by(constraint_stream, package, group_by_args, *type_arguments):
    ...
    for i in range(len(group_by_args)):
        if callable(group_by_args[i]):
            actual_group_by_args.append(
                function_cast(group_by_args[i], *type_arguments)
            )
        else:
    ...
    if arg_count == 1:
        return UniConstraintStream(
            constraint_stream.groupBy(*actual_group_by_args),
            package,
...
class ConstraintCollectors:
    ...
    @staticmethod
    def average(
        group_value_mapping: Callable[[A], int]
    ) -> "UniConstraintCollector[A, Any, int]":
        ...

    @overload  # noqa
    @staticmethod
    def average(
        group_value_mapping: Callable[[A, B], int]
    ) -> "BiConstraintCollector[A, B, Any, int]":
        ...

    @overload  # noqa
    @staticmethod
    def average(
        group_value_mapping: Callable[[A, B, C], int]
    ) -> "TriConstraintCollector[A, B, C, Any, int]":
        ...

    @overload  # noqa
    @staticmethod
    def average(
        group_value_mapping: Callable[[A, B, C, D], int]
    ...
    def average(group_value_mapping):
        ...
        """
        return GroupIntMappingSingleArgConstraintCollector(
            ConstraintCollectors._delegate().average, group_value_mapping
        )

    @overload  # noqa
    @staticmethod
    def compose(
        sub_collector_1: "UniConstraintCollector[A, Any, A_]",
        sub_collector_2: "UniConstraintCollector[A, Any, B_]",
        compose_function: Callable[[A_, B_], C_],
    ) -> "UniConstraintCollector[A, Any, C_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_], D_],
    ) -> "UniConstraintCollector[A, Any, D_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_, D_], E_],
    ) -> "UniConstraintCollector[A, Any, E_]":
        ...

    @overload  # noqa
    @staticmethod
    def compose(
        sub_collector_1: "BiConstraintCollector[A, B, Any, A_]",
        sub_collector_2: "BiConstraintCollector[A, B, Any, B_]",
        compose_function: Callable[[A_, B_], C_],
    ) -> "BiConstraintCollector[A, B, Any, C_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_], D_],
    ) -> "BiConstraintCollector[A, B, Any, D_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_, D_], E_],
    ) -> "BiConstraintCollector[A, B, Any, E_]":
        ...

    @overload  # noqa
    @staticmethod
    def compose(
        sub_collector_1: "TriConstraintCollector[A, B, C, Any, A_]",
        sub_collector_2: "TriConstraintCollector[A, B, C, Any, B_]",
        compose_function: Callable[[A_, B_], C_],
    ) -> "TriConstraintCollector[A, B, C, Any, C_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_], D_],
    ) -> "TriConstraintCollector[A, B, C, Any, D_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_, D_], E_],
    ) -> "TriConstraintCollector[A, B, C, Any, E_]":
        ...

    @overload  # noqa
    @staticmethod
    def compose(
        sub_collector_1: "QuadConstraintCollector[A, B, C, D, Any, A_]",
        sub_collector_2: "QuadConstraintCollector[A, B, C, D, Any, B_]",
        compose_function: Callable[[A_, B_], C_],
    ) -> "QuadConstraintCollector[A, B, C, D, Any, C_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_], D_],
    ) -> "QuadConstraintCollector[A, B, C, D, Any, D_]":
        ...
    ...
    def compose(
        ...
        compose_function: Callable[[A_, B_, C_, D_], E_],
    ) -> "QuadConstraintCollector[A, B, C, D, Any, E_]":
        ...
    ...
    def compose(*args):
        ...
        return ComposeConstraintCollector(
            ConstraintCollectors._delegate().compose, collectors, compose_function
        )

    @overload  # noqa
    @staticmethod
    def conditionally(
        predicate: Callable[[A], bool], delegate: "UniConstraintCollector[A, Any, A_]"
    ...
    def conditionally(
        ...
        delegate: "BiConstraintCollector[A, B, Any, A_]",
    ...
    @staticmethod
    def conditionally(
        predicate: Callable[[A, B, C, D], bool],
    ...
    def conditionally(predicate, delegate):
        ...
        condition.
        """
        return ConditionalConstraintCollector(
            ConstraintCollectors._delegate().conditionally, predicate, delegate
        )

    @overload  # noqa
    @staticmethod
    def collect_and_then(
        delegate: "UniConstraintCollector[A, Any, A_]",
    ...
    def collect_and_then(delegate, mapping_function):
        ...
        """
        return CollectAndThenCollector(
            ConstraintCollectors._delegate().collectAndThen, delegate, mapping_function
        )
    ...
    def count_bi() -> "BiConstraintCollector[A, B, Any, int]":
        ...
        Returns a collector that counts the number of elements that are being grouped.
        """
        return NoArgsConstraintCollector(
            ConstraintCollectors._delegate().countBi
        )  # noqa
    ...
    def count_tri() -> "TriConstraintCollector[A, B, C, Any, int]":
        ...
        """
        return NoArgsConstraintCollector(
            ConstraintCollectors._delegate().countTri
        )  # noqa
    ...
    def count_quad() -> "QuadConstraintCollector[A, B, C, D, Any, int]":
        ...
        """
        return NoArgsConstraintCollector(
            ConstraintCollectors._delegate().countQuad
        )  # noqa
    ...
    def count_distinct(function=None):
        ...
        if function is None:
            return NoArgsConstraintCollector(
                ConstraintCollectors._delegate().countDistinct
            )
        else:
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().countDistinct, function
            )
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A], A_]
    ) -> "UniConstraintCollector[A, Any, A_]":
        ...
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A], A_], comparator: Callable[[A_, A_], int]
    ) -> "UniConstraintCollector[A, Any, A_]":
        ...
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A, B], A_]
    ) -> "BiConstraintCollector[A, B, Any, A_]":
        ...
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A, B], A_], comparator: Callable[[A_, A_], int]
    ) -> "BiConstraintCollector[A, B, Any, A_]":
        ...
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A, B, C], A_]
    ) -> "TriConstraintCollector[A, B, C, Any, A_]":
        ...
    ...
    @staticmethod
    def max(
        group_value_mapping: Callable[[A, B, C, D], A_]
    ) -> "QuadConstraintCollector[A, B, C, D, Any, A_]":
        ...
    ...
    def max(function=None, comparator=None):
        ...
        if function is None and comparator is None:
            ...
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().max, function
            )
    ...
    def min(function=None, comparator=None):
        ...
        if function is None and comparator is None:
            ...
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().min, function
            )
        elif function is None and comparator is not None:
            raise NotImplementedError  # TODO
        else:
    ...
    @staticmethod
    def sum(
        function: Callable[[A], A_],
        zero: A_,
        adder: Callable[[A_, A_], A_],
    ...
    def sum(function, zero=None, adder=None, subtractor=None):
        ...
        if zero is None and adder is None and subtractor is None:
            return GroupIntMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().sum, function
            )
    ...
    @overload  # noqa
    @staticmethod
    def to_consecutive_sequences(
        index_map: Callable[[A], int]
    ...
    @staticmethod
    def to_consecutive_sequences(
        result_map: Callable[[A, B], A_], index_map: Callable[[A_], int]
    ...
    @staticmethod
    def to_consecutive_sequences(
        result_map: Callable[[A, B, C], A_], index_map: Callable[[A_], int]
    ...
    @staticmethod
    def to_consecutive_sequences(
        result_map: Callable[[A, B, C, D], A_], index_map: Callable[[A_], int]
    ...
    def to_list(
        group_value_mapping: Callable[[A], A_]
    ) -> "UniConstraintCollector[A, Any, List[A_]]":
        ...
    ...
    def to_list(
        group_value_mapping: Callable[[A, B], A_]
    ) -> "BiConstraintCollector[A, B, Any, List[A_]]":
        ...
    ...
    def to_list(
        group_value_mapping: Callable[[A, B, C], A_]
    ) -> "TriConstraintCollector[A, B, C, Any, List[A_]]":
        ...
    ...
    def to_list(group_value_mapping=None):
        ...
        if group_value_mapping is None:
            ...
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().toList, group_value_mapping
            )
    ...
    def to_set(group_value_mapping=None):
        ...
        if group_value_mapping is None:
            ...
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().toSet, group_value_mapping
            )
    ...
    def to_sorted_set(group_value_mapping=None, comparator=None):
        ...
        if group_value_mapping is None and comparator is None:
            return NoArgsConstraintCollector(
                ConstraintCollectors._delegate().toSortedSet
            )
        elif group_value_mapping is not None and comparator is None:
            return GroupMappingSingleArgConstraintCollector(
                ConstraintCollectors._delegate().toSortedSet, group_value_mapping
            )

    @overload  # noqa
    @staticmethod
    def to_map(
        key_mapper: Callable[[A], A_], value_mapper: Callable[[A], B_]
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A], A_],
        value_mapper: Callable[[A], B_],
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B], A_], value_mapper: Callable[[A, B], B_]
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B], A_],
        value_mapper: Callable[[A, B], B_],
        merge_function: Callable[[B_, B_], B_],
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B, C], A_], value_mapper: Callable[[A, B, C], B_]
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B, C], A_],
        value_mapper: Callable[[A, B, C], B_],
        merge_function: Callable[[B_, B_], B_],
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B, C, D], A_], value_mapper: Callable[[A, B, C, D], B_]
    ...
    @staticmethod
    def to_map(
        key_mapper: Callable[[A, B, C, D], A_],
        value_mapper: Callable[[A, B, C], B_],
        merge_function: Callable[[B_, B_], B_],
    ...
    def to_map(key_mapper, value_mapper, merge_function_or_set_creator=None):
        ...
        if merge_function_or_set_creator is None:
            return KeyValueMappingConstraintCollector(
                ConstraintCollectors._delegate().toMap, key_mapper, value_mapper
            )
    ...
    def to_sorted_map(key_mapper, value_mapper, merge_function_or_set_creator=None):
        ...
        if merge_function_or_set_creator is None:
            return KeyValueMappingConstraintCollector(
                ConstraintCollectors._delegate().toSortedMap, key_mapper, value_mapper
            )
    ...
    @staticmethod
    def load_balance(
        balanced_item_function: Callable[[A], Balanced_]
    ...
    @staticmethod
    def load_balance(
        balanced_item_function: Callable[[A, B], Balanced_]
    ...
    def load_balance(
        balanced_item_function: Callable[[A, B], Balanced_],
        load_function: Callable[[A, B], int],
    ) -> "BiConstraintCollector[A, B, Any, LoadBalance[Balanced_]]":
        ...
    ...
    @staticmethod
    def load_balance(
        balanced_item_function: Callable[[A, B, C], Balanced_]
    ...
    @staticmethod
    def load_balance(
        balanced_item_function: Callable[[A, B, C, D], Balanced_]
    ...
    @staticmethod
    def load_balance(
        balanced_item_function, load_function=None, initial_load_function=None
    ):
        """
        ...
        if load_function is None and initial_load_function is None:
            return LoadBalanceCollector(
                ConstraintCollectors._delegate().loadBalance,
            ...
            raise ValueError(
                "load_function cannot be None if initial_load_function is not None"
            )
        else:
            return LoadBalanceCollector(
                ConstraintCollectors._delegate().loadBalance,
