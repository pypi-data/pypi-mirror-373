...
def grid_bubble_plot(tsd, col_x, col_y, col_color, cmap = 'coolwarm', nbins = None, grid_size = 0.5, scale_size = 5, vmin = None, vmax = None):
    """
    ...
    if (nbins is None) and (grid_size is None):
        ...
        # grid_size = (xlims[1] - xlims[0], ylims[1] - ylims[0])
    ...
    x_bins = np.linspace(xlims[0], xlims[1], nbins[0] + 1)
    y_bins = np.linspace(ylims[0], ylims[1], nbins[1] + 1)
...
if __name__ == "__main__":
    ...
    grid_bubble_plot(tsd.scv, 'Hierarchy', 'Information', 'Information', cmap='coolwarm', nbins = (10,5), scale_size = 5)
