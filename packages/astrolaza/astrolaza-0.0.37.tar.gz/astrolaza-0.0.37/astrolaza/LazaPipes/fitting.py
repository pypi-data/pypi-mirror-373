...
def mpi(IDs,dtypes,params,paths,n_proc,filters=None,runs=None,save_post=False,save_plots=None,save_res=None,xaxis='AA',yaxis=None,box=None,verbose=False):
    """
    INSTRUCTIONS:
