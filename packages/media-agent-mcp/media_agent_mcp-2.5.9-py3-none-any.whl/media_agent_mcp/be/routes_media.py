...
def concat_videos():
    ...
    try:
        ...
        # Check which videos have audio and their durations
        ...
        # Handle/normalize audio per segment, generate finite-duration silence where needed
        audio_inputs = []
        for i, has_aud in enumerate(has_audio):
            if has_aud:
                # normalize to stereo 48k and reset pts
                filter_parts.append(
