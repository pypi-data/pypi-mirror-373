...
def format_message(action: str, message: str = "", data: Optional[Dict[str, Any]] = None) -> str:
    """格式化消息为JSON字符串
...
class Logger:
    ...
    Attributes:
        _debug_mode (bool): 调试模式标志
        _initialized (bool): 初始化状态标志
        _logger (logging.Logger): 内部日志记录器实例
    """
    ...
    @classmethod
    def setup(cls, debug_mode: bool = False, log_file: str = "rpa.log") -> None:
        """设置日志记录器
    ...
    @classmethod
    def info(cls, message: str, extra_data: Optional[Dict[str, Any]] = None) -> None:
        """记录信息级别日志
    ...
    @classmethod
    def warning(cls, message: str, extra_data: Optional[Dict[str, Any]] = None) -> None:
        """记录警告级别日志
    ...
    @classmethod
    def error(cls, message: str, exception: Optional[Exception] = None, extra_data: Optional[Dict[str, Any]] = None) -> None:
        """记录错误级别日志
