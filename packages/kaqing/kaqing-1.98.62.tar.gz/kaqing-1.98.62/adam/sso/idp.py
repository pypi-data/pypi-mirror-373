...
class Idp:
            ...
            while password == None or Idp.ctrl_c_entered: # exit the while loop even if password is empty string
                ...
                if default_pass:
                    if forced:
                        ...
                        password = Idp.getpass_no_limit(default_pass=default_pass)
                else:
                    password = Idp.getpass_no_limit()
    ...
    def getpass_no_limit(self, default_pass: str = None):
        ...
        if default_pass:
            ...
            return getpass.getpass(f'Password: ')
        # finally:
        #     # thread racing issue - leave kaqing with stty -icanon
