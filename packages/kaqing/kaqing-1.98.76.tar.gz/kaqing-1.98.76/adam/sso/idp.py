    ...
    def login(app_host: str, username: str = None, idp_uri: str = None, forced = False, use_token_from_env = True, use_cached_creds = True) -> IdpLogin:
        ...
        try:
            ...
            if username and password:
                ...
                # kubeconfig file content has first char as tab and its length is bigger than 128
                if password[0] != '\t' and len(password) <= Config().get('app.login.password-max-length', 128):
