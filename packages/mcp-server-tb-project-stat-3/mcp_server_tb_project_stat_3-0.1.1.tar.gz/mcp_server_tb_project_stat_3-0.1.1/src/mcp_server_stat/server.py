...
@mcp.tool(name="getColumnMap", description="Get column map")
def getColumnMap(projectId: str, userId: str) -> dict:
    """Get column map."""
    url = "https://www.teambition.com/api/boards/soa1/tproject/udr/project/" + projectId + "/providedInfo"
    headers = {
        "Cookie": "X-Canary=prepub-dev-l",
        "userid": userId,
        "debug_mode": "true"
    ...
    result = request_url(url, method="GET", headers=headers)
    return result["json"] 


@mcp.tool(name="getFilterOptions", description="Get filter options")
def getColumnMap(projectId: str, userId: str, key: str) -> dict:
    """Get filter options."""
    url = "https://www.teambition.com/api/boards/soa1/project/" + projectId + "/task/searcherOptions"
    headers = {
        "Cookie": "X-Canary=prepub-dev-l",
        "userid": userId,
        "debug_mode": "true"
    ...
    result = request_url(url, method="GET", headers=headers, params=params)
    return result["json"] 
