...
WELCOME_MESSAGE = """
[bold magenta]🎥 HALO: Hierarchical Abstraction for Longform Optimization[/bold magenta]

[bold green]🚀 The World's Most Intelligent Video Analysis System[/bold green]

[yellow]Built by Jeet Dekivadia during Google Summer of Code at Google DeepMind[/yellow]
[blue]Powered by the world's most versatile API: Google Gemini[/blue]

[white]HALO is a MIT licensed Python package that helps users around the world 
intelligently and cost-effectively use Gemini to understand long complex 
videos and perform video QA.[/white]

[green]✨ What makes HALO revolutionary:[/green]
• 🧠 [cyan]Hierarchical Abstraction[/cyan]: Multi-scale video understanding
• ⚡ [cyan]Longform Optimization[/cyan]: Process hours of content efficiently  
• 🎯 [cyan]Multimodal Fusion[/cyan]: Combines audio transcription + visual analysis
• � [cyan]Cost Efficiency[/cyan]: 90%+ API cost reduction through smart caching
• 🌍 [cyan]Global Impact[/cyan]: Used by millions worldwide for education, business, research

[blue]📋 Prerequisites:[/blue]
• Google Gemini API key (free at https://makersuite.google.com/app/apikey)
• FFmpeg (will be auto-installed if missing)

[yellow]🌟 Join the revolution:[/yellow] [blue]https://github.com/jeet-dekivadia/halo-video[/blue]
"""
...
[bold green]Hierarchical Abstraction for Longform Optimization[/bold green]

[yellow]🏛️ Built at Google DeepMind during Google Summer of Code 2024[/yellow]
[blue]👨‍💻 Created by: Jeet Dekivadia[/blue]  
[purple]⚡ Powered by: Google Gemini AI[/purple]
[white]📄 License: MIT Open Source[/white]

[green]🌍 Making AI video analysis accessible to everyone, everywhere[/green]
[dim]https://github.com/jeet-dekivadia/halo-video[/dim]""",
...
HALO is a MIT licensed Python package built by Jeet Dekivadia 
during his Google Summer of Code coding period at Google DeepMind. 
HALO (Hierarchical Abstraction for Longform Optimization) is powered 
by the most versatile API in the world: Gemini. HALO helps any user 
around the world intelligently and cost-effectively use Gemini to 
understand long complex videos and perform video QA.""",
...
async def analyze_video():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        console.print(Align.center("[green]Built with ❤️ by Jeet Dekivadia at Google DeepMind[/green]", vertical="middle"))
        console.print(Align.center("[yellow]Powered by Google Gemini • MIT Licensed • Making AI accessible to everyone[/yellow]", vertical="middle"))
...
async def run_cli():
    ...
    console.print("[green]Built with ❤️ by Jeet Dekivadia during Google Summer of Code at Google DeepMind[/green]")
    console.print("[yellow]Powered by Google Gemini • MIT Licensed • Making AI accessible to everyone, everywhere[/yellow]")
    console.print("[blue]🌍 Join the revolution: https://github.com/jeet-dekivadia/halo-video[/blue]")
...
[green]🏛️ About HALO:[/green]
HALO is a MIT licensed Python package built by Jeet Dekivadia 
during his Google Summer of Code coding period at Google DeepMind. 
HALO (Hierarchical Abstraction for Longform Optimization) is powered 
by the most versatile API in the world: Gemini.
