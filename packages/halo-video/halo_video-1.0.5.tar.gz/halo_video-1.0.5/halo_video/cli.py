...
[green]Purpose:[/green] Optimizing Gemini API usage for long-context video analysis
[green]Features:[/green] Intelligent frame extraction, hierarchical content processing
