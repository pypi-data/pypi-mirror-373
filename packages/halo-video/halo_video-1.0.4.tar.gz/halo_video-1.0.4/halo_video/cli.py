...
[green]About HALO:[/green]
HALO is an AI-powered video analysis tool built by Jeet Dekivadia 
during Google Summer of Code at Google DeepMind. It uses Google's 
Gemini Vision API to analyze YouTube videos.

[cyan]You'll need a free Gemini API key:[/cyan]
[blue]https://makersuite.google.com/app/apikey[/blue]""",
                    title="[bold blue]First Time Setup[/bold blue]",
                    box=box.ROUNDED
                ))
