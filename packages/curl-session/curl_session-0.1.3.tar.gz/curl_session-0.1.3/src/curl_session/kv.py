...
def put(value: Any, content_type: Union[ContentType, str] = ContentType.TEXT_PLAIN, expiration: Optional[Any] = None, timeout: int = 10, retries: int = 2) -> Dict[str, Any]:
    """
...
def get(hash_key: str, timeout: int = 10) -> Dict[str, Any]:
    ...
    The function returns the response body as text (requests.decoded text), and the response Content-Type header.
    """
    if not hash_key:
...
def update(hash_key: str, value: Any, content_type: Union[ContentType, str], expiration: Optional[Any] = None, timeout: int = 10, retries: int = 2) -> Dict[str, Any]:
    """
