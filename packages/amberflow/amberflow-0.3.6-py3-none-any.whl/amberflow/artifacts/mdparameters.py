...
class AmberParameters:
    ...
    value2: float = field(default=100)
...
class HeatingParameters(AmberParameters):
    ...
    ntwx: int = field(default=250, init=False)
    iwrap: int = field(default=0, init=False)
    ntc: int = field(default=2, init=False)
    ntf: int = field(default=2, init=False)
    nscm: int = field(default=0, init=False)
    ntb: int = field(default=1, init=False)
    ntp: int = field(default=0, init=False)
    ntt: int = field(default=3, init=False)
    gamma_ln: float = field(default=1.0, init=False)
    temp0: int = field(default=298)
    tempi: int = field(default=298)
    ntr: int = field(default=0)
    restraint_wt: float = field(default=50.0)
