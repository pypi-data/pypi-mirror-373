...
<img src="https://i.imgur.com/PPKYqah.png" alt="ambient-wds-logo" width="40%">
## Overview
...
- Upload the packets to [APRS.fi](https://aprs.fi) in real time
...
- Follow the [Ambient Weather Network setup instructions](https://ambientweather.net/) to properly configure and register your station.
