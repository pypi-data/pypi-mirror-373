...
@click.command()
@click.option('--config-file', default='config.yaml', show_default=True, help='The YAML configuration file to use.')
...
@click.option("--ssid", default=13, help="APRS SSID")
@click.option("--aprs-passcode", default=None, help="APRS passcode")
@click.option("--aprs-server", default="noam.aprs2.net", help="APRS server hostname")
@click.option("--aprs-port", default=14580, type=int, help="APRS server port")
@click.option("--poll-seconds", default=300, type=int, help="Polling interval in seconds")
def main(config_file, app_key, api_key, callsign, ssid, aprs_passcode, aprs_server, aprs_port, poll_seconds):
