...
os.environ["TAVILY_API_KEY"] = "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"
os.environ["OPENAI_API_KEY"] = "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"
        ...
        with open(file_path, mode="r", encoding="latin-1") as file:
            ...
            for row_number, row in enumerate(csv_reader, start=1):
                try:
                    ...
                    result = await generate_mail(row, 1)
