...
class IntakeIssueCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    issue: IssueForIntakeRequest = Field(description="Issue data for the intake issue")
    intake: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["issue", "intake", "status", "snoozed_till", "duplicate_to", "source", "source_email"]
