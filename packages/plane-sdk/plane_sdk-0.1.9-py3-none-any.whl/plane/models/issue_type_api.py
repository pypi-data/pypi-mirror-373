...
class IssueTypeAPI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "deleted_at", "project_ids", "created_at", "updated_at", "name", "description", "logo_props", "is_epic", "is_default", "is_active", "level", "external_source", "external_id", "created_by", "updated_by", "workspace"]
