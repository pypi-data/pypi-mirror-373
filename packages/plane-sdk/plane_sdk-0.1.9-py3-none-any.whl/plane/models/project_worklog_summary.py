...
class ProjectWorklogSummary(BaseModel):
    ...
    """ # noqa: E501
    issue_id: StrictStr = Field(description="ID of the work item")
    duration: StrictInt = Field(description="Total duration logged for this work item in seconds")
    __properties: ClassVar[List[str]] = ["issue_id", "duration"]
