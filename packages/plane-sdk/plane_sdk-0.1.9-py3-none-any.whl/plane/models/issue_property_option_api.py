...
class IssuePropertyOptionAPI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "deleted_at", "created_at", "updated_at", "name", "sort_order", "description", "logo_props", "is_active", "is_default", "external_source", "external_id", "created_by", "updated_by", "workspace", "project", "property", "parent"]
