...
class IntakeApi:
    ...
    def create_intake_work_item(
        ...
        intake_issue_create_request: IntakeIssueCreateRequest,
        ...
        _param = self._create_intake_work_item_serialize(
            project_id=project_id,
            slug=slug,
            intake_issue_create_request=intake_issue_create_request,
    ...
    @validate_call
    def create_intake_work_item_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        intake_issue_create_request: IntakeIssueCreateRequest,
    ...
    @validate_call
    def create_intake_work_item_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        intake_issue_create_request: IntakeIssueCreateRequest,
    ...
    def _create_intake_work_item_serialize(
        self,
        project_id,
        slug,
        ...
        if intake_issue_create_request is not None:
            _body_params = intake_issue_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/workspaces/{slug}/projects/{project_id}/intake-issues/',
    ...
    def delete_intake_work_item(
        ...
        _param = self._delete_intake_work_item_serialize(
            issue_id=issue_id,
            project_id=project_id,
            slug=slug,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_intake_work_item_with_http_info(
        self,
        issue_id: Annotated[StrictStr, Field(description="Issue ID")],
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    @validate_call
    def delete_intake_work_item_without_preload_content(
        self,
        issue_id: Annotated[StrictStr, Field(description="Issue ID")],
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    def _delete_intake_work_item_serialize(
        self,
        issue_id,
        project_id,
        slug,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/workspaces/{slug}/projects/{project_id}/intake-issues/{issue_id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_intake_work_items_list(
        ...
        _param = self._get_intake_work_items_list_serialize(
            project_id=project_id,
            slug=slug,
            cursor=cursor,
            expand=expand,
    ...
    @validate_call
    def get_intake_work_items_list_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor for getting next set of results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedIntakeIssueResponse]:
        """List intake work items
    ...
    @validate_call
    def get_intake_work_items_list_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor for getting next set of results")] = None,
    ...
    def _get_intake_work_items_list_serialize(
        self,
        project_id,
        slug,
        cursor,
    ...
    def retrieve_intake_work_item(
        ...
        _param = self._retrieve_intake_work_item_serialize(
            issue_id=issue_id,
            project_id=project_id,
            slug=slug,
            _request_auth=_request_auth,
    ...
    @validate_call
    def retrieve_intake_work_item_with_http_info(
        self,
        issue_id: Annotated[StrictStr, Field(description="Issue ID")],
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    @validate_call
    def retrieve_intake_work_item_without_preload_content(
        self,
        issue_id: Annotated[StrictStr, Field(description="Issue ID")],
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    def _retrieve_intake_work_item_serialize(
        self,
        issue_id,
        project_id,
        slug,
    ...
    def update_intake_work_item(
        ...
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        patched_intake_issue_update_request: Optional[PatchedIntakeIssueUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_intake_work_item_serialize(
            issue_id=issue_id,
            project_id=project_id,
            slug=slug,
            patched_intake_issue_update_request=patched_intake_issue_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_intake_work_item_without_preload_content(
        self,
        issue_id: Annotated[StrictStr, Field(description="Issue ID")],
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    def _update_intake_work_item_serialize(
        self,
        issue_id,
        project_id,
        slug,
        ...
        # process the form parameters
        # process the body parameter
        if patched_intake_issue_update_request is not None:
            _body_params = patched_intake_issue_update_request
