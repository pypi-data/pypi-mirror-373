...
class PatchedStateRequest(BaseModel):
    ...
    color: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "color", "sequence", "group", "is_triage", "default", "external_source", "external_id"]
