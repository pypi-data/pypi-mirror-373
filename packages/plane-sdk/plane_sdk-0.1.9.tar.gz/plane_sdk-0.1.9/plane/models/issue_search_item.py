...
class IssueSearchItem(BaseModel):
    ...
    name: StrictStr = Field(description="Issue name")
    sequence_id: StrictStr = Field(description="Issue sequence ID")
    project__identifier: StrictStr = Field(description="Project identifier")
    project_id: StrictStr = Field(description="Project ID")
    workspace__slug: StrictStr = Field(description="Workspace slug")
    __properties: ClassVar[List[str]] = ["id", "name", "sequence_id", "project__identifier", "project_id", "workspace__slug"]
