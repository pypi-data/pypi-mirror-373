...
from ...models.get_information_about_the_users_current_playback_response_401 import (
    GetInformationAboutTheUsersCurrentPlaybackResponse401,
)
from ...models.get_information_about_the_users_current_playback_response_403 import (
    GetInformationAboutTheUsersCurrentPlaybackResponse403,
)
from ...models.get_information_about_the_users_current_playback_response_429 import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetInformationAboutTheUsersCurrentPlaybackResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetInformationAboutTheUsersCurrentPlaybackResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 429:
        response_429 = GetInformationAboutTheUsersCurrentPlaybackResponse429.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, CurrentlyPlayingContextObject, GetInformationAboutTheUsersCurrentPlaybackResponse401, GetInformationAboutTheUsersCurrentPlaybackResponse403, GetInformationAboutTheUsersCurrentPlaybackResponse429]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, CurrentlyPlayingContextObject, GetInformationAboutTheUsersCurrentPlaybackResponse401, GetInformationAboutTheUsersCurrentPlaybackResponse403, GetInformationAboutTheUsersCurrentPlaybackResponse429]
    """
