...
T = TypeVar("T", bound="SimplifiedAudiobookObject")
...
class SimplifiedAudiobookObject:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simplified_audiobook_object = cls(
            authors=authors,
            available_markets=available_markets,
            copyrights=copyrights,
            description=description,
        ...
        simplified_audiobook_object.additional_properties = d
        return simplified_audiobook_object
