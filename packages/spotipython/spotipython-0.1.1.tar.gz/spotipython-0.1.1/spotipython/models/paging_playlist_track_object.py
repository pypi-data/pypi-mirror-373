...
if TYPE_CHECKING:
    from ..models.playlist_track_object import PlaylistTrackObject


T = TypeVar("T", bound="PagingPlaylistTrackObject")
...
class PagingPlaylistTrackObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['PlaylistTrackObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["PlaylistTrackObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = PlaylistTrackObject.from_dict(items_item_data)

            items.append(items_item)

        paging_playlist_track_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_playlist_track_object.additional_properties = d
        return paging_playlist_track_object
