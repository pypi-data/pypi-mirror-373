...
T = TypeVar("T", bound="RemoveTracksUserBody")


@_attrs_define
class RemoveTracksUserBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_tracks_user_body = cls(
            ids=ids,
        )

        remove_tracks_user_body.additional_properties = d
        return remove_tracks_user_body
