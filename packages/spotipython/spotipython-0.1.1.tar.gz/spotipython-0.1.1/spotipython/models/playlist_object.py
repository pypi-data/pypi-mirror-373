...
T = TypeVar("T", bound="PlaylistObject")
...
class PlaylistObject:
    ...
    Attributes:
        ...
        description (Union[None, Unset, str]): The playlist description. _Only returned for modified, verified
            playlists, otherwise_ `null`.
        ...
        tracks (Union[Unset, PagingPlaylistTrackObject]):
    ...
    tracks: Union[Unset, "PagingPlaylistTrackObject"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_tracks, Unset):
            ...
            tracks = PagingPlaylistTrackObject.from_dict(_tracks)
        ...
        playlist_object.additional_properties = d
