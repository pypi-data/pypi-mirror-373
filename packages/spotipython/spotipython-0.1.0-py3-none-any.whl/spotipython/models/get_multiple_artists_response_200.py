...
T = TypeVar("T", bound="GetMultipleArtistsResponse200")


@_attrs_define
class GetMultipleArtistsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_multiple_artists_response_200 = cls(
            artists=artists,
        )

        get_multiple_artists_response_200.additional_properties = d
        return get_multiple_artists_response_200
