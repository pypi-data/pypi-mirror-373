...
T = TypeVar("T", bound="GetSeveralTracksResponse200")


@_attrs_define
class GetSeveralTracksResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_several_tracks_response_200 = cls(
            tracks=tracks,
        )

        get_several_tracks_response_200.additional_properties = d
        return get_several_tracks_response_200
