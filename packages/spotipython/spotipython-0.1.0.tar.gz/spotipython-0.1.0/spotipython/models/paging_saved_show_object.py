...
if TYPE_CHECKING:
    from ..models.saved_show_object import SavedShowObject


T = TypeVar("T", bound="PagingSavedShowObject")
...
class PagingSavedShowObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['SavedShowObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["SavedShowObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SavedShowObject.from_dict(items_item_data)

            items.append(items_item)

        paging_saved_show_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_saved_show_object.additional_properties = d
        return paging_saved_show_object
