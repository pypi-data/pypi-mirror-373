...
from ..models.simplified_artist_object_type import SimplifiedArtistObjectType
...
T = TypeVar("T", bound="SimplifiedArtistObject")
...
class SimplifiedArtistObject:
    ...
    Attributes:
        ...
        type_ (Union[Unset, SimplifiedArtistObjectType]): The object type.
    ...
    type_: Union[Unset, SimplifiedArtistObjectType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, SimplifiedArtistObjectType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = SimplifiedArtistObjectType(_type_)

        uri = d.pop("uri", UNSET)

        simplified_artist_object = cls(
        ...
        simplified_artist_object.additional_properties = d
        return simplified_artist_object
