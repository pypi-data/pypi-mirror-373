...
if TYPE_CHECKING:
    from ..models.simplified_episode_object import SimplifiedEpisodeObject


T = TypeVar("T", bound="PagingSimplifiedEpisodeObject")
...
class PagingSimplifiedEpisodeObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['SimplifiedEpisodeObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["SimplifiedEpisodeObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SimplifiedEpisodeObject.from_dict(items_item_data)

            items.append(items_item)

        paging_simplified_episode_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_simplified_episode_object.additional_properties = d
        return paging_simplified_episode_object
