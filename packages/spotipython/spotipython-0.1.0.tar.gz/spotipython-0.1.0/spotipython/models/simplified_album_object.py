...
from ..models.simplified_album_object_album_group import SimplifiedAlbumObjectAlbumGroup
...
T = TypeVar("T", bound="SimplifiedAlbumObject")
...
class SimplifiedAlbumObject:
    ...
    Attributes:
        ...
        album_group (Union[Unset, SimplifiedAlbumObjectAlbumGroup]): The field is present when getting an artist's
            albums. Compare to album_type this field represents relationship between the artist and the album.
             Example: compilation.
    """
    ...
    album_group: Union[Unset, SimplifiedAlbumObjectAlbumGroup] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        album_group: Union[Unset, str] = UNSET
        if not isinstance(self.album_group, Unset):
        ...
        if album_group is not UNSET:
            field_dict["album_group"] = album_group
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _album_group = d.pop("album_group", UNSET)
        album_group: Union[Unset, SimplifiedAlbumObjectAlbumGroup]
        if isinstance(_album_group, Unset):
            album_group = UNSET
        else:
            album_group = SimplifiedAlbumObjectAlbumGroup(_album_group)

        simplified_album_object = cls(
            album_type=album_type,
            available_markets=available_markets,
            external_urls=external_urls,
            href=href,
        ...
        simplified_album_object.additional_properties = d
        return simplified_album_object
