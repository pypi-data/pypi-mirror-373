...
if TYPE_CHECKING:
    from ..models.saved_track_object import SavedTrackObject


T = TypeVar("T", bound="PagingSavedTrackObject")
...
class PagingSavedTrackObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['SavedTrackObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["SavedTrackObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SavedTrackObject.from_dict(items_item_data)

            items.append(items_item)

        paging_saved_track_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_saved_track_object.additional_properties = d
        return paging_saved_track_object
