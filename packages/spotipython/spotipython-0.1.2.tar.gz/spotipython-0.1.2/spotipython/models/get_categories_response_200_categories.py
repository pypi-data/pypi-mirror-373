...
T = TypeVar("T", bound="GetCategoriesResponse200Categories")


@_attrs_define
class GetCategoriesResponse200Categories:
    """
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['CategoryObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["CategoryObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = CategoryObject.from_dict(items_item_data)

            items.append(items_item)

        get_categories_response_200_categories = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        get_categories_response_200_categories.additional_properties = d
        return get_categories_response_200_categories
