...
T = TypeVar("T", bound="SaveAlbumsUserBody")


@_attrs_define
class SaveAlbumsUserBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        save_albums_user_body = cls(
            ids=ids,
        )

        save_albums_user_body.additional_properties = d
        return save_albums_user_body
