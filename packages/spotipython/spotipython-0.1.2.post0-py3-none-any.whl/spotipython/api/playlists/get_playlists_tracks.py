...
from ...models.get_playlists_tracks_response_401 import GetPlaylistsTracksResponse401
from ...models.get_playlists_tracks_response_403 import GetPlaylistsTracksResponse403
from ...models.get_playlists_tracks_response_429 import GetPlaylistsTracksResponse429
from ...models.paging_playlist_track_object import PagingPlaylistTrackObject
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PagingPlaylistTrackObject.from_dict(response.json())

        return response_200

    if response.status_code == 401:
        response_401 = GetPlaylistsTracksResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetPlaylistsTracksResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 429:
        response_429 = GetPlaylistsTracksResponse429.from_dict(response.json())
    ...
    *,
    ...
    Args:
        ...
        fields (Union[Unset, str]): Filters for the query: a comma-separated list of the
            ...
            get just the added date and user ID of the
            adder:<br/>`fields=items(added_at,added_by.id)`<br/>Use
            multiple parentheses to drill down into nested objects, for
            example:<br/>`fields=items(track(name,href,album(name,href)))`<br/>Fields
    ...
    Returns:
        Response[Union[GetPlaylistsTracksResponse401, GetPlaylistsTracksResponse403, GetPlaylistsTracksResponse429, PagingPlaylistTrackObject]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[GetPlaylistsTracksResponse401, GetPlaylistsTracksResponse403, GetPlaylistsTracksResponse429, PagingPlaylistTrackObject]
    """
