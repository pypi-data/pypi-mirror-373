...
if TYPE_CHECKING:
    from ..models.saved_album_object import SavedAlbumObject


T = TypeVar("T", bound="PagingSavedAlbumObject")
...
class PagingSavedAlbumObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['SavedAlbumObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["SavedAlbumObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SavedAlbumObject.from_dict(items_item_data)

            items.append(items_item)

        paging_saved_album_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_saved_album_object.additional_properties = d
        return paging_saved_album_object
