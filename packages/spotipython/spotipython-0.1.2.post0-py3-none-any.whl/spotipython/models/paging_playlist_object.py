...
if TYPE_CHECKING:
    from ..models.simplified_playlist_object import SimplifiedPlaylistObject


T = TypeVar("T", bound="PagingPlaylistObject")
...
class PagingPlaylistObject:
    ...
    Attributes:
        ...
        total (int): The total number of items available to return.
             Example: 4.
        items (Union[Unset, list['SimplifiedPlaylistObject']]):
    """
    ...
    total: int
    items: Union[Unset, list["SimplifiedPlaylistObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SimplifiedPlaylistObject.from_dict(items_item_data)

            items.append(items_item)

        paging_playlist_object = cls(
            href=href,
            limit=limit,
            next_=next_,
            offset=offset,
        ...
        paging_playlist_object.additional_properties = d
        return paging_playlist_object
