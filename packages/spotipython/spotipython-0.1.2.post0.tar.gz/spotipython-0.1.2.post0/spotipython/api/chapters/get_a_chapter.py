...
from ...models.chapter_object import ChapterObject
from ...models.get_a_chapter_response_401 import GetAChapterResponse401
from ...models.get_a_chapter_response_403 import GetAChapterResponse403
from ...models.get_a_chapter_response_429 import GetAChapterResponse429
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ChapterObject.from_dict(response.json())

        return response_200

    if response.status_code == 401:
        response_401 = GetAChapterResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetAChapterResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 429:
        response_429 = GetAChapterResponse429.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ChapterObject, GetAChapterResponse401, GetAChapterResponse403, GetAChapterResponse429]
    """
