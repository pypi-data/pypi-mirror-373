...
T = TypeVar("T", bound="CursorPagingSimplifiedArtistObject")
...
class CursorPagingSimplifiedArtistObject:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = ArtistObject.from_dict(items_item_data)
        ...
        cursor_paging_simplified_artist_object.additional_properties = d
        return cursor_paging_simplified_artist_object
