...
class HpHc(ABC):
    ...
    def type(cls, source_name, source_type, approximant):
        ...
        # PhenomHM
        if source_type == "MBHB" and approximant == "IMRPhenomHM":
            module = importlib.import_module("ldc.waveform.waveform.bhb_imrphenomHM")
            # return getattr(module, "SOBHB_IMRPhenomD")(source_name, source_type, approximant)
            return getattr(module, "BHB_IMRPhenomHM")(source_name, source_type, approximant)
