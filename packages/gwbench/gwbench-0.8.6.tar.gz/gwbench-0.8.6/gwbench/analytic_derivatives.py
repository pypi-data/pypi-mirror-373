...
def antenna_pattern_and_loc_phase_fac_ana_derivs(f, params_dic, loc, use_rot, Flp=None, user_locs=None):
    ...
    del_gra_td, del_dec_td          = calc_d_time_delay(gra_Flp, params_dic['dec'], f, d)
    del_ra_gra_Fpc                  =  (1 - time_to_rad_earth * del_gra_td)
    del_dec_gra_Fpc                 = -time_to_rad_earth *      del_dec_td
    del_tc_gra_Fpc                  = -time_to_rad_earth * (1 + del_gra_td)
    ...
    return  {   'ra'  : del_gra_dec_psi_Fpc[:,0,0] * del_ra_gra_Fpc,
            ...
            {   'ra' : del_ra_Flp,
                ...
                'tc' : -time_to_rad_earth * del_ra_Flp,
                }
