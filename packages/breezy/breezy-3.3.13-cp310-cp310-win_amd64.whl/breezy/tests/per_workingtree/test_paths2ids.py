...
class TestPaths2Ids(TestCaseWithWorkingTree):
    ...
    def test_find_children_of_moved_directories(self):
        ...
        self.build_tree(
            [
                "tree/dir/",
                "tree/dir/child-moves",
                "tree/dir/child-stays",
                "tree/dir/child-goes",
            ]
        )
        tree.add(
            ["dir", "dir/child-moves", "dir/child-stays", "dir/child-goes"],
    ...
    def test_unversioned_one_tree(self):
        ...
        tree.lock_read()
        self.assertRaises(
            errors.PathsNotVersionedError, tree.paths2ids, ["unversioned"]
        )
        tree.unlock()
    ...
    def test_unversioned_all_of_multiple_trees(self):
        ...
        basis = tree.basis_tree()
        self.assertExpectedIds(
            [], tree, ["unversioned"], [basis], require_versioned=False
        )
        tree.lock_read()
        basis.lock_read()
        self.assertRaises(
            errors.PathsNotVersionedError, tree.paths2ids, ["unversioned"], [basis]
        )
        self.assertRaises(
            errors.PathsNotVersionedError, basis.paths2ids, ["unversioned"], [tree]
        )
        basis.unlock()
        tree.unlock()
    ...
    def test_unversioned_non_ascii_one_tree(self):
        ...
        e = self.assertRaises(errors.PathsNotVersionedError, tree.paths2ids, ["\xa7"])
