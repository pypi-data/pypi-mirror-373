...
class TestNoColocatedSupport(per_controldir.TestCaseWithControlDir):
    ...
    def test_destroy_colocated_branch(self):
        ...
        self.assertRaises(
            ...
            branch.controldir.destroy_branch,
            "colo",
        )
    ...
    def test_create_colo_branch(self):
        ...
        self.assertRaises(
            controldir.NoColocatedBranchSupport, made_control.create_branch, "colo"
        )

    def test_open_branch(self):
        made_control = self.make_controldir_with_repo()
        self.assertRaises(
            controldir.NoColocatedBranchSupport, made_control.open_branch, name="colo"
        )

    def test_get_branch_reference(self):
        made_control = self.make_controldir_with_repo()
        self.assertRaises(
            controldir.NoColocatedBranchSupport,
            made_control.get_branch_reference,
            "colo",
        )
    ...
    def test_set_branch_reference(self):
        ...
        self.assertRaises(
            controldir.NoColocatedBranchSupport,
            made_control.set_branch_reference,
            referenced,
            name="colo",
        )
