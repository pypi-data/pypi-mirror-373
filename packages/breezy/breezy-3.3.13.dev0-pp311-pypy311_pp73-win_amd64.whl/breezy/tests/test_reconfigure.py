...
class TestReconfigure(tests.TestCaseWithTransport):
    ...
    def test_branch_to_branch(self):
        ...
        self.assertRaises(
            reconfigure.AlreadyBranch,
            reconfigure.Reconfigure.to_branch,
            branch.controldir,
        )
    ...
    def test_lightweight_checkout_to_branch(self):
        ...
        self.assertEqual(
            checkout_branch.controldir.root_transport.base,
    ...
    def test_tree_to_tree(self):
        tree = self.make_branch_and_tree("tree")
        self.assertRaises(
            reconfigure.AlreadyTree, reconfigure.Reconfigure.to_tree, tree.controldir
        )
    ...
    def test_select_bind_location(self):
        ...
        self.assertRaises(
            reconfigure.NoBindLocation, reconfiguration._select_bind_location
        )
        ...
        self.assertEqual(
            "ftp://user-specified", reconfiguration._select_bind_location()
        )
    ...
    def test_checkout_to_checkout(self):
        ...
        self.assertRaises(
            reconfigure.AlreadyCheckout,
            reconfigure.Reconfigure.to_checkout,
            checkout.controldir,
        )
    ...
    def test_synced_checkout_to_lightweight(self):
        ...
        self.assertRaises(
            errors.NoRepositoryPresent, checkout.controldir.open_repository
        )
    ...
    def test_lightweight_checkout_to_lightweight_checkout(self):
        ...
        self.assertRaises(
            reconfigure.AlreadyLightweightCheckout,
    ...
    def test_unshared_repo_to_lightweight_checkout(self):
        ...
        workingtree.WorkingTree.open("repo")
        self.assertRaises(
            errors.NoRepositoryPresent, repository.Repository.open, "repo"
        )
    ...
    def test_use_shared_to_use_shared(self):
        ...
        self.assertRaises(
            reconfigure.AlreadyUsingShared,
            reconfigure.Reconfigure.to_use_shared,
            tree.controldir,
        )
    ...
    def test_use_shared_to_standalone(self):
        ...
        self.assertEqual(
            repo.controldir.root_transport.base, tree.controldir.root_transport.base
        )
        self.assertEqual("Hello", repo.get_revision(b"hello-id").message)
    ...
    def test_standalone_to_standalone(self):
        tree = self.make_branch_and_tree("tree")
        self.assertRaises(
            reconfigure.AlreadyStandalone,
            reconfigure.Reconfigure.to_standalone,
            tree.controldir,
        )
    ...
    def test_make_with_trees_already_with_trees(self):
        repo = self.make_repository_with_without_trees(True)
        e = self.assertRaises(
            reconfigure.AlreadyWithTrees,
            reconfigure.Reconfigure.set_repository_trees,
            repo.controldir,
            True,
        )
        self.assertContainsRe(
            str(e), r"Shared repository '.*' already creates working trees."
        )
    ...
    def test_make_without_trees_already_no_trees(self):
        ...
        self.assertContainsRe(
            str(e), r"Shared repository '.*' already doesn't create working trees."
        )
    ...
    def test_lightweight_checkout_to_tree_preserves_reference_locations(self):
        ...
        checkout_branch = checkout.controldir.open_branch()
        self.assertEqual(
            ("../location", "path"), checkout_branch.get_reference_info(b"file_id")
        )
