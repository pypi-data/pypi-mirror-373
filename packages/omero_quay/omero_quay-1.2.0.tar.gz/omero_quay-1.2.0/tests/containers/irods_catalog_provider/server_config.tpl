{
    ...
    "default_resource_directory": "{{ IRODS_RES_DIR or "/mnt/users/" }}",
    "default_resource_name": "{{ IRODS_DEFAULT_RES_NAME or "demoResc" }}",
    ...
    "service_account_environment": {
        ...
        "irods_cwd": "/{{ IRODS_ZONE or "devZone" }}/home/rods",
        "irods_default_hash_scheme": "SHA256",
        "irods_default_number_of_transfer_threads": 4,
        "irods_default_resource": "{{ IRODS_DEFAULT_RES_NAME or "demoResc" }}",
        "irods_encryption_algorithm": "AES-256-CBC",
        "irods_encryption_key_size": 32,
        "irods_encryption_num_hash_rounds": 16,
        "irods_encryption_salt_size": 8,
        "irods_home": "/{{ IRODS_ZONE or "devZone" }}/home/rods",
        "irods_host": "{{ HOSTNAME }}",
        ...
        "irods_server_control_plane_key": "{{ IRODS_PLANE_KEY }}",
        "irods_server_control_plane_port": 1248,
        "irods_transfer_buffer_size_for_parallel_transfer_in_megabytes": 4,
        "irods_user_name": "rods",
        "irods_zone_name": "{{ IRODS_ZONE or "devZone" }}",
...
{% if IRODS_ROLE == "provider" %}
            "{{ HOSTNAME }}"
{% else %}
            "{{ IRODS_ICAT_HOST or "irods-icat" }}"
{% endif %}
        ],
        "catalog_service_role": "{{ IRODS_ROLE or "consumer" }}",
        ...
        "negotiation_key": "{{ IRODS_NEG_KEY }}",
        "plugin_configuration": {
            "authentication": {},
{% if IRODS_ROLE == "provider" %}
            "database": {
                "postgres": {
                    "db_host": "{{ IRODS_DB_HOST or "psql" }}",
                    "db_name": "{{ IRODS_DB_NAME or "irods" }}",
                    "db_odbc_driver": "PostgreSQL ANSI",
                    "db_password": "{{ IRODS_DB_PASS }}",
                    "db_port": 5432,
                    "db_username": "{{ IRODS_DB_USER or "irods" }}"
                }
            },
{% endif %}
            "network": {},
        ...
        "server_control_plane_key": "{{ IRODS_PLANE_KEY }}",
        ...
        "zone_name": "{{ IRODS_ZONE or "devZone" }}",
        "zone_port": 1247,
        "zone_user": "rods"
    }
}
