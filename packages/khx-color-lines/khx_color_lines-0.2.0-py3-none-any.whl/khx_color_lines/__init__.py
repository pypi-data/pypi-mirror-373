...
__all__ = ["__version__", "print_five_lines", "five_default_colors", "colorize_text"]
__version__ = "0.2.0"
...
def colorize_text(text: str, color: ColorName) -> str:
    """
    Return the input text wrapped in the ANSI color sequence.
    Args:
        text: The text to colorize.
        color: A supported color name.
    Returns:
        The colorized text string with a trailing reset sequence.
    Raises:
