"""Cadence Framework SDK Plugin Manager - Dynamic Agent Discovery and Lifecycle Management.

This module implements the core plugin management system for Cadence's multi-agent AI framework,
...
Plugin Management Architecture:
    ...
    - Automatic discovery of plugins following Cadence SDK contracts
...
Example Usage:
    ...
    ```python
    from cadence.infrastructure.plugins.sdk_manager import SDKPluginManager
    from cadence.infrastructure.llm import LLMModelFactory

    plugin_manager = SDKPluginManager(
        plugins_dirs=["./plugins/src/cadence_example_plugins", "./custom_plugins"],
