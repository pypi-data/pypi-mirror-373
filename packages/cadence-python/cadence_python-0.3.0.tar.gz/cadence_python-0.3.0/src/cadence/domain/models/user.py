...
class User(BaseModel):
    ...
    Attributes:
        ...
        org_id: Organization this user belongs to.
        display_name: Friendly display name; defaults to `user_id`.
        created_at: Account creation timestamp (UTC).
        last_active: Timestamp of last observed activity, if any.
    ...
    def update_last_active(self) -> None:
        """Set `last_active` to the current UTC timestamp."""
    ...
    def can_create_threads(self) -> bool:
        """Return True if the user is allowed to create threads.

        Currently this maps to the account being active.
        """
    ...
    def from_dict(cls, data: dict) -> "User":
        ...
        Args:
            data: Mapping with keys user_id, org_id, created_at (ISO 8601),
                and optional display_name, last_active (ISO 8601), is_active.
