...
class MapReduceStep(BasePipelineStep, HasInputsMixin):
    ...
    def __init__(self, name: str, input_state_map: dict[str, str], output_state: str, map_func: Component | Callable[[dict[str, Any]], Any], reduce_func: Callable[[list[Any]], Any] = ..., runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, retry_config: RetryConfig | None = None) -> None:
