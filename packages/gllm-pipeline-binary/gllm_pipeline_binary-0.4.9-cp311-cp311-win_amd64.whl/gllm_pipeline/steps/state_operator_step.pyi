...
class StateOperatorStep(BasePipelineStep, HasInputsMixin):
    ...
    def __init__(self, name: str, input_states: list[str], output_state: str | list[str], operation: Callable[[dict[str, Any]], Any], runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, retry_config: RetryConfig | None = None, error_handler: BaseStepErrorHandler | None = None) -> None:
