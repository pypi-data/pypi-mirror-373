...
class GuardStep(ConditionalStep):
    ...
    '''
    def __init__(self, name: str, condition: ConditionType, success_branch: BasePipelineStep | list[BasePipelineStep], failure_branch: BasePipelineStep | list[BasePipelineStep] | None = None, retry_config: RetryConfig | None = None, **kwargs: Any) -> None:
