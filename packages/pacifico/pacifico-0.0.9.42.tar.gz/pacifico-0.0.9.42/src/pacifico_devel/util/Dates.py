...
if __name__=='__main__':
    ...
    todayMidDay = datetime.datetime(now.year, now.month, now.day) + datetime.timedelta(hours=12)
    today = datetime.date.today()
    print('now:', now, ' - ', dateTimeToJulian(now))
    print('today (mid day):', todayMidDay, ' - ', dateTimeToJulian(todayMidDay))
    ...
    print('test:', julianToDateTime(2459926.1779433936))
    # print(now)
    # x = getExcelDate(now)
    # print(x)
