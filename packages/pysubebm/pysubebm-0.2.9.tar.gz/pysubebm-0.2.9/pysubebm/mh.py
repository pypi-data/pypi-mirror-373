...
def metropolis_hastings(
    ...
    return all_accepted_orders, log_likelihoods, all_log_likes_subtypes, best_order, best_ll, best_theta_phi, best_stage_post, best_subtype_prior, best_stage_prior, best_subtype_post, current_ln_likes_subtypes, current_stage_post, current_theta_phi, current_stage_prior, current_subtype_prior