...
class BaseUniversityProvider(UniversityProvider, ABC):
    ...
    def search_courses(self, query: str, subject_code: Optional[str] = None) -> SearchResult:
        """
        ...
        for course in courses:
            ...
            searchable_text = f"{course.course_code} {course.title} {course.description}".lower()
    ...
    def _validate_course_data(self, course_dict: Dict[str, Any]) -> bool:
        ...
        return all(field in course_dict and course_dict[field] for field in required_fields)
