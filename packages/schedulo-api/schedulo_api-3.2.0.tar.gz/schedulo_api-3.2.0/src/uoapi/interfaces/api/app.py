...
def create_app() -> FastAPI:
    ...
    async def get_universities():
        ...
        try:
            available_unis = services.discovery_service.get_available_universities()
            return {
                "universities": available_unis,
                "count": len(available_unis)
            }
    ...
    async def get_university_info(university: str):
        ...
        try:
            ...
            normalized_uni = services.discovery_service.normalize_university_name(university)
    ...
    async def get_university_courses(
        ...
        try:
            ...
            if search:
                ...
                search_result = services.course_service.search_courses(uni_enum, search, subject)
    ...
    async def get_live_university_courses(
        ...
        try:
            ...
            if include_ratings:
                try:
                    result.courses = services.rating_service.inject_ratings_into_courses(
            ...
            for course in result.courses:
                ...
                live_courses.append(LiveCourseData(
                    ...
                    catalog_credits=float(course.credits) if course.credits else 0.0,
