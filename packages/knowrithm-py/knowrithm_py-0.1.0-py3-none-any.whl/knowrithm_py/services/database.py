...
class DatabaseService:
    ...
    def create_connection(self, connection_data: Dict) -> Dict:
        ...
        return self.client._make_request("POST", "/database-connections", connection_data)
    
    def list_connections(self, active_only: bool = True) -> List[Dict]:
        """List database connections"""
        params = {"active_only": active_only}
        return self.client._make_request("GET", "/database-connections", params=params)
    
    def get_connection(self, connection_id: str) -> Dict:
        """Get database connection details"""
        return self.client._make_request("GET", f"/database-connections/{connection_id}")
    
    def update_connection(self, connection_id: str, connection_data: Dict) -> Dict:
        """Update database connection"""
        return self.client._make_request("PUT", f"/database-connections/{connection_id}", connection_data)
    
    def patch_connection(self, connection_id: str, connection_data: Dict) -> Dict:
        """Partially update database connection"""
        return self.client._make_request("PATCH", f"/database-connections/{connection_id}", connection_data)
    
    def delete_connection(self, connection_id: str) -> Dict:
        """Soft delete database connection"""
        return self.client._make_request("DELETE", f"/database-connections/{connection_id}")
    
    def restore_connection(self, connection_id: str) -> Dict:
        """Restore soft-deleted database connection"""
        return self.client._make_request("PATCH", f"/database-connections/{connection_id}/restore")
    
    def test_connection(self, connection_id: str) -> Dict:
        """Test database connection"""
        return self.client._make_request("POST", f"/database-connections/{connection_id}/test")
    
    def analyze_database(self, connection_id: str) -> Dict:
        """Analyze database schema"""
        return self.client._make_request("POST", f"/database-connections/{connection_id}/analyze")
    
    def get_tables(self, connection_id: str) -> List[Dict]:
        """Get database tables"""
        return self.client._make_request("GET", f"/database-connections/{connection_id}/tables")
    ...
    def search(self, query: str, connection_ids: Optional[List[str]] = None) -> Dict:
        ...
        return self.client._make_request("POST", "/database-connections/search", data)
