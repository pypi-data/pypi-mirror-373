...
```env
KNOWRITHM_API_KEY=your_api_key_here
KNOWRITHM_BASE_URL=https://app.knowrithm.org
KNOWRITHM_TIMEOUT=30
```
...
- **Documentation**: [https://docs.knowrithm.com](https://docs.knowrithm.com)
- **Discord Community**: [https://discord.gg/knowrithm](https://discord.gg/knowrithm)
- **Email Support**: support@knowrithm.com
- **GitHub Issues**: [https://github.com/yourusername/knowrithm-py/issues](https://github.com/yourusername/knowrithm-py/issues)
