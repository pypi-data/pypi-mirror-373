...
class AgentSdk:
    ...
    async def send_log(self, log: AddLogRequest | dict) -> None:
        """
        ...
        await self._send_logs(logs_request)
    ...
    async def sign_and_send(
        ...
        if is_ethereum_network(request_obj.network):
            ...
            return await self._handle_evm_transaction(payload)
