...
/// water-pump-off
pub const WATER_PUMP_OFF: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-water-pump-off" viewBox="0 0 24 24"><path d="M5.7 2.5A2 2 0 0 1 7 2H9A2 2 0 0 1 11 4V5H19A2 2 0 0 1 21 7V11A1 1 0 0 1 21 13H17A1 1 0 0 1 17 11V9H12.2M20.84 22.73L22.11 21.46L11 10.34L2.39 1.73L1.11 3L3.65 5.54A2 2 0 0 0 5 9V18H4A2 2 0 0 0 2 20V22H14V20A2 2 0 0 0 12 18H11V12.89Z"/></svg>"#,
    slug: "water-pump-off",
    version: "3.9.97",
    deprecated: false,
    author: "Nick",
...
pub const WATER_REMOVE_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-water-remove-outline" viewBox="0 0 24 24"><path d="M12 18C12 18.7 12.12 19.36 12.34 20C12.23 20 12.12 20 12 20C8.69 20 6 17.31 6 14C6 10 12 3.25 12 3.25S16.31 8.1 17.62 12C16.93 12.06 16.28 12.22 15.67 12.47C15 10.68 13.5 8.33 12 6.39C10 8.96 8 12.23 8 14C8 16.21 9.79 18 12 18M21.54 15.88L20.13 14.47L18 16.59L15.88 14.47L14.47 15.88L16.59 18L14.47 20.12L15.88 21.53L18 19.41L20.12 21.53L21.53 20.12L19.41 18L21.54 15.88Z"/></svg>"#,
    slug: "water-remove-outline",
    version: "5.4.55",
    deprecated: false,
...
/// water-remove
pub const WATER_REMOVE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-water-remove" viewBox="0 0 24 24"><path d="M12 18C12 18.7 12.12 19.36 12.34 20C12.23 20 12.12 20 12 20C8.69 20 6 17.31 6 14C6 10 12 3.25 12 3.25S16.31 8.1 17.62 12C14.5 12.22 12 14.82 12 18M21.54 15.88L20.13 14.47L18 16.59L15.88 14.47L14.47 15.88L16.59 18L14.47 20.12L15.88 21.53L18 19.41L20.12 21.53L21.53 20.12L19.41 18L21.54 15.88Z"/></svg>"#,
    slug: "water-remove",
    version: "5.4.55",
    deprecated: false,
    author: "Colton Wiscombe",
...
/// water
pub const WATER: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-water" viewBox="0 0 24 24"><path d="M12,20A6,6 0 0,1 6,14C6,10 12,3.25 12,3.25C12,3.25 18,10 18,14A6,6 0 0,1 12,20Z"/></svg>"#,
    slug: "water",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
...
/// watering-can
pub const WATERING_CAN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-watering-can" viewBox="0 0 24 24"><path d="M18.5 7.47C17.76 8.2 17.57 9.25 17.92 10.15L15 13.07V11C15 10.45 14.55 10 14 10H12.97C13 9.83 13 9.67 13 9.5C13 6.46 10.54 4 7.5 4S2 6.46 2 9.5C2 11.21 2.78 12.73 4 13.74V20C4 20.55 4.45 21 5 21H14C14.55 21 15 20.55 15 20V15.89L19.33 11.56C20.23 11.91 21.28 11.73 22 11L18.5 7.47M4.05 10C4.03 9.83 4 9.67 4 9.5C4 7.57 5.57 6 7.5 6S11 7.57 11 9.5C11 9.67 10.97 9.83 10.95 10H4.05Z"/></svg>"#,
    slug: "watering-can",
    version: "5.3.45",
    deprecated: false,
    author: "guenth39",
...
/// watermark
pub const WATERMARK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-watermark" viewBox="0 0 24 24"><path d="M21,3H3A2,2 0 0,0 1,5V19A2,2 0 0,0 3,21H21A2,2 0 0,0 23,19V5A2,2 0 0,0 21,3M21,19H12V13H21V19Z"/></svg>"#,
    slug: "watermark",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
...
/// wave-arrow-down
pub const WAVE_ARROW_DOWN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wave-arrow-down" viewBox="0 0 24 24"><path d="M20 7H22V9H20C18.62 9 17.26 8.65 16 8C13.5 9.3 10.5 9.3 8 8C6.74 8.65 5.37 9 4 9H2V7H4C5.39 7 6.78 6.53 8 5.67C10.44 7.38 13.56 7.38 16 5.67C17.22 6.53 18.61 7 20 7M12 22L8 18H11V11H13V18H16L12 22Z"/></svg>"#,
    slug: "wave-arrow-down",
    version: "7.3.67",
    deprecated: false,
    author: "Contributors",
};
...
/// wave-arrow-up
pub const WAVE_ARROW_UP: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wave-arrow-up" viewBox="0 0 24 24"><path d="M20 7H22V9H20C18.62 9 17.26 8.65 16 8C13.5 9.3 10.5 9.3 8 8C6.74 8.65 5.37 9 4 9H2V7H4C5.39 7 6.78 6.53 8 5.67C10.44 7.38 13.56 7.38 16 5.67C17.22 6.53 18.61 7 20 7M12 11L16 15H13V22H11V15H8L12 11Z"/></svg>"#,
    slug: "wave-arrow-up",
    version: "7.3.67",
    deprecated: false,
    author: "Contributors",
...
/// wave-undercurrent
pub const WAVE_UNDERCURRENT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wave-undercurrent" viewBox="0 0 24 24"><path d="M20 7H22V9H20C18.62 9 17.26 8.65 16 8C13.5 9.3 10.5 9.3 8 8C6.74 8.65 5.37 9 4 9H2V7H4C5.39 7 6.78 6.53 8 5.67C10.44 7.38 13.56 7.38 16 5.67C17.22 6.53 18.61 7 20 7M12 12.5C14.21 12.5 16 14.29 16 16.5C16 17.32 15.75 18.08 15.33 18.71L14.24 17.62C14.41 17.28 14.5 16.9 14.5 16.5C14.5 15.12 13.38 14 12 14V15.5L9.75 13.25L12 11V12.5M12 19V17.5L14.25 19.75L12 22V20.5C9.79 20.5 8 18.71 8 16.5C8 15.68 8.25 14.92 8.67 14.29L9.76 15.38C9.59 15.72 9.5 16.1 9.5 16.5C9.5 17.88 10.62 19 12 19Z"/></svg>"#,
    slug: "wave-undercurrent",
    version: "7.3.67",
    deprecated: false,
    author: "Austin Andrews",
};
...
/// wave
pub const WAVE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wave" viewBox="0 0 24 24"><path d="M20,12C18.61,12 17.22,11.53 16,10.67C13.56,12.38 10.44,12.38 8,10.67C6.78,11.53 5.39,12 4,12H2V14H4C5.37,14 6.74,13.65 8,13C10.5,14.3 13.5,14.3 16,13C17.26,13.65 18.62,14 20,14H22V12"/></svg>"#,
    slug: "wave",
    version: "3.8.95",
    deprecated: false,
    author: "Michael Irigoyen",
...
/// waveform
pub const WAVEFORM: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-waveform" viewBox="0 0 24 24"><path d="M22 12L20 13L19 14L18 13L17 16L16 13L15 21L14 13L13 15L12 13L11 17L10 13L9 22L8 13L7 19L6 13L5 14L4 13L2 12L4 11L5 10L6 11L7 5L8 11L9 2L10 11L11 7L12 11L13 9L14 11L15 3L16 11L17 8L18 11L19 10L20 11L22 12Z"/></svg>"#,
    slug: "waveform",
    version: "5.2.45",
    deprecated: false,
...
/// waves-arrow-up
pub const WAVES_ARROW_UP: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-waves-arrow-up" viewBox="0 0 24 24"><path d="M20 14H22V16H20C18.62 16 17.26 15.65 16 15C13.5 16.3 10.5 16.3 8 15C6.74 15.65 5.37 16 4 16H2V14H4C5.39 14 6.78 13.53 8 12.67C10.44 14.38 13.56 14.38 16 12.67C17.22 13.53 18.61 14 20 14M20 20H22V22H20C18.62 22 17.26 21.65 16 21C13.5 22.3 10.5 22.3 8 21C6.74 21.65 5.37 22 4 22H2V20H4C5.39 20 6.78 19.53 8 18.67C10.44 20.38 13.56 20.38 16 18.67C17.22 19.53 18.61 20 20 20M7 2L3 6H6V11H8V6H11M17 2L13 6H16V11H18V6H21"/></svg>"#,
    slug: "waves-arrow-up",
    version: "6.2.95",
    deprecated: false,
    author: "Michael Irigoyen",
...
pub const WEATHER_CLOUDY_ARROW_RIGHT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-cloudy-arrow-right" viewBox="0 0 24 24"><path d="M6,7L6.69,7.06C7.32,4.72 9.46,3 12,3A5.5,5.5 0 0,1 17.5,8.5L17.42,9.45C17.88,9.16 18.42,9 19,9A3,3 0 0,1 22,12A3,3 0 0,1 19,15H6A4,4 0 0,1 2,11A4,4 0 0,1 6,7M6,9A2,2 0 0,0 4,11A2,2 0 0,0 6,13H19A1,1 0 0,0 20,12A1,1 0 0,0 19,11H15.5V8.5A3.5,3.5 0 0,0 12,5A3.5,3.5 0 0,0 8.5,8.5V9H6M22,19L19,22V20H2V18H19V16L22,19"/></svg>"#,
    slug: "weather-cloudy-arrow-right",
    version: "3.6.95",
    deprecated: false,
    author: "Michael Irigoyen",
};
...
/// weather-hurricane
pub const WEATHER_HURRICANE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-hurricane" viewBox="0 0 24 24"><path d="M15,6.79C16.86,7.86 18,9.85 18,12C18,22 6,22 6,22C7.25,21.06 8.38,19.95 9.34,18.71C9.38,18.66 9.41,18.61 9.44,18.55C9.69,18.06 9.5,17.46 9,17.21C7.14,16.14 6,14.15 6,12C6,2 18,2 18,2C16.75,2.94 15.62,4.05 14.66,5.29C14.62,5.34 14.59,5.39 14.56,5.45C14.31,5.94 14.5,6.54 15,6.79M12,14A2,2 0 0,0 14,12A2,2 0 0,0 12,10A2,2 0 0,0 10,12A2,2 0 0,0 12,14Z"/></svg>"#,
    slug: "weather-hurricane",
    version: "2.1.99",
    deprecated: false,
    author: "Michael Richins",
};
...
/// weather-lightning
pub const WEATHER_LIGHTNING: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-lightning" viewBox="0 0 24 24"><path d="M6,16A5,5 0 0,1 1,11A5,5 0 0,1 6,6C7,3.65 9.3,2 12,2C15.43,2 18.24,4.66 18.5,8.03L19,8A4,4 0 0,1 23,12A4,4 0 0,1 19,16H18A1,1 0 0,1 17,15A1,1 0 0,1 18,14H19A2,2 0 0,0 21,12A2,2 0 0,0 19,10H17V9A5,5 0 0,0 12,4C9.5,4 7.45,5.82 7.06,8.19C6.73,8.07 6.37,8 6,8A3,3 0 0,0 3,11A3,3 0 0,0 6,14H7A1,1 0 0,1 8,15A1,1 0 0,1 7,16H6M12,11H15L13,15H15L11.25,22L12,17H9.5L12,11Z"/></svg>"#,
...
pub const WEATHER_MOONSET_DOWN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-moonset-down" viewBox="0 0 24 24"><path d="M3 12H7C7 10.67 7.53 9.4 8.46 8.46C9.4 7.53 10.67 7 12 7C13.33 7 14.6 7.53 15.54 8.46C16.47 9.4 17 10.67 17 12H21C21.27 12 21.5 12.11 21.71 12.29C21.9 12.5 22 12.74 22 13C22 13.27 21.9 13.5 21.71 13.71C21.5 13.9 21.27 14 21 14H3C2.74 14 2.5 13.9 2.29 13.71C2.11 13.5 2 13.27 2 13C2 12.74 2.11 12.5 2.29 12.29C2.5 12.11 2.74 12 3 12M12.71 20.71L15.82 17.6C16.21 17.21 16.21 16.57 15.82 16.18C15.43 15.79 14.8 15.79 14.41 16.18L12 18.59L9.59 16.18C9.2 15.79 8.57 15.79 8.18 16.18C7.79 16.57 7.79 17.21 8.18 17.6L11.29 20.71C11.5 20.9 11.74 21 12 21C12.26 21 12.5 20.9 12.71 20.71Z"/></svg>"#,
    slug: "weather-moonset-down",
    version: "7.4.47",
    deprecated: false,
    author: "Jeff Anders",
};
...
/// weather-moonset-up
pub const WEATHER_MOONSET_UP: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-moonset-up" viewBox="0 0 24 24"><path d="M3 12H7C7 10.67 7.53 9.4 8.46 8.46C9.4 7.53 10.67 7 12 7C13.33 7 14.6 7.53 15.54 8.46C16.47 9.4 17 10.67 17 12H21C21.27 12 21.5 12.11 21.71 12.29C21.9 12.5 22 12.74 22 13C22 13.27 21.9 13.5 21.71 13.71C21.5 13.9 21.27 14 21 14H3C2.74 14 2.5 13.9 2.29 13.71C2.11 13.5 2 13.27 2 13C2 12.74 2.11 12.5 2.29 12.29C2.5 12.11 2.74 12 3 12M12.71 16.3L15.82 19.41C16.21 19.8 16.21 20.43 15.82 20.82C15.43 21.21 14.8 21.21 14.41 20.82L12 18.41L9.59 20.82C9.2 21.21 8.57 21.21 8.18 20.82C7.79 20.43 7.79 19.8 8.18 19.41L11.29 16.3C11.5 16.1 11.74 16 12 16C12.26 16 12.5 16.1 12.71 16.3Z"/></svg>"#,
    slug: "weather-moonset-up",
    version: "7.4.47",
    deprecated: false,
    author: "Jeff Anders",
};
...
/// weather-night
pub const WEATHER_NIGHT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-night" viewBox="0 0 24 24"><path d="M17.75,4.09L15.22,6.03L16.13,9.09L13.5,7.28L10.87,9.09L11.78,6.03L9.25,4.09L12.44,4L13.5,1L14.56,4L17.75,4.09M21.25,11L19.61,12.25L20.2,14.23L18.5,13.06L16.8,14.23L17.39,12.25L15.75,11L17.81,10.95L18.5,9L19.19,10.95L21.25,11M18.97,15.95C19.8,15.87 20.69,17.05 20.16,17.8C19.84,18.25 19.5,18.67 19.08,19.07C15.17,23 8.84,23 4.94,19.07C1.03,15.17 1.03,8.83 4.94,4.93C5.34,4.53 5.76,4.17 6.21,3.85C6.96,3.32 8.14,4.21 8.06,5.04C7.79,7.9 8.75,10.87 10.95,13.06C13.14,15.26 16.1,16.22 18.97,15.95M17.33,17.97C14.5,17.81 11.7,16.64 9.53,14.5C7.36,12.31 6.2,9.5 6.04,6.68C3.23,9.82 3.34,14.64 6.35,17.66C9.37,20.67 14.19,20.78 17.33,17.97Z"/></svg>"#,
    slug: "weather-night",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// weather-sunny
pub const WEATHER_SUNNY: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-sunny" viewBox="0 0 24 24"><path d="M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M3.36,17L5.12,13.23C5.26,14 5.53,14.78 5.95,15.5C6.37,16.24 6.91,16.86 7.5,17.37L3.36,17M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M20.64,17L16.5,17.36C17.09,16.85 17.62,16.22 18.04,15.5C18.46,14.77 18.73,14 18.87,13.21L20.64,17M12,22L9.59,18.56C10.33,18.83 11.14,19 12,19C12.82,19 13.63,18.83 14.37,18.56L12,22Z"/></svg>"#,
    slug: "weather-sunny",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// weather-sunset-down
pub const WEATHER_SUNSET_DOWN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-sunset-down" viewBox="0 0 24 24"><path d="M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z"/></svg>"#,
    slug: "weather-sunset-down",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
};
...
/// weather-tornado
pub const WEATHER_TORNADO: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-tornado" viewBox="0 0 24 24"><path d="M21,5H3A1,1 0 0,1 2,4A1,1 0 0,1 3,3H21A1,1 0 0,1 22,4A1,1 0 0,1 21,5M20,8A1,1 0 0,0 19,7H5A1,1 0 0,0 4,8A1,1 0 0,0 5,9H19A1,1 0 0,0 20,8M21,12A1,1 0 0,0 20,11H10A1,1 0 0,0 9,12A1,1 0 0,0 10,13H20A1,1 0 0,0 21,12M16,16A1,1 0 0,0 15,15H9A1,1 0 0,0 8,16A1,1 0 0,0 9,17H15A1,1 0 0,0 16,16M13,20A1,1 0 0,0 12,19H10A1,1 0 0,0 9,20A1,1 0 0,0 10,21H12A1,1 0 0,0 13,20Z"/></svg>"#,
    slug: "weather-tornado",
    version: "3.8.95",
    deprecated: false,
    author: "Michael Irigoyen",
};
...
pub const WEATHER_WINDY_VARIANT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-windy-variant" viewBox="0 0 24 24"><path d="M6,6L6.69,6.06C7.32,3.72 9.46,2 12,2A5.5,5.5 0 0,1 17.5,7.5L17.42,8.45C17.88,8.16 18.42,8 19,8A3,3 0 0,1 22,11A3,3 0 0,1 19,14H6A4,4 0 0,1 2,10A4,4 0 0,1 6,6M6,8A2,2 0 0,0 4,10A2,2 0 0,0 6,12H19A1,1 0 0,0 20,11A1,1 0 0,0 19,10H15.5V7.5A3.5,3.5 0 0,0 12,4A3.5,3.5 0 0,0 8.5,7.5V8H6M18,18H4A1,1 0 0,1 3,17A1,1 0 0,1 4,16H18A3,3 0 0,1 21,19A3,3 0 0,1 18,22C17.17,22 16.42,21.66 15.88,21.12C15.5,20.73 15.5,20.1 15.88,19.71C16.27,19.32 16.9,19.32 17.29,19.71C17.47,19.89 17.72,20 18,20A1,1 0 0,0 19,19A1,1 0 0,0 18,18Z"/></svg>"#,
    slug: "weather-windy-variant",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
};
...
/// weather-windy
pub const WEATHER_WINDY: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-weather-windy" viewBox="0 0 24 24"><path d="M4,10A1,1 0 0,1 3,9A1,1 0 0,1 4,8H12A2,2 0 0,0 14,6A2,2 0 0,0 12,4C11.45,4 10.95,4.22 10.59,4.59C10.2,5 9.56,5 9.17,4.59C8.78,4.2 8.78,3.56 9.17,3.17C9.9,2.45 10.9,2 12,2A4,4 0 0,1 16,6A4,4 0 0,1 12,10H4M19,12A1,1 0 0,0 20,11A1,1 0 0,0 19,10C18.72,10 18.47,10.11 18.29,10.29C17.9,10.68 17.27,10.68 16.88,10.29C16.5,9.9 16.5,9.27 16.88,8.88C17.42,8.34 18.17,8 19,8A3,3 0 0,1 22,11A3,3 0 0,1 19,14H5A1,1 0 0,1 4,13A1,1 0 0,1 5,12H19M18,18H4A1,1 0 0,1 3,17A1,1 0 0,1 4,16H18A3,3 0 0,1 21,19A3,3 0 0,1 18,22C17.17,22 16.42,21.66 15.88,21.12C15.5,20.73 15.5,20.1 15.88,19.71C16.27,19.32 16.9,19.32 17.29,19.71C17.47,19.89 17.72,20 18,20A1,1 0 0,0 19,19A1,1 0 0,0 18,18Z"/></svg>"#,
    slug: "weather-windy",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// web-off
pub const WEB_OFF: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-web-off" viewBox="0 0 24 24"><path d="M9.4 4.44C9.19 4.83 9 5.23 8.84 5.64L10.37 7.17C10.78 6.05 11.33 5 12 4.03C12.83 5.23 13.5 6.57 13.91 8H11.2L13.2 10H14.34C14.4 10.41 14.44 10.84 14.47 11.27L16.44 13.24C16.47 12.83 16.5 12.42 16.5 12C16.5 11.32 16.44 10.66 16.36 10H19.74C19.9 10.64 20 11.31 20 12S19.9 13.36 19.74 14H17.2L20.5 17.28C21.44 15.75 22 13.94 22 12C22 6.5 17.5 2 12 2C10.06 2 8.25 2.56 6.72 3.5L8.18 5C8.57 4.77 9 4.58 9.4 4.44M18.92 8H15.97C15.65 6.75 15.19 5.55 14.59 4.44C16.43 5.07 17.96 6.34 18.92 8M2.39 1.73L1.11 3L4.06 5.95C2.77 7.63 2 9.73 2 12C2 17.5 6.5 22 12 22C14.28 22 16.37 21.23 18.06 19.95L20.84 22.73L22.11 21.46L2.39 1.73M5.5 7.37L6.11 8H5.08C5.2 7.78 5.34 7.58 5.5 7.37M4.26 14C4.1 13.36 4 12.69 4 12S4.1 10.64 4.26 10H7.64C7.56 10.66 7.5 11.32 7.5 12S7.56 13.34 7.64 14H4.26M5.08 16H8C8.35 17.25 8.8 18.45 9.4 19.56C7.57 18.93 6.03 17.65 5.08 16M9.5 12C9.5 11.8 9.5 11.61 9.53 11.42L12.11 14H9.66C9.56 13.34 9.5 12.68 9.5 12M12 19.96C11.17 18.76 10.5 17.43 10.09 16H13.91C13.5 17.43 12.83 18.76 12 19.96M14.59 19.56C14.96 18.88 15.26 18.15 15.5 17.41L16.62 18.5C16 18.95 15.32 19.31 14.59 19.56Z"/></svg>"#,
    slug: "web-off",
    version: "2.7.94",
    deprecated: false,
    author: "Colton Wiscombe",
...
pub const WEB: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-web" viewBox="0 0 24 24"><path d="M16.36,14C16.44,13.34 16.5,12.68 16.5,12C16.5,11.32 16.44,10.66 16.36,10H19.74C19.9,10.64 20,11.31 20,12C20,12.69 19.9,13.36 19.74,14M14.59,19.56C15.19,18.45 15.65,17.25 15.97,16H18.92C17.96,17.65 16.43,18.93 14.59,19.56M14.34,14H9.66C9.56,13.34 9.5,12.68 9.5,12C9.5,11.32 9.56,10.65 9.66,10H14.34C14.43,10.65 14.5,11.32 14.5,12C14.5,12.68 14.43,13.34 14.34,14M12,19.96C11.17,18.76 10.5,17.43 10.09,16H13.91C13.5,17.43 12.83,18.76 12,19.96M8,8H5.08C6.03,6.34 7.57,5.06 9.4,4.44C8.8,5.55 8.35,6.75 8,8M5.08,16H8C8.35,17.25 8.8,18.45 9.4,19.56C7.57,18.93 6.03,17.65 5.08,16M4.26,14C4.1,13.36 4,12.69 4,12C4,11.31 4.1,10.64 4.26,10H7.64C7.56,10.66 7.5,11.32 7.5,12C7.5,12.68 7.56,13.34 7.64,14M12,4.03C12.83,5.23 13.5,6.57 13.91,8H10.09C10.5,6.57 11.17,5.23 12,4.03M18.92,8H15.97C15.65,6.75 15.19,5.55 14.59,4.44C16.43,5.07 17.96,6.34 18.92,8M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z"/></svg>"#,
    slug: "web",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
...
/// weight-kilogram
pub const WEIGHT_KILOGRAM: Icon = Icon {
...
/// weight-lifter
pub const WEIGHT_LIFTER: Icon = Icon {
...
/// weight-pound
pub const WEIGHT_POUND: Icon = Icon {
...
/// wheel-barrow
pub const WHEEL_BARROW: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wheel-barrow" viewBox="0 0 24 24"><path d="M18 15.5C18.83 15.5 19.5 16.17 19.5 17S18.83 18.5 18 18.5 16.5 17.83 16.5 17 17.17 15.5 18 15.5M18 14C16.34 14 15 15.34 15 17S16.34 20 18 20C19.66 20 21 18.66 21 17S19.66 14 18 14M7 8L5 5H2V7H5.13L8 11.3V20H10L12.57 15H14.55C15.25 13.81 16.5 13 18 13C18.88 13 19.69 13.29 20.35 13.78L22 8H7M9.39 19H9V12.8L9.87 14.11C10.23 14.64 10.82 14.96 11.45 15L9.39 19Z"/></svg>"#,
    slug: "wheel-barrow",
    version: "5.4.55",
    deprecated: false,
    author: "Michael Irigoyen",
...
/// wheelchair
pub const WHEELCHAIR: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wheelchair" viewBox="0 0 24 24"><path d="M14 16L15.32 17.76C14.32 19.68 12.31 21 10 21C6.69 21 4 18.31 4 15C4 12.57 5.46 10.5 7.55 9.55L7.76 11.72C6.71 12.44 6 13.63 6 15C6 17.21 7.79 19 10 19C11.86 19 13.41 17.72 13.86 16H14M19.55 16.11L18.3 16.73L15.5 13H10.91L10.71 11H14V9H10.5L10.2 6C11.21 5.88 12 5.04 12 4C12 2.9 11.11 2 10 2S8 2.9 8 4C8 4.03 8 4.07 8 4.1H8L9.1 15H14.5L17.7 19.27L20.45 17.9L19.55 16.11Z"/></svg>"#,
    slug: "wheelchair",
    version: "6.7.96",
    deprecated: false,
    author: "Michael Irigoyen",
...
/// whistle-outline
pub const WHISTLE_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-whistle-outline" viewBox="0 0 24 24"><path d="M3.76 3.7L2.14 4.88L4.43 8A8.23 8.23 0 0 1 6.35 7.28M11 9V11H18V11.29L13 12.71V15.5A4.5 4.5 0 1 1 8.5 11H9V9H8.5A6.5 6.5 0 1 0 15 15.5V13.91L22 12V9M16.24 3.7L13.85 7H16.32L17.86 4.88M9 2V7H11V2Z"/></svg>"#,
    slug: "whistle-outline",
    version: "4.8.95",
    deprecated: false,
    author: "Michael Richins",
};
...
/// white-balance-auto
pub const WHITE_BALANCE_AUTO: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-white-balance-auto" viewBox="0 0 24 24"><path d="M10.3,16L9.6,14H6.4L5.7,16H3.8L7,7H9L12.2,16M22,7L20.8,13.29L19.3,7H17.7L16.21,13.29L15,7H14.24C12.77,5.17 10.5,4 8,4A8,8 0 0,0 0,12A8,8 0 0,0 8,20C11.13,20 13.84,18.19 15.15,15.57L15.25,16H17L18.5,9.9L20,16H21.75L23.8,7M6.85,12.65H9.15L8,9L6.85,12.65Z"/></svg>"#,
    slug: "white-balance-auto",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
};
...
pub const WHITE_BALANCE_IRIDESCENT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-white-balance-iridescent" viewBox="0 0 24 24"><path d="M4.96,19.95L6.76,18.15L5.34,16.74L3.55,18.53M3.55,4.46L5.34,6.26L6.76,4.84L4.96,3.05M20.45,18.53L18.66,16.74L17.24,18.15L19.04,19.95M13,22.45V19.5H11V22.45C11.32,22.45 13,22.45 13,22.45M19.04,3.05L17.24,4.84L18.66,6.26L20.45,4.46M11,3.5H13V0.55H11M5,14.5H19V8.5H5V14.5Z"/></svg>"#,
    slug: "white-balance-iridescent",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
};
...
/// white-balance-sunny
pub const WHITE_BALANCE_SUNNY: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-white-balance-sunny" viewBox="0 0 24 24"><path d="M3.55 19.09L4.96 20.5L6.76 18.71L5.34 17.29M12 6C8.69 6 6 8.69 6 12S8.69 18 12 18 18 15.31 18 12C18 8.68 15.31 6 12 6M20 13H23V11H20M17.24 18.71L19.04 20.5L20.45 19.09L18.66 17.29M20.45 5L19.04 3.6L17.24 5.39L18.66 6.81M13 1H11V4H13M6.76 5.39L4.96 3.6L3.55 5L5.34 6.81L6.76 5.39M1 13H4V11H1M13 20H11V23H13"/></svg>"#,
    slug: "white-balance-sunny",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
};
...
/// widgets-outline
pub const WIDGETS_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-widgets-outline" viewBox="0 0 24 24"><path d="M16.7 4.5L19.5 7.3L16.7 10.1L13.9 7.3L16.7 4.5M9 5V9H5V5H9M19 15V19H15V15H19M16.7 1.7L11 7.3L16.7 13H13V21H21V13H16.7L22.3 7.3L16.7 1.7M11 3H3V11H11V3M9 15V19H5V15H9M11 13H3V21H11V13Z"/></svg>"#,
    slug: "widgets-outline",
    version: "4.9.95",
    deprecated: false,
    author: "Google",
};
...
/// widgets
pub const WIDGETS: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-widgets" viewBox="0 0 24 24"><path d="M3,3H11V7.34L16.66,1.69L22.31,7.34L16.66,13H21V21H13V13H16.66L11,7.34V11H3V3M3,13H11V21H3V13Z"/></svg>"#,
    slug: "widgets",
    version: "1.8.36",
    deprecated: false,
    author: "Google",
...
/// wifi-arrow-left
pub const WIFI_ARROW_LEFT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-arrow-left" viewBox="0 0 24 24"><path d="M12 12C9.97 12 8.1 12.67 6.6 13.8L4.8 11.4C6.81 9.89 9.3 9 12 9S17.19 9.89 19.2 11.4L17.92 13.1C17.55 13.17 17.18 13.27 16.84 13.41C15.44 12.5 13.78 12 12 12M21 9L22.8 6.6C19.79 4.34 16.05 3 12 3S4.21 4.34 1.2 6.6L3 9C5.5 7.12 8.62 6 12 6S18.5 7.12 21 9M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M18 16L15 19L18 22V20H22V18H18V16Z"/></svg>"#,
    slug: "wifi-arrow-left",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
};
...
/// wifi-arrow-right
pub const WIFI_ARROW_RIGHT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-arrow-right" viewBox="0 0 24 24"><path d="M12 6C8.62 6 5.5 7.12 3 9L1.2 6.6C4.21 4.34 7.95 3 12 3S19.79 4.34 22.8 6.6L21 9C18.5 7.12 15.38 6 12 6M16.84 13.41C17.18 13.27 17.55 13.17 17.92 13.1L19.2 11.4C17.19 9.89 14.7 9 12 9S6.81 9.89 4.8 11.4L6.6 13.8C8.1 12.67 9.97 12 12 12C13.78 12 15.44 12.5 16.84 13.41M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M23 19L20 16V18H16V20H20V22L23 19Z"/></svg>"#,
    slug: "wifi-arrow-right",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
};
...
/// wifi-arrow-up-down
pub const WIFI_ARROW_UP_DOWN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-arrow-up-down" viewBox="0 0 24 24"><path d="M12 12C9.97 12 8.1 12.67 6.6 13.8L4.8 11.4C6.81 9.89 9.3 9 12 9S17.19 9.89 19.2 11.4L17.92 13.1C17.55 13.17 17.18 13.27 16.84 13.41C15.44 12.5 13.78 12 12 12M21 9L22.8 6.6C19.79 4.34 16.05 3 12 3S4.21 4.34 1.2 6.6L3 9C5.5 7.12 8.62 6 12 6S18.5 7.12 21 9M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M17 15L14.5 18H16V22H18V18H19.5L17 15M22 20V16H20V20H18.5L21 23L23.5 20H22Z"/></svg>"#,
    slug: "wifi-arrow-up-down",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
};
...
/// wifi-arrow-up
pub const WIFI_ARROW_UP: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-arrow-up" viewBox="0 0 24 24"><path d="M12 12C9.97 12 8.1 12.67 6.6 13.8L4.8 11.4C6.81 9.89 9.3 9 12 9S17.19 9.89 19.2 11.4L17.92 13.1C17.55 13.17 17.18 13.27 16.84 13.41C15.44 12.5 13.78 12 12 12M21 9L22.8 6.6C19.79 4.34 16.05 3 12 3S4.21 4.34 1.2 6.6L3 9C5.5 7.12 8.62 6 12 6S18.5 7.12 21 9M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M16 18H18V22H20V18H22L19 15L16 18Z"/></svg>"#,
    slug: "wifi-arrow-up",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
...
/// wifi-cancel
pub const WIFI_CANCEL: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-cancel" viewBox="0 0 24 24"><path d="M12 6C8.62 6 5.5 7.12 3 9L1.2 6.6C4.21 4.34 7.95 3 12 3S19.79 4.34 22.8 6.6L21 9C18.5 7.12 15.38 6 12 6M15.53 12.72C16.42 12.26 17.43 12 18.5 12C18.58 12 18.66 12 18.74 12L19.2 11.4C17.19 9.89 14.7 9 12 9S6.81 9.89 4.8 11.4L6.6 13.8C8.1 12.67 9.97 12 12 12C13.26 12 14.45 12.26 15.53 12.72M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L12.34 20.54C12.13 19.9 12 19.22 12 18.5C12 17.24 12.36 16.08 13 15.08C12.66 15.03 12.33 15 12 15M23 18.5C23 21 21 23 18.5 23S14 21 14 18.5 16 14 18.5 14 23 16 23 18.5M20 21.08L15.92 17C15.65 17.42 15.5 17.94 15.5 18.5C15.5 20.16 16.84 21.5 18.5 21.5C19.06 21.5 19.58 21.35 20 21.08M21.5 18.5C21.5 16.84 20.16 15.5 18.5 15.5C17.94 15.5 17.42 15.65 17 15.92L21.08 20C21.35 19.58 21.5 19.06 21.5 18.5Z"/></svg>"#,
    slug: "wifi-cancel",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
...
/// wifi-check
pub const WIFI_CHECK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-check" viewBox="0 0 24 24"><path d="M12 12C9.97 12 8.1 12.67 6.6 13.8L4.8 11.4C6.81 9.89 9.3 9 12 9S17.19 9.89 19.2 11.4L17.92 13.1C17.55 13.17 17.18 13.27 16.84 13.41C15.44 12.5 13.78 12 12 12M21 9L22.8 6.6C19.79 4.34 16.05 3 12 3S4.21 4.34 1.2 6.6L3 9C5.5 7.12 8.62 6 12 6S18.5 7.12 21 9M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M17.75 19.43L16.16 17.84L15 19L17.75 22L22.5 17.25L21.34 15.84L17.75 19.43Z"/></svg>"#,
    slug: "wifi-check",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
...
/// wifi-minus
pub const WIFI_MINUS: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-minus" viewBox="0 0 24 24"><path d="M12 12C9.97 12 8.1 12.67 6.6 13.8L4.8 11.4C6.81 9.89 9.3 9 12 9S17.19 9.89 19.2 11.4L17.92 13.1C17.55 13.17 17.18 13.27 16.84 13.41C15.44 12.5 13.78 12 12 12M21 9L22.8 6.6C19.79 4.34 16.05 3 12 3S4.21 4.34 1.2 6.6L3 9C5.5 7.12 8.62 6 12 6S18.5 7.12 21 9M12 15C10.65 15 9.4 15.45 8.4 16.2L12 21L13.04 19.61C13 19.41 13 19.21 13 19C13 17.66 13.44 16.43 14.19 15.43C13.5 15.16 12.77 15 12 15M15 18V20H23V18H15Z"/></svg>"#,
    slug: "wifi-minus",
    version: "5.8.55",
    deprecated: false,
    author: "Colton Wiscombe",
...
/// wifi-off
pub const WIFI_OFF: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-off" viewBox="0 0 24 24"><path d="M2.28,3L1,4.27L2.47,5.74C2.04,6 1.61,6.29 1.2,6.6L3,9C3.53,8.6 4.08,8.25 4.66,7.93L6.89,10.16C6.15,10.5 5.44,10.91 4.8,11.4L6.6,13.8C7.38,13.22 8.26,12.77 9.2,12.47L11.75,15C10.5,15.07 9.34,15.5 8.4,16.2L12,21L14.46,17.73L17.74,21L19,19.72M12,3C9.85,3 7.8,3.38 5.9,4.07L8.29,6.47C9.5,6.16 10.72,6 12,6C15.38,6 18.5,7.11 21,9L22.8,6.6C19.79,4.34 16.06,3 12,3M12,9C11.62,9 11.25,9 10.88,9.05L14.07,12.25C15.29,12.53 16.43,13.07 17.4,13.8L19.2,11.4C17.2,9.89 14.7,9 12,9Z"/></svg>"#,
    slug: "wifi-off",
    version: "1.5.54",
    deprecated: false,
    author: "Simran",
...
pub const WIFI_STRENGTH_1_ALERT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-1-alert" viewBox="0 0 24 24"><path d="M12 3C7.8 3 3.7 4.4 .4 7C4.4 12.1 7.9 16.4 12 21.5C14.4 18.5 16.7 15.7 19 12.8V9.6L15.6 13.8C14.5 13.3 13.2 13 12 13S9.5 13.3 8.4 13.8L3.3 7.4C5.9 5.8 8.9 5 12 5S18.1 5.9 20.7 7.4L20.3 8H22.9C23.1 7.7 23.5 7.3 23.7 7C20.3 4.4 16.2 3 12 3M21 10V16H23V10M21 18V20H23V18"/></svg>"#,
    slug: "wifi-strength-1-alert",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_2_ALERT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-2-alert" viewBox="0 0 24 24"><path d="M12 3C7.8 3 3.7 4.4 .4 7C4.4 12.1 7.9 16.4 12 21.5C14.4 18.5 16.7 15.7 19 12.8V9.6L17.5 11.4C16.3 10.7 14.4 10 12 10C9.6 10 7.7 10.8 6.5 11.4L3.3 7.4C5.9 5.8 8.9 5 12 5S18.1 5.9 20.7 7.4L20.3 8H22.9C23.1 7.7 23.5 7.3 23.7 7C20.3 4.4 16.2 3 12 3M21 10V16H23V10M21 18V20H23V18"/></svg>"#,
    slug: "wifi-strength-2-alert",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
/// wifi-strength-2
pub const WIFI_STRENGTH_2: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-2" viewBox="0 0 24 24"><path d="M12,3C7.79,3 3.7,4.41 0.38,7C4.41,12.06 7.89,16.37 12,21.5C16.08,16.42 20.24,11.24 23.65,7C20.32,4.41 16.22,3 12,3M12,5C15.07,5 18.09,5.86 20.71,7.45L17.5,11.43C16.26,10.74 14.37,10 12,10C9.62,10 7.74,10.75 6.5,11.43L3.27,7.44C5.91,5.85 8.93,5 12,5Z"/></svg>"#,
    slug: "wifi-strength-2",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_3_ALERT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-3-alert" viewBox="0 0 24 24"><path d="M12 3C7.8 3 3.7 4.4 .4 7C4.4 12.1 7.9 16.4 12 21.5C14.4 18.5 16.7 15.7 19 12.8V9.6L18.8 9.9C17.3 9 14.9 8 12 8C9 8 6.7 9 5.2 9.8L3.3 7.4C5.9 5.8 8.9 5 12 5S18.1 5.9 20.7 7.4L20.3 8H22.9C23.1 7.7 23.5 7.3 23.7 7C20.3 4.4 16.2 3 12 3M21 10V16H23V10M21 18V20H23V18"/></svg>"#,
    slug: "wifi-strength-3-alert",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
/// wifi-strength-3
pub const WIFI_STRENGTH_3: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-3" viewBox="0 0 24 24"><path d="M12,3C7.79,3 3.7,4.41 0.38,7C4.41,12.06 7.89,16.37 12,21.5C16.08,16.42 20.24,11.24 23.65,7C20.32,4.41 16.22,3 12,3M12,5C15.07,5 18.09,5.86 20.71,7.45L18.77,9.88C17.26,9 14.88,8 12,8C9,8 6.68,9 5.21,9.84L3.27,7.44C5.91,5.85 8.93,5 12,5Z"/></svg>"#,
    slug: "wifi-strength-3",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_4_ALERT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-4-alert" viewBox="0 0 24 24"><path d="M12 3C7.8 3 3.7 4.4 .4 7C4.4 12.1 7.9 16.4 12 21.5C14.4 18.5 16.7 15.7 19 12.8V8H22.8C23 7.7 23.4 7.3 23.6 7C20.3 4.4 16.2 3 12 3M21 10V16H23V10M21 18V20H23V18"/></svg>"#,
    slug: "wifi-strength-4-alert",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_4_LOCK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-4-lock" viewBox="0 0 24 24"><path d="M14.2 14.5V14.74C13.5 15.34 13 16.24 13 17.2V20.24L12 21.5C7.88 16.37 4.39 12.06 .365 7C3.69 4.41 7.78 3 12 3C16.2 3 20.31 4.41 23.64 7L20.91 10.39C20.32 10.14 19.68 10 19 10C16.4 10 14.2 12.06 14.2 14.5M23 17.3V20.8C23 21.4 22.4 22 21.7 22H16.2C15.6 22 15 21.4 15 20.7V17.2C15 16.6 15.6 16 16.2 16V14.5C16.2 13.1 17.6 12 19 12S21.8 13.1 21.8 14.5V16C22.4 16 23 16.6 23 17.3M20.5 14.5C20.5 13.7 19.8 13.2 19 13.2S17.5 13.7 17.5 14.5V16H20.5V14.5Z"/></svg>"#,
    slug: "wifi-strength-4-lock",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
/// wifi-strength-4
pub const WIFI_STRENGTH_4: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-4" viewBox="0 0 24 24"><path d="M12,3C7.79,3 3.7,4.41 0.38,7C4.41,12.06 7.89,16.37 12,21.5C16.08,16.42 20.24,11.24 23.65,7C20.32,4.41 16.22,3 12,3Z"/></svg>"#,
    slug: "wifi-strength-4",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_ALERT_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-alert-outline" viewBox="0 0 24 24"><path d="M12 3C7.8 3 3.7 4.4 .4 7C4.3 11.8 8.2 16.7 12 21.5C14.3 18.6 16.7 15.7 19 12.8V9.6L12 18.3L3.3 7.4C5.9 5.8 8.9 5 12 5C15.1 5 18.1 5.9 20.7 7.4L20.3 8H22.9C23.2 7.7 23.4 7.3 23.7 7C20.3 4.4 16.2 3 12 3M21 10V16H23V10M21 18V20H23V18"/></svg>"#,
    slug: "wifi-strength-alert-outline",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
/// wifi-strength-off
pub const WIFI_STRENGTH_OFF: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-off" viewBox="0 0 24 24"><path d="M3.27,1.44L2,2.72L4.05,4.77C2.75,5.37 1.5,6.11 0.38,7C4.41,12.06 12,21.5 12,21.5L15.91,16.63L19.23,19.95L20.5,18.68M12,3C10.6,3 9.21,3.17 7.86,3.5L18.18,13.81C20,11.5 22.05,9 23.65,7C20.32,4.41 16.22,3 12,3Z"/></svg>"#,
    slug: "wifi-strength-off",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
pub const WIFI_STRENGTH_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wifi-strength-outline" viewBox="0 0 24 24"><path d="M12,3C7.79,3 3.7,4.41 0.38,7H0.36C4.24,11.83 8.13,16.66 12,21.5C15.89,16.66 19.77,11.83 23.64,7H23.65C20.32,4.41 16.22,3 12,3M12,5C15.07,5 18.09,5.86 20.71,7.45L12,18.3L3.27,7.44C5.9,5.85 8.92,5 12,5Z"/></svg>"#,
    slug: "wifi-strength-outline",
    version: "2.3.50",
    deprecated: false,
    author: "Simran",
};
...
/// window-close
pub const WINDOW_CLOSE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-close" viewBox="0 0 24 24"><path d="M13.46,12L19,17.54V19H17.54L12,13.46L6.46,19H5V17.54L10.54,12L5,6.46V5H6.46L12,10.54L17.54,5H19V6.46L13.46,12Z"/></svg>"#,
    slug: "window-close",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
pub const WINDOW_CLOSED_VARIANT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-closed-variant" viewBox="0 0 24 24"><path d="M21 20V2H3V20H1V23H23V20M19 4V11H13V4M5 4H11V11H5M5 20V13H11V20M13 20V13H19V20Z"/></svg>"#,
    slug: "window-closed-variant",
    version: "4.5.95",
    deprecated: false,
    author: "Michael Richins",
};
...
/// window-closed
pub const WINDOW_CLOSED: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-closed" viewBox="0 0 24 24"><path d="M6,11H10V9H14V11H18V4H6V11M18,13H6V20H18V13M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2Z"/></svg>"#,
    slug: "window-closed",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// window-maximize
pub const WINDOW_MAXIMIZE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-maximize" viewBox="0 0 24 24"><path d="M4,4H20V20H4V4M6,8V18H18V8H6Z"/></svg>"#,
...
/// window-open-variant
pub const WINDOW_OPEN_VARIANT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-open-variant" viewBox="0 0 24 24"><path d="M21 20V2H3V20H1V23H23V20M19 4V11H17V4M5 4H7V11H5M5 20V13H7V20M9 20V4H15V20M17 20V13H19V20Z"/></svg>"#,
    slug: "window-open-variant",
    version: "4.5.95",
    deprecated: false,
    author: "Michael Richins",
};
...
/// window-open
pub const WINDOW_OPEN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-open" viewBox="0 0 24 24"><path d="M6,8H10V6H14V8H18V4H6V8M18,10H6V15H18V10M6,20H18V17H6V20M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2Z"/></svg>"#,
    slug: "window-open",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// window-restore
pub const WINDOW_RESTORE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-restore" viewBox="0 0 24 24"><path d="M4,8H8V4H20V16H16V20H4V8M16,8V14H18V6H10V8H16M6,12V18H14V12H6Z"/></svg>"#,
    slug: "window-restore",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
pub const WINDOW_SHUTTER_ALERT: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-shutter-alert" viewBox="0 0 24 24"><path d="M2 4H20V8H18V20H16V8H6V20H4V8H2V4M7 9H15V11H7V9M7 12H15V14H7V12M20 19V17H22V19H20M20 15V10H22V15H20Z"/></svg>"#,
    slug: "window-shutter-alert",
    version: "4.3.95",
    deprecated: false,
    author: "idevo89",
};
...
/// window-shutter-auto
pub const WINDOW_SHUTTER_AUTO: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-shutter-auto" viewBox="0 0 24 24"><path d="M20 14H18L14.8 23H16.7L17.4 21H20.6L21.3 23H23.2L20 14M17.8 19.7L19 16L20.2 19.7H17.8M7 9H15V11H7V9M7 12H15V14H7V12M7 15H15V16.5L14.8 17H7V15M13.7 20H7V18H14.5L13.7 20M16 8H6V20H4V8H2V4H20V8H18V12H16.6L16.1 13.3L16 13.7V8Z"/></svg>"#,
    slug: "window-shutter-auto",
    version: "7.0.96",
    deprecated: false,
    author: "Michael Irigoyen",
};
...
/// window-shutter-open
pub const WINDOW_SHUTTER_OPEN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-shutter-open" viewBox="0 0 24 24"><path d="M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9Z"/></svg>"#,
    slug: "window-shutter-open",
    version: "4.3.95",
    deprecated: false,
    author: "idevo89",
};
...
pub const WINDOW_SHUTTER_SETTINGS: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-shutter-settings" viewBox="0 0 24 24"><path d="M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9M8 12H16V14H8V12M8 15H16V17H8V15M8 18H16V20H8V18M13 22H11V24H13V22M17 22H15V24H17V22M9 22H7V24H9V22Z"/></svg>"#,
    slug: "window-shutter-settings",
    version: "6.7.96",
    deprecated: false,
    author: "Michael Irigoyen",
};
...
/// window-shutter
pub const WINDOW_SHUTTER: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-window-shutter" viewBox="0 0 24 24"><path d="M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9M8 12H16V14H8V12M8 15H16V17H8V15M8 18H16V20H8V18Z"/></svg>"#,
    slug: "window-shutter",
    version: "4.3.95",
    deprecated: false,
    author: "idevo89",
...
/// windsock
pub const WINDSOCK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-windsock" viewBox="0 0 24 24"><path d="M7 5V13L22 11V7L7 5M10 6.91L13 7.31V10.69L10 11.09V6.91M16 7.71L19 8.11V9.89L16 10.29V7.71M5 10V11H6V12H5V21H3V4C3 3.45 3.45 3 4 3S5 3.45 5 4V6H6V7H5V10Z"/></svg>"#,
    slug: "windsock",
    version: "5.6.55",
    deprecated: false,
    author: "Michael Irigoyen",
...
/// wrap-disabled
pub const WRAP_DISABLED: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wrap-disabled" viewBox="0 0 24 24"><path d="M16,7H3V5H16V7M3,19H16V17H3V19M22,12L18,9V11H3V13H18V15L22,12Z"/></svg>"#,
    slug: "wrap-disabled",
    version: "3.0.39",
    deprecated: false,
    author: "Leo SF",
...
/// wrap
pub const WRAP: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wrap" viewBox="0 0 24 24"><path d="M21,5H3V7H21V5M3,19H10V17H3V19M3,13H18C19,13 20,13.43 20,15C20,16.57 19,17 18,17H16V15L12,18L16,21V19H18C20.95,19 22,17.73 22,15C22,12.28 21,11 18,11H3V13Z"/></svg>"#,
    slug: "wrap",
    version: "1.5.54",
    deprecated: false,
    author: "Doug C. Hardester",
...
/// wrench-check
pub const WRENCH_CHECK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wrench-check" viewBox="0 0 24 24"><path d="M9 2C10.8 2.6 12 4.3 12 6.2C12 8.2 10.8 9.9 9 10.5V21.5C9 21.8 8.8 22 8.5 22H6.5C6.2 22 6 21.8 6 21.4V10.4C4.2 9.8 3 8.1 3 6.2S4.2 2.6 6 2V5.7H9V2M20.6 13L22 14.41L15.47 21L12 17.5L13.4 16.09L15.47 18.17L20.6 13"/></svg>"#,
    slug: "wrench-check",
    version: "7.0.96",
    deprecated: false,
    author: "Andrej Sharapov",
...
/// wrench-outline
pub const WRENCH_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wrench-outline" viewBox="0 0 24 24"><path d="M22.61,19L13.53,9.91C14.46,7.57 14,4.81 12.09,2.91C9.79,0.61 6.21,0.4 3.66,2.26L7.5,6.11L6.08,7.5L2.25,3.69C0.39,6.23 0.6,9.82 2.9,12.11C4.76,13.97 7.47,14.46 9.79,13.59L18.9,22.7C19.29,23.09 19.92,23.09 20.31,22.7L22.61,20.4C23,20 23,19.39 22.61,19M19.61,20.59L10.15,11.13C9.54,11.58 8.86,11.85 8.15,11.95C6.79,12.15 5.36,11.74 4.32,10.7C3.37,9.76 2.93,8.5 3,7.26L6.09,10.35L10.33,6.11L7.24,3C8.5,2.95 9.73,3.39 10.68,4.33C11.76,5.41 12.17,6.9 11.92,8.29C11.8,9 11.5,9.66 11.04,10.25L20.5,19.7L19.61,20.59Z"/></svg>"#,
    slug: "wrench-outline",
    version: "3.0.39",
    deprecated: false,
    author: "Google",
...
/// wrench
pub const WRENCH: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-wrench" viewBox="0 0 24 24"><path d="M22.7,19L13.6,9.9C14.5,7.6 14,4.9 12.1,3C10.1,1 7.1,0.6 4.7,1.7L9,6L6,9L1.6,4.7C0.4,7.1 0.9,10.1 2.9,12.1C4.8,14 7.5,14.5 9.8,13.6L18.9,22.7C19.3,23.1 19.9,23.1 20.3,22.7L22.6,20.4C23.1,20 23.1,19.3 22.7,19Z"/></svg>"#,
    slug: "wrench",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
...
/// xml
pub const XML: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-xml" viewBox="0 0 24 24"><path d="M12.89,3L14.85,3.4L11.11,21L9.15,20.6L12.89,3M19.59,12L16,8.41V5.58L22.42,12L16,18.41V15.58L19.59,12M1.58,12L8,5.58V8.41L4.41,12L8,15.58V18.41L1.58,12Z"/></svg>"#,
    slug: "xml",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// yeast
pub const YEAST: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-yeast" viewBox="0 0 24 24"><path d="M18,14A4,4 0 0,1 22,18A4,4 0 0,1 18,22A4,4 0 0,1 14,18L14.09,17.15C14.05,16.45 13.92,15.84 13.55,15.5C13.35,15.3 13.07,15.19 12.75,15.13C11.79,15.68 10.68,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3A6.5,6.5 0 0,1 16,9.5C16,10.68 15.68,11.79 15.13,12.75C15.19,13.07 15.3,13.35 15.5,13.55C15.84,13.92 16.45,14.05 17.15,14.09L18,14M7.5,10A1.5,1.5 0 0,1 9,11.5A1.5,1.5 0 0,1 7.5,13A1.5,1.5 0 0,1 6,11.5A1.5,1.5 0 0,1 7.5,10M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z"/></svg>"#,
    slug: "yeast",
    version: "1.5.54",
    deprecated: false,
    author: "Austin Andrews",
...
/// yin-yang
pub const YIN_YANG: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-yin-yang" viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A4,4 0 0,1 8,16A4,4 0 0,1 12,12A4,4 0 0,0 16,8A4,4 0 0,0 12,4M12,6.5A1.5,1.5 0 0,1 13.5,8A1.5,1.5 0 0,1 12,9.5A1.5,1.5 0 0,1 10.5,8A1.5,1.5 0 0,1 12,6.5M12,14.5A1.5,1.5 0 0,0 10.5,16A1.5,1.5 0 0,0 12,17.5A1.5,1.5 0 0,0 13.5,16A1.5,1.5 0 0,0 12,14.5Z"/></svg>"#,
    slug: "yin-yang",
    version: "1.7.12",
    deprecated: false,
    author: "Austin Andrews",
...
/// yoga
pub const YOGA: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-yoga" viewBox="0 0 24 24"><path d="M13 2C11.9 2 11 2.9 11 4C11 5.11 11.9 6 13 6C14.11 6 15 5.11 15 4C15 2.9 14.11 2 13 2M4 7V9H10V15L4.93 20.07L6.34 21.5L13.06 14.77L17 17.13V21H19V16.57C19 16.21 18.82 15.89 18.5 15.71L15 13.6V9H21V7H4Z"/></svg>"#,
    slug: "yoga",
    version: "4.4.95",
    deprecated: false,
    author: "Michael Irigoyen",
...
/// zip-box-outline
pub const ZIP_BOX_OUTLINE: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zip-box-outline" viewBox="0 0 24 24"><path d="M12 17V15H14V17H12M14 13V11H12V13H14M14 9V7H12V9H14M10 11H12V9H10V11M10 15H12V13H10V15M21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5M19 5H12V7H10V5H5V19H19V5Z"/></svg>"#,
    slug: "zip-box-outline",
    version: "4.0.96",
    deprecated: false,
    author: "Michael Irigoyen",
};
...
/// zip-box
pub const ZIP_BOX: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zip-box" viewBox="0 0 24 24"><path d="M14,17H12V15H10V13H12V15H14M14,9H12V11H14V13H12V11H10V9H12V7H10V5H12V7H14M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z"/></svg>"#,
    slug: "zip-box",
    version: "1.5.54",
    deprecated: false,
    author: "Google",
...
/// zip-disk
pub const ZIP_DISK: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zip-disk" viewBox="0 0 24 24"><path d="M7,3L3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5L17,3V5A1,1 0 0,1 16,6H10A1,1 0 0,1 9,5V3H7M8,10H16A1,1 0 0,1 17,11V19H7V11A1,1 0 0,1 8,10Z"/></svg>"#,
    slug: "zip-disk",
    version: "2.5.94",
    deprecated: false,
    author: "GreenTurtwig",
...
/// zodiac-aries
pub const ZODIAC_ARIES: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-aries" viewBox="0 0 24 24"><path d="M16,2C14.95,2 13.91,2.27 13,2.81C12.64,3 12.3,3.26 12,3.54C11.7,3.26 11.36,3 11,2.81C10.09,2.27 9.05,2 8,2A6,6 0 0,0 2,8A6,6 0 0,0 8,14V12A4,4 0 0,1 4,8A4,4 0 0,1 8,4C9,4 10,4.39 10.75,5.1C10.84,5.18 10.92,5.27 11,5.36V22H13V5.36C13.08,5.27 13.16,5.18 13.25,5.1C14.85,3.58 17.38,3.64 18.91,5.25C20.43,6.85 20.36,9.38 18.76,10.9C18,11.61 17.03,12 16,12V14A6,6 0 0,0 22,8A6,6 0 0,0 16,2Z"/></svg>"#,
    slug: "zodiac-aries",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-cancer
pub const ZODIAC_CANCER: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-cancer" viewBox="0 0 24 24"><path d="M12,4C6.5,4 2,7.58 2,12C2,14.12 3.65,15.87 5.76,16H6A4,4 0 0,0 10,12A4,4 0 0,0 6,8H5.76C7.44,6.41 9.69,5.55 12,5.6C13.77,5.58 15.5,6.07 17,7L18.25,5.75C16.38,4.58 14.21,3.97 12,4M6,10A2,2 0 0,1 8,12C8,13.11 7.08,14 6,14C4.96,14 4.1,13.22 4,12.2C4,12.07 4,11.93 4,11.8C4.1,10.77 4.97,10 6,10M18.24,8H18A4,4 0 0,0 14,12A4,4 0 0,0 18,16H18.24C16.56,17.59 14.31,18.45 12,18.4C10.23,18.42 8.5,17.93 7,17L5.76,18.24C7.63,19.41 9.79,20 12,20C17.5,20 22,16.42 22,12C22,9.88 20.35,8.13 18.24,8M18,14A2,2 0 0,1 16,12C16,10.89 16.92,10 18,10C19.04,10 19.9,10.78 20,11.8C20,11.93 20,12.07 20,12.2C19.9,13.23 19.03,14 18,14Z"/></svg>"#,
    slug: "zodiac-cancer",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-capricorn
pub const ZODIAC_CAPRICORN: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-capricorn" viewBox="0 0 24 24"><path d="M15,13C14.3,13 13.61,13.19 13,13.55V6A3,3 0 0,0 10,3C9.25,3 8.55,3.29 8,3.78C7.45,3.28 6.74,3 6,3V5A1,1 0 0,1 7,6V16H9V6A1,1 0 0,1 10,5A1,1 0 0,1 11,6V17A2,2 0 0,1 9,19V21C10.15,21 11.25,20.5 12,19.62C13.45,21.29 15.97,21.47 17.64,20C19.31,18.58 19.5,16.05 18.04,14.38C17.28,13.5 16.17,13 15,13M15,19A2,2 0 0,1 13,17A2,2 0 0,1 15,15A2,2 0 0,1 17,17A2,2 0 0,1 15,19Z"/></svg>"#,
...
/// zodiac-gemini
pub const ZODIAC_GEMINI: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-gemini" viewBox="0 0 24 24"><path d="M18,5.3C19.35,4.97 20.66,4.54 21.94,4L21.18,2.14C18.27,3.36 15.15,4 12,4C8.85,4 5.73,3.38 2.82,2.17L2.06,4C3.34,4.54 4.65,4.97 6,5.3V18.7C4.65,19.03 3.34,19.46 2.06,20L2.82,21.86C8.7,19.42 15.3,19.42 21.18,21.86L21.94,20C20.66,19.46 19.35,19.03 18,18.7V5.3M8,18.3V5.69C9.32,5.89 10.66,6 12,6C13.34,6 14.68,5.89 16,5.69V18.31C13.35,17.9 10.65,17.9 8,18.31V18.3Z"/></svg>"#,
    slug: "zodiac-gemini",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-leo
pub const ZODIAC_LEO: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-leo" viewBox="0 0 24 24"><path d="M20,17A3,3 0 0,1 17,20C15.38,19.92 14.08,18.62 14,17C14.16,15.39 14.5,13.8 15,12.26C15.54,10.55 15.87,8.79 16,7C15.93,4.27 13.73,2.07 11,2C8.27,2.07 6.07,4.27 6,7C6.15,8.53 6.5,10.03 7,11.5L7.21,12.2C5.1,11.53 2.86,12.7 2.19,14.8C1.5,16.91 2.68,19.16 4.79,19.83C6.9,20.5 9.14,19.33 9.81,17.22C9.94,16.83 10,16.41 10,16C9.84,14.27 9.5,12.56 8.91,10.92C8.47,9.65 8.16,8.34 8,7C8.08,5.38 9.38,4.08 11,4C12.62,4.08 13.92,5.38 14,7C13.84,8.61 13.5,10.2 13,11.74C12.46,13.45 12.13,15.21 12,17C12.07,19.73 14.27,21.93 17,22A5,5 0 0,0 22,17H20M6,18A2,2 0 0,1 4,16A2,2 0 0,1 6,14A2,2 0 0,1 8,16A2,2 0 0,1 6,18Z"/></svg>"#,
    slug: "zodiac-leo",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-libra
pub const ZODIAC_LIBRA: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-libra" viewBox="0 0 24 24"><path d="M20,16V18H13V15.91C16,15.36 17.96,12.5 17.41,9.5C16.86,6.5 14,4.54 11,5.09C8,5.65 6.04,8.5 6.59,11.5C7,13.74 8.76,15.5 11,15.91V18H4V16H6.92C5.37,14.59 4.5,12.59 4.5,10.5A7.5,7.5 0 0,1 12,3A7.5,7.5 0 0,1 19.5,10.5C19.5,12.59 18.63,14.59 17.08,16H20M20,19H4V21H20V19Z"/></svg>"#,
    slug: "zodiac-libra",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-pisces
pub const ZODIAC_PISCES: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-pisces" viewBox="0 0 24 24"><path d="M20,11H18C18.11,8.19 18.73,5.42 19.81,2.82L18,2.06C16.81,4.9 16.13,7.92 16,11H8C7.87,7.92 7.19,4.9 6,2.06L4.14,2.82C5.24,5.41 5.87,8.18 6,11H4V13H6C5.89,15.81 5.27,18.58 4.19,21.18L6,21.94C7.19,19.1 7.87,16.08 8,13H16C16.13,16.08 16.81,19.1 18,21.94L19.86,21.18C18.76,18.59 18.13,15.82 18,13H20V11Z"/></svg>"#,
    slug: "zodiac-pisces",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
...
/// zodiac-sagittarius
pub const ZODIAC_SAGITTARIUS: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-sagittarius" viewBox="0 0 24 24"><path d="M22,2V12H20V5.41L10.41,15L12.71,17.29L11.29,18.71L9,16.41L3.71,21.71L2.29,20.29L7.59,15L5.29,12.71L6.71,11.29L9,13.59L18.59,4H12V2H22Z"/></svg>"#,
...
/// zodiac-scorpio
pub const ZODIAC_SCORPIO: Icon = Icon {
    svg: r#"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-zodiac-scorpio" viewBox="0 0 24 24"><path d="M17.71,15.29L16.29,16.71L17.59,18H16A2,2 0 0,1 14,16V6A3,3 0 0,0 11,3C10.25,3 9.55,3.29 9,3.78C7.86,2.76 6.14,2.76 5,3.78C4.45,3.28 3.74,3 3,3V5A1,1 0 0,1 4,6V16H6V6A1,1 0 0,1 7,5A1,1 0 0,1 8,6V16H10V6A1,1 0 0,1 11,5A1,1 0 0,1 12,6V16A4,4 0 0,0 16,20H17.59L16.29,21.29L17.71,22.71L21.41,19L17.71,15.29Z"/></svg>"#,
    slug: "zodiac-scorpio",
    version: "2.6.95",
    deprecated: false,
    author: "Michael Richins",
