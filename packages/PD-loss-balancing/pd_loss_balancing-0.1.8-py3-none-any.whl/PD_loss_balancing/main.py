...
class LossWeighter(ABC):
    ...
    def get_combined_loss(self, loss1: float, loss2: float, alpha: float) -> float:
        ...
        Args:
            loss1: First loss value, increasing this loss should makes the reference value go up
            loss2: Second loss value, increasing this loss should makes the reference value go down
