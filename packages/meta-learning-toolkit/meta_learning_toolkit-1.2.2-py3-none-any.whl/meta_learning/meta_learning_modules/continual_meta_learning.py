...
2. Continual MAML with Elastic Weight Consolidation (Kirkpatrick et al., 2017)
...
Mathematical formulations follow the original research papers with
extensions based on cited improvements from the literature.
"""
