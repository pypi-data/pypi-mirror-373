...
from src.meta_learning.cli import *
        ...
        for strategy in strategies:
            ...
            configs = [
                TestTimeComputeConfig(
                    ...
                    base_compute_steps=1, max_compute_steps=3,
                    use_process_reward_model=False,
                    use_test_time_training=False,
                    use_chain_of_thought=False
                ),
                TestTimeComputeConfig(
                    compute_strategy=strategy,
                    base_compute_steps=5, max_compute_steps=20,
                ...
                TestTimeComputeConfig(
                    compute_strategy=strategy,
                    base_compute_steps=3, max_compute_steps=15,
                ...
                TestTimeComputeConfig(
                    compute_strategy=strategy,
                    base_compute_steps=2, max_compute_steps=12,
                ...
                TestTimeComputeConfig(
                    compute_strategy=strategy,
                    base_compute_steps=4, max_compute_steps=25,
