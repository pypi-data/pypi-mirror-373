...
class BaseTcpClient(ABC):
    ...
    def _log_jobmanager_connection_help(self):
        ...
        self.logger.error(f"      启动命令: sage jobmanager start --host {self.host} --port {self.port}")
        ...
        self.logger.error("📚 更多信息：https://intellistream.github.io/SAGE-Pub/kernel/jobmanager/")
