            ...
            if mechanism == "a":
                ...
                if len(a_records) == 0:
                    raise _SPFMissingRecords(
                        f"The a mechanism points to {value.lower()}, but that domain/subdommain does not have any A/AAAA records"
                    )
                ...
                if len(mx_hosts) == 0:
                    raise _SPFMissingRecords(
                        f"The mx mechanism points to {value.lower()},  but that domain/subdommain does not have any MX records"
                    )
                if len(mx_hosts) > 10:
