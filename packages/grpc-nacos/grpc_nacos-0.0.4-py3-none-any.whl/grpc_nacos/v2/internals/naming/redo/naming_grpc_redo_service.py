...
from .naming_redo_data import NamingRedoData
from ..util.naming_client_util import get_group_name, \
	get_service_cache_key
from ...redo.abstract_redo_service import AbstractRedoService
from ...redo.redo_data import RedoData, RedoType
...
class NamingGrpcRedoService(AbstractRedoService):
	...
	def __init__(self, client_proxy):
		...
		from ..remote.naming_grpc_client_proxy import \
