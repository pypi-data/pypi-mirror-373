...
async def basic_example():
    ...
    async with BedrockRegionBalancer(
        default_model="claude-3.7-sonnet"  # Set default model
    ) as balancer:
...
async def bedrock_api_key_example():
    ...
    if not api_key:
        ...
        print("Set AWS_BEARER_TOKEN_BEDROCK or BEDROCK_API_KEY environment variable to test this")
        return
...
async def custom_regions_example():
    ...
    async with BedrockRegionBalancer(
        ...
        # Example with Claude 3.7 Sonnet (using short name)
...
async def main():
    """Run all examples."""
    print("Bedrock Region Balancer - Basic Usage Examples")
    print("=" * 50)
    print()
