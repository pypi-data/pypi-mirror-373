...
class AggregationsGroup(BaseModel):
    """
    Aggregations response containing additional metadata or statistics related to the response.
    """ # noqa: E501
    group_name: StrictStr
    aggregations: Dict[str, Aggregation]
    __properties: ClassVar[List[str]] = ["group_name", "aggregations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AggregationsGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AggregationsGroup from a dict"""
        if obj is None:
            return None
