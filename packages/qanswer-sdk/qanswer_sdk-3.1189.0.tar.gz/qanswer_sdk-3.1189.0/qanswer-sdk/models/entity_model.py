...
class EntityModel(BaseModel):
    ...
    EntityModel
    """ # noqa: E501
    relation_name: Optional[StrictStr] = None
    object_entity: Optional[StrictStr] = None
    sources: Optional[List[Source]] = None
    __properties: ClassVar[List[str]] = ["relation_name", "object_entity", "sources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "object_entity": obj.get("object_entity"),
