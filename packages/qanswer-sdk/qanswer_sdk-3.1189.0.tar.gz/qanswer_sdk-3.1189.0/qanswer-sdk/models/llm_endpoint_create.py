...
class LLMEndpointCreate(BaseModel):
    ...
    name: StrictStr
    __properties: ClassVar[List[str]] = ["modality", "provider", "api_version", "aws_access_key_id", "aws_secret_access_key", "aws_region_name", "description", "onpremise", "sensitivity_label", "guardrail", "retry_params", "extra_body", "tags", "display_name", "engine", "api_key", "endpoint_url", "rag_params", "generation_params", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LLMEndpointCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LLMEndpointCreate from a dict"""
        if obj is None:
            return None
