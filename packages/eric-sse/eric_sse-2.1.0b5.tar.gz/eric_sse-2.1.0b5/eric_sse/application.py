...
class ApplicationTemplate(ABC):
    ...
    def boot(self) -> dict[str, AbstractChannel]:
        ...
        connection_repository = self._channel_repository.connections_repository
    ...
    def _save_connection(self, connection: Connection):
        self._channel_repository.connections_repository.persist(connection)
        self._channel_repository.connections_repository.listeners_repository.persist(connection.id, connection.listener)
        self._channel_repository.connections_repository.queues_repository.persist(connection.id, connection.queue)

    def delete_channel(self, channel_id: str):
        self._channel_repository.delete(channel_id)
        for connection in self._channel_repository.connections_repository.load_all(channel_id):
    ...
    def unsubscribe_channel(self, channel_id: str, connection_id: str):
        channel = self._channel_repository.load_one(channel_id=channel_id)
        connection = self._channel_repository.connections_repository.load_one(connection_id=connection_id)
    ...
    def _delete_connection(self, connection_id: str):
        self._channel_repository.connections_repository.listeners_repository.delete(connection_id=connection_id)
        self._channel_repository.connections_repository.queues_repository.delete(connection_id=connection_id)
        self._channel_repository.connections_repository.delete(connection_id)
