...
message Response { string status=1; string message=2; bytes data=3; }https://chatgpt.com/c/68a35293-1a34-832b-9bec-09e0513a52e3
message Empty {}
'''
    server = '''
...
class {app}Client:
    ...
    def __init__(self, host="localhost", port=50051):
        ...
        self.stub = CatalogService_pb2_grpc.CatalogServiceStub(self.channel)
...
@cli.command()
@click.argument('name')
def generated_proto_files(name: str):
