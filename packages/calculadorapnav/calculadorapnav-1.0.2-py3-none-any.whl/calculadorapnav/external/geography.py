...
from calculadorapnav.core.cloud import get_env_cloud_details
...
class CloudMetadata:
    ...
    def is_on_private_infra(self) -> bool:
        return self.provider is None or self.region is None
...
class GeoMetadata:
    ...
    def from_geo_js(cls, url: str) -> "GeoMetadata":
        ...
        try:
            ...
            logger.warning(
                f"Unable to access geographical location. Using 'España' as the default value - Exception : {e} - url={url}"
            )
