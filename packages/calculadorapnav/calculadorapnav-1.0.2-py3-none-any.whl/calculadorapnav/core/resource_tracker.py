...
from calculadorapnav.core import cpu, gpu, powermetrics
from calculadorapnav.core.config import parse_gpu_ids
from calculadorapnav.core.util import detect_cpu_model, is_linux_os, is_mac_os, is_windows_os
...
class ResourceTracker:
    ...
    def set_RAM_tracking(self):
        ...
        ram = RAM(tracking_mode=self.tracker._tracking_mode, type_ram=self.tracker._type_ram)
