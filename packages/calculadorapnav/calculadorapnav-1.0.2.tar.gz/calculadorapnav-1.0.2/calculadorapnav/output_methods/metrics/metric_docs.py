"""_summary_
This module contains the documentation for the metrics that are used in the calculadorapnav package.
Goal is to provide a common place to generate the metrics with the same information.

Example of how to use it:
    ```python
    from calculadorapnav.output_methods.metrics.metric_docs import duration_doc
