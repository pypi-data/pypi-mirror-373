...
# https://github.com/vllm-project/vllm/tree/main/vllm/entrypoints/openai/reasoning_parsers
...
class ReasoningParser:
    ...
    def extract_reasoning_content(
        ...
        raise NotImplementedError(
            "AbstractReasoningParser.extract_reasoning_calls " "has not been implemented!"
        )
