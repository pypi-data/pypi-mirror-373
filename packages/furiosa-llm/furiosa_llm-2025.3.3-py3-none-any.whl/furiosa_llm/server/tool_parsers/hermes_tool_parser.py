...
class Hermes2ProToolParser(ToolParser):
    ...
    def extract_tool_calls_streaming(
        ...
        try:
            ...
            cur_arguments = current_tool_call.get("arguments")  # type: ignore
            ...
            if self.current_tool_id == len(self.prev_tool_call_arr) - 1:
                self.prev_tool_call_arr[self.current_tool_id] = current_tool_call  # type: ignore
            else:
                self.prev_tool_call_arr.append(current_tool_call)  # type: ignore
