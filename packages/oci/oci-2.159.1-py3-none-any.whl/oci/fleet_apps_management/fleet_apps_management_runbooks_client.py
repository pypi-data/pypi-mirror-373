...
class FleetAppsManagementRunbooksClient(object):
    ...
    def change_runbook_compartment(self, runbook_id, change_runbook_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/change_runbook_compartment.py.html>`__ to see an example of how to use change_runbook_compartment API.
        """
    ...
    def change_task_record_compartment(self, task_record_id, change_task_record_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/change_task_record_compartment.py.html>`__ to see an example of how to use change_task_record_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_runbook(self, create_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/create_runbook.py.html>`__ to see an example of how to use create_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_runbook_version(self, create_runbook_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/create_runbook_version.py.html>`__ to see an example of how to use create_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_task_record(self, create_task_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/create_task_record.py.html>`__ to see an example of how to use create_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_runbook(self, runbook_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/delete_runbook.py.html>`__ to see an example of how to use delete_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
    ...
    def delete_runbook_version(self, runbook_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/delete_runbook_version.py.html>`__ to see an example of how to use delete_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_task_record(self, task_record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/delete_task_record.py.html>`__ to see an example of how to use delete_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['taskRecordId']
    ...
    def get_runbook(self, runbook_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/get_runbook.py.html>`__ to see an example of how to use get_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
        resource_path = "/runbooks/{runbookId}"
    ...
    def get_runbook_version(self, runbook_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/get_runbook_version.py.html>`__ to see an example of how to use get_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookVersionId']
        resource_path = "/runbookVersions/{runbookVersionId}"
    ...
    def get_task_record(self, task_record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/get_task_record.py.html>`__ to see an example of how to use get_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['taskRecordId']
        resource_path = "/taskRecords/{taskRecordId}"
    ...
    def list_runbook_versions(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/list_runbook_versions.py.html>`__ to see an example of how to use list_runbook_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/runbookVersions"
    ...
    def list_runbooks(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/list_runbooks.py.html>`__ to see an example of how to use list_runbooks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/runbooks"
    ...
    def list_task_records(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/list_task_records.py.html>`__ to see an example of how to use list_task_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/taskRecords"
    ...
    def publish_runbook(self, publish_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/publish_runbook.py.html>`__ to see an example of how to use publish_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def set_default_runbook(self, set_default_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/set_default_runbook.py.html>`__ to see an example of how to use set_default_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_runbook(self, runbook_id, update_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/update_runbook.py.html>`__ to see an example of how to use update_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
        resource_path = "/runbooks/{runbookId}"
    ...
    def update_runbook_version(self, runbook_version_id, update_runbook_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/update_runbook_version.py.html>`__ to see an example of how to use update_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookVersionId']
        resource_path = "/runbookVersions/{runbookVersionId}"
    ...
    def update_task_record(self, task_record_id, update_task_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.1/fleetappsmanagement/update_task_record.py.html>`__ to see an example of how to use update_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['taskRecordId']
        resource_path = "/taskRecords/{taskRecordId}"
