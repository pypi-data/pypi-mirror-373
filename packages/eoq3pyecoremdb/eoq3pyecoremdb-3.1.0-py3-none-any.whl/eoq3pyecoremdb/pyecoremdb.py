'''
 ...
 This file is generated form: pyecoremdb.py.mako on 2025-08-29 10:49:55.713129 by calling E:/1_ILS/Projects/2025_IlsHackathon/Repos/hackathon/pyeoq/eoq3conceptsgen/generatefromconceptscli.py -i pyecoremdb.py.mako -o ../pyecoremdb.py -d pyecoremdb.prev.json.
...
#         self.__PreventMetaMetaAccess(target,False)
    ...
    #@generate comment no
    #@generate body no
    def _UpdateM1ObjectName(self, eObj:EObject, value:STR, ePosition:int) -> (STR,NON,NON,NON):
        """Update the property Name of M1Object
        ...
        Returns:
            ...
            oldOwner:Obj (optional) the old owner of an object element
            oldComposition:Obj (optional) the old composition of an object element 
            oldPosition:INT (optional) the old position of the element in an composition
            
        """
        eValue = self.__ValidateType(value, STR, M1OBJECT.NAME, True).GetVal()
        eOldValue = eObj._CON_name
        eObj._CON_name = eValue
        oldValue = InitValOrNon(eOldValue, STR)
        return (oldValue,NON(),NON(),NON())
        #end _UpdateM1ObjectName
...
#                     if(removedM1Feature): self.__DelM1Compo(m1Feature,True)
    ...
    def __InitConceptsUpdateHandlerTable(self):
        ...
        handlerTable[GetConceptKeyString(CONCEPTS.M1OBJECT)] = {}
        handlerTable[GetConceptKeyString(CONCEPTS.M1OBJECT)][GetConceptKeyString(M1OBJECT.NAME)] = self._UpdateM1ObjectName
