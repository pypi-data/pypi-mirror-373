...
class PyEcoreMdb(Mdb):
    ...
    def _CreatePackage(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateClass(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateAttribute(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateAssociation(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateComposition(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateInheritance(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateEnum(self, createArgs:LST, target:Obj) -> Obj:
    ...
    def _CreateEnumoption(self, createArgs:LST, target:Obj) -> Obj:
...
#                 classes.append(self.classIdCache[classNameOrId])
    ...
    ## READ
    # UNIVERSAL
    def _ReadAnyName(self,eObj : EObject,eContext : EObject) -> STR:
    ...
    # ROOT
    def _ReadRootRoot(self,eObj : EObject,eContext : EObject) -> Obj:
        return self.__Enc(self.root)
    
    def _ReadRootOrphans(self,eObj : EObject,eContext : EObject):
        return LST([self.__Enc(m) for m in self.orphans])
    
    # ELEMENT
    def _ReadElementClass(self,eObj : EObject,eContext : EObject) -> Obj:
    ...
    def _ReadElementParent(self,eObj : EObject,eContext : EObject) -> LST:  
    ...
    def _ReadClassAttributes(self,eObj : EClass,eContext : EObject)  -> LST:
        mask = lambda e: EAttribute==type(e)
        return self.__EncCollection(eObj.eStructuralFeatures, mask)
    
    def _ReadClassAllAttributes(self,eObj : EClass,eContext : EObject) -> LST:
    ...
    def _ReadClassAssociations(self,eObj : EClass,eContext : EObject)  -> LST:
        mask = lambda e: isinstance(e,EReference) and not e.containment
        return self.__EncCollection(eObj.eStructuralFeatures, mask)
    
    def _ReadClassAllAssociations(self,eObj : EClass,eContext : EObject)  -> LST:
        return  LST([self.__Enc(x) for x in eObj.eAllReferences() if not x.containment])
    
    def _ReadClassCompositions(self,eObj : EClass,eContext : EObject)  -> LST:
        mask = lambda e: isinstance(e,EReference) and e.containment
        return self.__EncCollection(eObj.eStructuralFeatures, mask)
    
    def _ReadClassAllCompositions(self,eObj : EClass,eContext : EObject)  -> LST:
        return  LST([self.__Enc(x) for x in eObj.eAllReferences() if x.containment])
    
    def _ReadClassSupertypes(self,eObj : EClass,eContext : EObject)  -> LST:
        return self.__EncCollection(eObj.eSuperTypes)
    
    def _ReadClassAllSupertypes(self,eObj : EClass,eContext : EObject)  -> LST:
        return self.__EncCollection(eObj.eAllSuperTypes())
    
    def _ReadClassSubtypes(self,eObj : EClass,eContext : EObject)  -> LST:
    ...
    def _ReadClassAllSubtypes(self,eObj : EClass,eContext : EObject)  -> LST:
    ...
    def _ReadClassInstances(self,eObj : EClass, eContext : EObject)  -> LST:
        instances = []
    ...
    ## PACKAGE
    def _ReadPackageId(self,eObj : EPackage, eContext : EObject)  -> STR:
        return InitValOrNon(eObj.nsURI,STR) #because that can also be None
    
    def _ReadPackageClasses(self,eObj : EPackage, eContext : EObject)  -> LST:
        mask = lambda e: EClass == type(e)
        return self.__EncCollection(eObj.eClassifiers,mask)
    
    def _ReadPackageEnums(self,eObj : EPackage, eContext : EObject)  -> LST:
    ...
    ## ATTRIBUTE
    def _ReadAttributeType(self,eObj: EAttribute, eContext : EObject)  -> Obj or STR:
        eType = eObj.eType
    ...
    def _ReadAttributeLen(self,eObj: EAttribute, eContext : EObject)  -> I64:
        return I64(eObj.upperBound)
    
    def _ReadAttributeUnit(self,eObj : EObject,eContext : EObject) -> STR:
        return InitValOrNon(GetEAnnotation(eObj, EANNOTATION_SOURCES.UNIT, EANNOTATION_KEYS.UNIT),STR)
    
    ## ASSOCIATION
    def _ReadAssociationSrcName(self,eObj: EReference, eContext : EObject)  -> I64:
        if(eObj.isOpposite):
    ...
    def _ReadAssociationDstName(self,eObj: EReference, eContext : EObject)  -> I64:
        if(not eObj.isOpposite):
            return STR(eObj.name)
        else:
            return STR(eObj.eOpposite.name)
        
    def _ReadAssociationSrcSafeName(self,eObj: EReference, eContext : EObject)  -> I64:
        if(eObj.isOpposite):
    ...
    def _ReadAssociationDstSafeName(self,eObj: EReference, eContext : EObject)  -> I64:
        if(not eObj.isOpposite):
            return self._ReadFeatureSafeName(eObj, eContext)
        else:
            return self._ReadFeatureSafeName(eObj.eOpposite, eContext)
    
    def _ReadAssociationSrcType(self,eObj: EReference, eContext : EObject)  -> Obj:
        if(eObj.isOpposite):
    ...
    def _ReadAssociationDstType(self,eObj: EReference, eContext : EObject)  -> Obj:
        eType = None
        if(not eObj.isOpposite):
            eType = eObj.eType
        elif(eObj.eOpposite):
    ...
    def _ReadAssociationSrcMul(self,eObj: EReference, eContext : EObject)  -> I64:
        if(eObj.isOpposite):
            return I64(eObj.upperBound)
        elif(eObj.eOpposite):
    ...
    def _ReadAssociationDstMul(self,eObj: EReference, eContext : EObject)  -> I64:
        if(not eObj.isOpposite):
            return I64(eObj.upperBound)
        else:
            return I64(eObj.eOpposite.upperBound)    
    ...
    ## COMPOSITION
    def _ReadCompositionType(self,eObj: EReference, eContext : EObject)  -> Obj:
        eType = eObj.eType
        return self.__Enc(eType)
        
    def _ReadCompositionLen(self,eObj: EReference, eContext : EObject)  -> I64:
        return I64(eObj.upperBound)
        
    ## ENUM
    def _ReadEnumOptions(self,eObj: EEnum, eContext : EObject)  -> LST:
        return self.__EncCollection(eObj.eLiterals)

    ## ENUMOPTION
    def _ReadEnumoptionValue(self,eObj : EEnumLiteral,eContext : EObject) -> I64:
