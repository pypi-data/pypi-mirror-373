...
public:
  ...
  Polyhedron(const std::vector<std::vector<double>> &vertices,
             const std::vector<std::vector<int>> &facets);
  Polyhedron(const py::list vertices, const py::list facets);
  Polyhedron(const py::array_t<double> vertices, const py::array_t<int> facets);
  ~Polyhedron();
};
...
public:
  ...
  void transform(double m11, double m12, double m13, double m21, double m22,
