...
PYBIND11_MODULE(TKernel, m) {
  ...
  py::class_<Standard_Transient, opencascade::handle<Standard_Transient>>(
  ...
  py::class_<Standard_Type, opencascade::handle<Standard_Type>,
             Standard_Transient>(m, "Standard_Type")
