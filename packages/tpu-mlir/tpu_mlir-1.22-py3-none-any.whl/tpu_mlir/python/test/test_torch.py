...
from tpu_mlir.python.tools.model_runner import mlir_inference, model_inference, torch_inference, show_fake_cmd
from tpu_mlir.python.tools.npz_tool import npz_compare
from tpu_mlir.python.tools.model_transform import *
from tpu_mlir.python.utils.mlir_shell import *
from tpu_mlir.python.utils.auto_remove import clean_kmp_files
from tpu_mlir.python.utils.timer import Timer
from tpu_mlir.python.utils.regression_logger import run_in_log_wrapper
import os
...
class TORCH_IR_TESTER(object):
    ...
    def user_define_net(self):
        ...
        from tpu_mlir.python.tools.train.test_model import test_model1
        model = test_model1()
        self.trace_and_test([(batch_size, 3, 224, 224)], model)

        print('start test test_model2')
        from tpu_mlir.python.tools.train.test_model import test_model2
        model = test_model2()
        self.trace_and_test([(batch_size, 3, 224, 224)], model)
        ...
        from tpu_mlir.python.tools.train.test_model import test_model4
        model = test_model4()
        self.trace_and_test([(batch_size, 3, 224, 224)], model)
