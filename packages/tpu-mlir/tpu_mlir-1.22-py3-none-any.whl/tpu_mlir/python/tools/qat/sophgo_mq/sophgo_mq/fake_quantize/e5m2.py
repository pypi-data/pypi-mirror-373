...
from tpu_mlir.python.tools.qat.sophgo_mq.FP8_Emulator.pytquant.cpp import fpemu_cpp
if torch.cuda.is_available():
    from tpu_mlir.python.tools.qat.sophgo_mq.FP8_Emulator.pytquant.cuda import fpemu_cuda
