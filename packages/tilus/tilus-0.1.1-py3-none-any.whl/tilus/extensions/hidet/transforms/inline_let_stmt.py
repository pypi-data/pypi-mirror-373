...
from hidet.ir.expr import Add, Call, Constant, Expr, Sub, Var
...
from hidet.ir.type import ArrayType, FuncType, TensorPointerType, TensorType
from hidet.transforms import FunctionPass, Pass, RepeatFunctionPass
...
def inline_let_stmt_pass(inline_factor: int = 1, inline_all: bool = False) -> Pass:
    if inline_all:
