...
import warnings
from jaygoga_orchestra.v1.experimental.evaluation.experiment import ExperimentResults, ExperimentRunner
...
def run_experiment(dataset: list[dict[str, Any]], squad: Squad | None = None, agents: list[Agent] | None = None, verbose: bool = False) -> ExperimentResults:
    runner = ExperimentRunner(dataset=dataset)

    return runner.run(agents=agents, squad=squad, print_summary=verbose)
