...
from vector_bridge.schema.helpers.enums import (DataTypeInput, FilterKey,
                                                FilterOperator, PropertyKey)
...
class VectorDBChangesetAdmin:
    ...
    def get_changeset_diff(self, integration_name: Optional[str] = None) -> List[StateFullSchema]:
        """
    ...
    def delete_schema(self, schema_name: str, integration_name: Optional[str] = None) -> List[StateFullSchema]:
        """
