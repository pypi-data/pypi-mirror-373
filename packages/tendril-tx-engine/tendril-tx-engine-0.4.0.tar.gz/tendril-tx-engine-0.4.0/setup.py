...
setup(
    name='tendril-tx-engine',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Template for Twisted Services for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-tx-engine',
    project_urls={
        'Documentation': 'https://tendril-tx-engine.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-tx-engine/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-tx-engine',
    },
