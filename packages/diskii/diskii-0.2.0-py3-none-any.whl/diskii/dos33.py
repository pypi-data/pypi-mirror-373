...
class DOSTrackSectorList:
    ...
    def __init__(self, image: DOSImage, track: int, sector: int):
        self.image = image
        self.track = track
        self.sector = sector
...
class DOSVTOC:
    ...
    def __init__(self, image: DOSImage):
        self.image = image
    ...
    def _parse_vtoc(self) -> None:
        ...
        # Byte 6: Number of sectors per track (normally 16)
...
class DOSCatalog:
    ...
    def _parse_catalog_entry(self, entry_data: bytes) -> DOSFileEntry | None:
        ...
        dos_type = dos_type_map.get(file_type_bits, "B")  # Default to binary if not found
        ...
        # This is approximate because DOS 3.3 doesn't store exact byte count
...
def parse_dos33_catalog(image: DOSImage) -> DOSCatalog:
