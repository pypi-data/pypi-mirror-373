...
from ibm_watsonx_gov.config.agentic_ai_configuration import AgenticAIConfiguration
...
class AgenticApp(BaseModel):
    ...
    The metrics to be computed at the agent or interaction level should be specified in the metrics_configuration and the metrics to be computed for the node level should be specified in the nodes list.
