...
- **`init`** - Comprehensive session initialization including:
  - Global workspace verification at `~/Projects/claude/`
  - UV dependency synchronization
  - Session management setup with auto-checkpoints
  - Project context analysis and maturity scoring
...
This server integrates with the global Claude workspace automation system at `~/Projects/claude/`:
- **Session Management**: `~/Projects/claude/toolkits/session/`
- **Verification Tools**: `~/Projects/claude/toolkits/verification/`
- **Structured Logging**: `~/Projects/claude/logs/`
...
- **Global workspace**: Verify `~/Projects/claude/` directory exists
