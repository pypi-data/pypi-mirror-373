    ...
    conversations = [
        {
            ...
            "metadata": {"type": "development", "language": "python", "framework": "flask"}
        },
        {
...
class TestBasicSearch:
    ...
    async def test_simple_text_search(self, search_engine, sample_data):
        ...
        auth_result = next((r for r in results['results'] if "authentication" in r.content.lower()), None)
...
class TestAdvancedSearch:
    ...
    async def test_sorting_options(self, search_engine, sample_data):
        ...
        relevance_ids = [r.content_id for r in relevance_results['results']]
        date_ids = [r.content_id for r in date_results['results']]
