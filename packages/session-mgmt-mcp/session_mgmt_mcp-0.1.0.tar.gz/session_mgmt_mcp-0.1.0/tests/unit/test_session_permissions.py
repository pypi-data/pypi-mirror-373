...
class TestSessionPermissionsManager:
    ...
    @pytest.mark.parametrize("frequency,expected_minutes", [
        (60, 1.0),
        (300, 5.0),
        (600, 10.0),
        (1800, 30.0),
    ...
    def test_checkpoint_frequency_conversion(self, permissions_manager, 
    ...
    def test_concurrent_access_thread_safety(self, permissions_manager):
        ...
        def trust_operations(start_index, count):
            try:
    ...
    def test_checkpoint_frequency_boundary_values(self, permissions_manager):
        ...
        # Test zero (invalid)
        result = permissions_manager.configure_auto_checkpoint(
            enabled=True, frequency=0
        )
        assert result is False
        
        # Test large value
        result = permissions_manager.configure_auto_checkpoint(
            enabled=True, frequency=86400  # 24 hours
        )
        assert result is True
