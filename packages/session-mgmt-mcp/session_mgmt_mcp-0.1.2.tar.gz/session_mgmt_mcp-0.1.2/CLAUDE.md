...
1. **server.py** (⚠️ 6397 lines - needs refactoring): Main MCP server implementation
   ...
   - **Critical Issue**: Monolithic structure violates single responsibility principle
...
⚠️ **Monolithic Structure**: server.py is 6397 lines - violates clean code principles and needs refactoring
