...
class DataLoader:
	...
	def __init__(self, mimic_path: Path, study_tables_list: Optional[List[TableNames]] = None, apply_filtering: bool = True, include_transfers: bool = False):
...
if __name__ == '__main__':
	# Example usage - replace with your actual MIMIC-IV path
	mimic_path = Path("/path/to/your/mimic-iv-data")
	loader = DataLoader(mimic_path=mimic_path, apply_filtering=True, include_transfers=True)
