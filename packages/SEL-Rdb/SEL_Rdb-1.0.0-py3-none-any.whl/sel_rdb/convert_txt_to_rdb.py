...
def create_rdb_file(input_txt_path, output_rdb_path, template_rdb_path):
    """
    Convert a relay settings text file to a valid SEL .rdb file with OLE2 structure
    by copying a template and modifying its contents
    """
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python convert_txt_to_rdb.py <input_txt_file> <output_rdb_file>")
        sys.exit(1)
