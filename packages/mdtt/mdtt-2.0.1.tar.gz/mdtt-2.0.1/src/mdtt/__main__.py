"""Main entry point for MDTT (MDx Dict Dev ToolKit) with subcommand architecture."""
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="mdtt",
        description="MDTT (MDx Dict Dev ToolKit) - A modern Python tool for packing and unpacking MDict dictionary files (.mdx/.mdd).",
