...
setup(
    ...
    description="Terminal executor for AI agents, with ANSI escape sequence support and image screenshots",  # Provide a short description
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/james4ever0/termexec",  # Replace with your project URL
