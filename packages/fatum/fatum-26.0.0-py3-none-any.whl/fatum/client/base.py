...
class BaseClient:
    ...
    def _get_client(self) -> httpx.AsyncClient:
        ...
        Notes
        -----
        The client is configured with the provided settings,
    ...
    def _create_retry_decorator(
        ...
        Examples
        --------
        >>> retrying = self._create_retry_decorator(max_attempts=5, max_wait=30.0)
        ...
        def should_retry_exception(exc: BaseException) -> bool:
            ...
            if isinstance(exc, ClientError) and exc.status_code is not None:
                return exc.status_code in retry_on_status or exc.status_code in RETRYABLE_STATUS_CODES
    ...
    async def _arequest(
        ...
        **kwargs : Any
        ...
        """
        retrying = self._create_retry_decorator(
