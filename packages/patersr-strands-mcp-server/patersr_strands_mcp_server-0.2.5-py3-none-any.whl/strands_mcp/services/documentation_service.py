...
class DocumentationService:
    ...
    def __init__(
        ...
        Args:
            cache_dir: Directory to store cached documentation (defaults to user cache dir)
        ...
        if cache_dir is None:
            import platformdirs
            cache_dir = str(Path(platformdirs.user_cache_dir("strands-mcp-server")) / "docs")
    ...
    async def _make_github_request(self, operation, *args, **kwargs):
        ...
        try:
            ...
            url = str(getattr(getattr(e, 'request', None), 'url', 'unknown'))
            ...
            try:
                ...
                if attempt == max_retries:
                    logger.error(
                        ...
                        extra={
                            "extra_fields": {
                                "operation": "exponential_backoff_retry",
                                "component": "documentation_service",
                                "attempt": attempt + 1,
    ...
    async def check_for_updates(self) -> bool:
        ...
        try:
            ...
            commit_info = await self._exponential_backoff_retry(
                _make_request, 
