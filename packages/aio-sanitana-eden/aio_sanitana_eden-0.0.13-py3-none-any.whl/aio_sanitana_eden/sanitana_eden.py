...
class SanitanaEdenSteam:
    ...
    def current_temperature(self) -> float:
        """Return the current temperature in degrees Celcius of the steam program."""
        return float(self._se._state.steam_temperature)

    @property
    def temperature(self) -> float:
        """Return the target temperature in degrees Celcius of the steam program."""
    ...
    def duration(self) -> float:
        """Return the duration in minutes of the steam program."""
        return float(self._duration)

    async def async_set_duration(self, duration: float) -> None:
        """Set the duration in minutes of the steam program."""
        self._duration = int(duration)

    async def async_set_temperature(self, temperature: float) -> None:
        """Set the target temperature in degrees Celcius of the steam program."""
        self._temperature = int(temperature)

    async def async_turn_on(self) -> None:
        """Turn on steam generator."""
        await self._se._write(b"n", self._temperature, self._duration)
