"""
Quadratic regression model wrapper.
"""
...
class Quadratic:
    """
    Simple wrapper for quadratic (polynomial degree 2) regression.
    
    Uses scikit-learn's PolynomialFeatures with LinearRegression
    to create quadratic models.
    ...
    def __init__(
        ...
        # Create pipeline with polynomial features (degree=2) and linear regression
        self.model = Pipeline([
    ...
    def fit(self, X: Union[np.ndarray, list], y: Union[np.ndarray, list]) -> 'Quadratic':
        """
    ...
    def __repr__(self) -> str:
        ...
        return f"Quadratic(fit_intercept={self.fit_intercept}, include_bias={self.include_bias}{split_info}) - {status}"