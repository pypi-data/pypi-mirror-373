...
def load_and_stack_by_age(
    ...
    from ..models.rating_model import load_control_models # Assuming control models load function exists
...
def run_dataset_generation_pipeline(dim_name=config.TARGET_DIMENSION, device=config.DEVICE):
    ...
    from ..models.rating_model import load_trust_model_ensemble, load_control_models # Need these functions
