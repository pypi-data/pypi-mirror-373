...
class AsyncFurhatClient:
    ...
    async def request_speak_audio(self, url: str, text: str = "AUDIO", speech: bool = True, abort: bool = False, wait: bool = False):
    ...
    async def request_listen_config(self, languages: list = ["en-US"]):
    ...
    async def request_listen_start(self, partial: bool = False, concat: bool = True, stop_silence_timeout: bool = True, stop_robot_start: bool = True, stop_user_end: bool = True, resume_robot_end: bool = False, silence_timeout: float = 8.0):
        """Make the robot listen for speech"""
        await self.send_event({
            "type": Events.request_listen_start,
            "partial": partial,
            "concat": concat,
            "stop_silence_timeout": stop_silence_timeout,
