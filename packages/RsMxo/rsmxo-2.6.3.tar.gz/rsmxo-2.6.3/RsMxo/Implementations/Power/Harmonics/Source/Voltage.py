...
class VoltageCls:
	...
	def set(self, source_voltage: enums.Source, power=repcap.Power.Default) -> None:
		...
		Snippet: driver.power.harmonics.source.voltage.set(source_voltage = enums.Source.C1, power = repcap.Power.Default) \n
	...
	def get(self, power=repcap.Power.Default) -> enums.Source:
		"""POWer<*>:HARMonics:SOURce[:VOLTage] \n
		Snippet: value: enums.Source = driver.power.harmonics.source.voltage.get(power = repcap.Power.Default) \n
		Sets the channel for the voltage source input of the power harmonics analysis. \n
			:param power: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Power')
