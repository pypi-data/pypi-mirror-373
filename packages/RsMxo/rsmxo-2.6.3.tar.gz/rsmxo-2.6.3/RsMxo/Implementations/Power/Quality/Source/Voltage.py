...
class VoltageCls:
	...
	def set(self, source_voltage: enums.Source, power=repcap.Power.Default) -> None:
		...
		Snippet: driver.power.quality.source.voltage.set(source_voltage = enums.Source.C1, power = repcap.Power.Default) \n
	...
	def get(self, power=repcap.Power.Default) -> enums.Source:
		"""POWer<*>:QUALity:SOURce[:VOLTage] \n
		Snippet: value: enums.Source = driver.power.quality.source.voltage.get(power = repcap.Power.Default) \n
		Selects the voltage source waveform. Active analog channels and math waveforms can be used. \n
			:param power: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Power')
