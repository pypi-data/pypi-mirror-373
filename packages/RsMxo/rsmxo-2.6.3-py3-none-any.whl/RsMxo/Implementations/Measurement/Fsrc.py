...
class FsrcCls:
	...
	def set(self, source: enums.Source, measIndex=repcap.MeasIndex.Default) -> None:
		"""MEASurement<*>:FSRC \n
		Snippet: driver.measurement.fsrc.set(source = enums.Source.C1, measIndex = repcap.MeasIndex.Default) \n
	...
	def get(self, measIndex=repcap.MeasIndex.Default) -> enums.Source:
		"""MEASurement<*>:FSRC \n
		Snippet: value: enums.Source = driver.measurement.fsrc.get(measIndex = repcap.MeasIndex.Default) \n
		Defines the first measurement source. The command is an alternative to method RsMxo.Measurement.Source.set. \n
			:param measIndex: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Measurement')
