...
[templates](https://gitlab.huc.knaw.nl/tt/text-fabric/tree/master/tf/browser/templates).
...
URL pattern | effect
--- | ---
`/browser/static/...` | serves a static file from the server-wide [static folder](https://gitlab.huc.knaw.nl/tt/text-fabric/tree/master/tf/browser/static)
...
*   the CSS loaded from the app dependent `extraApi`, used
    for pretty displays;
*   [index.css](https://gitlab.huc.knaw.nl/tt/text-fabric/blob/master/tf/browser/static/index.css):
    the formatting of the *index* web page with which the user interacts;
*   [export.css](https://gitlab.huc.knaw.nl/tt/text-fabric/blob/master/tf/browser/templates/export.css)
    the formatting of the export page;
*   [base.css](https://gitlab.huc.knaw.nl/tt/text-fabric/blob/master/tf/browser/templates/base.css)
    shared formatting between the index and export pages.

## JavaScript

We use a
[modest amount of JavaScript](https://gitlab.huc.knaw.nl/tt/text-fabric/blob/master/tf/browser/static/tf3.0.js)
on top of
