...
def chatbot_ui(bot: Callable[[str], str], height='300px'):
    # Output widget for chat messages
    chat_output = widgets.Output(layout=widgets.Layout(width='100%', height=height, border='1px solid black', overflow='auto'))
