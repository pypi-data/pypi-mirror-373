...
""")
        ...
        # Verify LHP created its own file in resources/lhp/dev/
        lhp_resource_file = self.project_root / "resources" / "lhp" / "dev" / "test_pipeline.pipeline.yml"
        ...
        # Should use glob pattern instead of individual notebook names
        assert "- glob:" in lhp_content
        assert "include: ../../generated/dev/test_pipeline/**" in lhp_content
