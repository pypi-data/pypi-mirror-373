...
class TestResourceSync:
    ...
    def test_sync_resources_with_special_characters_in_filenames(self):
        ...
        assert "include: ../../generated/dev/raw_ingestion/**" in content
        assert "root_path: ${workspace.file_path}/generated/dev/raw_ingestion" in content
...
""")
        ...
        assert "include: ../../generated/dev/lhp_pipeline/**" in lhp_content
...
""")
        ...
        assert "include: ../../generated/dev/new_pipeline/**" in new_content
...
"""
        ...
        assert "- glob:" in new_content
        assert "include: ../../generated/dev/active_pipeline/**" in new_content
