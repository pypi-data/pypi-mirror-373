...
def check_ai_readiness() -> Dict[str, Any]:
    ...
    try:
        ...
        # Check for Llama-Stack deployment
        ...
        return {
            ...
            "ai_ready": len(gpu_nodes) > 0 and llama_deployed and secrets_configured
        }
...
def check(
    ...
    if ai_status["llama_deployed"]:
        ...
        console.print("⚠️ Llama-Stack not deployed (deploy with: o8 llama deploy)")
