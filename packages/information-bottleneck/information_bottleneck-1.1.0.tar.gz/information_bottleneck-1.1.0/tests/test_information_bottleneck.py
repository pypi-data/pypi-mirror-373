#!/usr/bin/env python3
"""
Basic test suite for information-bottleneck
=====================================
...
class TestBasicFunctionality:
    ...
    def test_module_components(self):
        ...
        for component in information_bottleneck.__all__:
            assert hasattr(information_bottleneck, component), f"Missing component: {component}"
    ...
    def test_attribution_display(self):
        ...
        import importlib
        importlib.reload(information_bottleneck)
...
class TestModuleSpecific:
    ...
    def test_main_class_instantiation(self):
        ...
        try:
            ...
            main_classes = [getattr(information_bottleneck, name) for name in information_bottleneck.__all__ 
                           if hasattr(getattr(information_bottleneck, name), '__init__')]
    ...
    def test_version_format(self):
        ...
        version = information_bottleneck.__version__
