...
class ShippingServer(v1.ShippingBase):
    ...
    async def create(
        ...
        return await self.srv_stub.handle_request(
            current_tid, "Create", create_shipping_request
        )
    ...
    async def status(
        ...
        return await self.srv_stub.handle_request(
            current_tid, "Status", shipping_status_request
        )
    ...
    def set_create_response_creator(
        ...
        tid: str,
        creator: Callable[
            [v1.CreateShippingRequest],
            tuple[Optional[v1.CreateShippingResponse], Optional[Exception]],
        ],
    ):
    ...
    def set_status_response_creator(
        ...
        tid: str,
        creator: Callable[
            [v1.ShippingStatusRequest],
            tuple[Optional[v1.ShippingStatusResponse], Optional[Exception]],
        ],
    ):
