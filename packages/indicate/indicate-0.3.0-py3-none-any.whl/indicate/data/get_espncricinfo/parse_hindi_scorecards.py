...
with open("hindi_matches.json", "r") as matches_file:
    ...
    for match in hindi_matches:
        ...
        if "data" in hindi_json["props"]["pageProps"]:
            for team_players in hindi_json["props"]["pageProps"]["data"]["pageData"][
                "content"
                ...
                for player in team_players["players"]:
                    players.append(
                        {
                            "id": player["player"]["id"],
                            "hindi_name": player["player"]["name"],
                            "hindi_long_name": player["player"]["longName"],
                            "english_name": player["player"]["indexName"],
                            "gender": player["player"]["gender"],
                            "date_of_birth": player["player"]["dateOfBirth"],
                            "country_id": player["player"]["countryTeamId"],
