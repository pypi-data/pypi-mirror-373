...
with open('niemarkov/niemarkov.py') as f:
    NIEMARKOV_VERSION = [l for l in f if l.startswith('NIEMARKOV_VERSION = ')][0].split('=')[-1].replace("'",'').strip()
...
setup(
    ...
    keywords='python markov chain',  # Optional
