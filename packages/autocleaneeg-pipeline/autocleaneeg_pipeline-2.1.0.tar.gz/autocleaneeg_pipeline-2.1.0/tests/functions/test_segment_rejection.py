...
class TestAnnotateNoisySegments:
    ...
    @patch('autoclean.functions.segment_rejection.segment_rejection.mne.make_fixed_length_events')
    ...
    def test_basic_functionality(self, mock_epochs_class, mock_make_events, mock_raw):
        ...
        with patch('autoclean.functions.segment_rejection.segment_rejection._epochs_to_xr') as mock_xr, \
             patch('autoclean.functions.segment_rejection.segment_rejection._detect_outliers') as mock_detect:
...
class TestAnnotateUncorrelatedSegments:
    ...
    def test_basic_functionality(self, mock_epochs_class, mock_make_events, mock_raw):
        ...
        with patch('autoclean.functions.segment_rejection.segment_rejection._calculate_neighbor_correlations') as mock_calc, \
             patch('autoclean.functions.segment_rejection.segment_rejection._detect_outliers') as mock_detect:
...
class TestIntegration:
    ...
    def test_all_functions_work_together(self, mock_raw):
        ...
        with patch('autoclean.functions.segment_rejection.segment_rejection.mne.make_fixed_length_events') as mock_events, \
             patch('autoclean.functions.segment_rejection.segment_rejection.mne.Epochs') as mock_epochs_class, \
             patch('autoclean.functions.segment_rejection.segment_rejection._epochs_to_xr'), \
             patch('autoclean.functions.segment_rejection.segment_rejection._detect_outliers', return_value=np.array([])):
            ...
            with patch('autoclean.functions.segment_rejection.segment_rejection._calculate_neighbor_correlations'):
