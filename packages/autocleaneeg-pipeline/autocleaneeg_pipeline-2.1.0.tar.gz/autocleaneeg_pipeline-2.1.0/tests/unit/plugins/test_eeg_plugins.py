...
class TestEGIRawGSN129Plugin:
    ...
    def test_plugin_format_montage_support(self):
        ...
        assert plugin_class.supports_format_montage("EGI_RAW", "GSN-HydroCel-129") is True
        
        # Should not support incorrect combinations
        assert plugin_class.supports_format_montage("EEGLAB_SET", "GSN-HydroCel-129") is False
        assert plugin_class.supports_format_montage("EGI_RAW", "GSN-HydroCel-128") is False
        assert plugin_class.supports_format_montage("GENERIC_FIF", "standard_1020") is False
...
class TestEGIRawGSN124Plugin:
    ...
    def test_gsn124_plugin_support(self):
        ...
        assert plugin_class.supports_format_montage("EGI_RAW", "GSN-HydroCel-124") is True
        assert plugin_class.supports_format_montage("EGI_RAW", "GSN-HydroCel-129") is False
...
class TestEEGLABPlugins:
    ...
    def test_eeglab_set_plugin_support(self):
        ...
        assert plugin_class.supports_format_montage("EEGLAB_SET", "GSN-HydroCel-129") is True
        assert plugin_class.supports_format_montage("EGI_RAW", "GSN-HydroCel-129") is False
...
class TestStandard1020Plugin:
    ...
    def test_standard_1020_plugin_support(self):
        ...
        assert plugin_class.supports_format_montage("EEGLAB_SET", "standard_1020") is True
        assert plugin_class.supports_format_montage("GENERIC_FIF", "standard_1020") is True
