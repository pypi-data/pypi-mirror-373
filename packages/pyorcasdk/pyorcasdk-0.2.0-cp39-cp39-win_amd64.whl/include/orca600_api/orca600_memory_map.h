...
#define POS_SIGN                      152       // TUNING_SECTION       | Width: 1    | Determines which direction of shaft movement is the zero direction.
/***********************************************************
...
/***********************************************************
 * Non-contiguous addresses. 1 free registers. 170 - 170
 ***********************************************************/
#define ZERO_MODE                     171       // USER_OPTIONS_SECTION | Width: 1    | Selects the type of zeroing the motor should use.
#define AUTO_ZERO_FORCE_N             172       // USER_OPTIONS_SECTION | Width: 1    | The maximum force the auto-zeroing algorithm will use to move the motor. In Newtons.
#define AUTO_ZERO_EXIT_MODE           173       // USER_OPTIONS_SECTION | Width: 1    | Mode to enter after completing auto-zeroing.
#define MB_RS485_MODE                 174       // USER_OPTIONS_SECTION | Width: 1    | Controls whether RS485 mode is enabled for the Modbus interface.
...
/***********************************************************
 * Non-contiguous addresses. 5 free registers. 401 - 405
 ***********************************************************/
...
/***********************************************************
 * Non-contiguous addresses. 5 free registers. 413 - 417
 ***********************************************************/
#define STATOR_CONFIG                 418       // PARAM_SECTION        | Width: 1    | Physical stator configuration type.
/***********************************************************
 * Non-contiguous addresses. 12 free registers. 419 - 430
 ***********************************************************/
...
#define ILOOP_D0_HIGH_ID              771       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for rising edge digital 0
#define ILOOP_D0_LOW_ID               772       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for falling edge digital 0
#define ILOOP_D1_HIGH_ID              773       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for rising edge digital 1
#define ILOOP_D1_LOW_ID               774       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for falling edge digital 1
#define ILOOP_D2_HIGH_ID              775       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for rising edge digital 2
#define ILOOP_D2_LOW_ID               776       // CURRENT_LOOP_SECTION | Width: 1    | Kinematic motion id value for falling edge digital 2
/***********************************************************
