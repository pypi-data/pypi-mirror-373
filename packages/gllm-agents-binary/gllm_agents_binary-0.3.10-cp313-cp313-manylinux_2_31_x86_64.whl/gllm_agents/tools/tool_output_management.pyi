...
class ToolOutput:
    ...
    def get_data_preview(self, max_length: int = 200, storage_provider: BaseStorageProvider | None = None) -> str:
        ...
        Returns:
            A string representation of the data, truncated if necessary.
        """
...
class ToolOutputManager:
    ...
    def store_output(self, params: StoreOutputParams) -> None:
        ...
        is used multiple times, the previous output will be overwritten.

        Thread-safe: This method uses internal locking to ensure safe concurrent access.

        Args:
            params: StoreOutputParams containing all necessary parameters.

        Raises:
            Exception: If storage operation fails for any reason.
        """
    def get_output(self, call_id: str) -> ToolOutput | None:
        """Retrieve a stored tool output by its call ID.
    ...
    def has_outputs(self) -> bool:
        ...
        """
    def generate_summary(self, max_entries: int = 10) -> str:
        '''Generate an LLM-friendly summary with simple recent-first ordering and agent context.

        This method creates a concise, informative summary of stored outputs that
        can be included in LLM prompts. It uses a flat, recent-first structure with
        agent attribution for multi-agent workflows.
        ...
        Returns:
            A formatted string summarizing the available tool outputs, or "None"
            if no outputs are stored.
        '''
...
class ToolReferenceResolver:
    ...
    def __init__(self, config: ToolOutputConfig) -> None:
        ...
        Args:
            config: Configuration object defining operational parameters.
        """
    def resolve_references(self, args: dict[str, Any], manager: ToolOutputManager) -> dict[str, Any]:
