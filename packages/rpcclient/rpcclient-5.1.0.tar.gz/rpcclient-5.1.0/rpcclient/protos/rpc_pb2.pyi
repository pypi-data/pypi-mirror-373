...
class _ProtocolConstantsEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ProtocolConstants.ValueType], builtins.type):
    ...
    SERVER_VERSION: _ProtocolConstants.ValueType  # 143165456
...
SERVER_VERSION: ProtocolConstants.ValueType  # 143165456
...
class _ErrorCodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ErrorCode.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ERROR_UNKNOWN: _ErrorCode.ValueType  # 0
    ERROR_UNSUPPORTED_COMMAND: _ErrorCode.ValueType  # 1
    ERROR_MEMORY_ACCESS: _ErrorCode.ValueType  # 2
    ERROR_SPAWN_FAILED: _ErrorCode.ValueType  # 3
    ERROR_FILE_SYSTEM: _ErrorCode.ValueType  # 4

class ErrorCode(_ErrorCode, metaclass=_ErrorCodeEnumTypeWrapper): ...

ERROR_UNKNOWN: ErrorCode.ValueType  # 0
ERROR_UNSUPPORTED_COMMAND: ErrorCode.ValueType  # 1
ERROR_MEMORY_ACCESS: ErrorCode.ValueType  # 2
ERROR_SPAWN_FAILED: ErrorCode.ValueType  # 3
ERROR_FILE_SYSTEM: ErrorCode.ValueType  # 4
...
class Handshake(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["arch", b"arch", "client_id", b"client_id", "machine", b"machine", "magic", b"magic", "platform", b"platform", "sysname", b"sysname"]) -> None: ...
