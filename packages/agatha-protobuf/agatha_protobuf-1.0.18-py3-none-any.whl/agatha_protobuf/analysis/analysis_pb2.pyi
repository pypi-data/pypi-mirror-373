...
class CreateFeedbackRequest(_message.Message):
    __slots__ = ("_id", "scale", "analyze", "context", "build", "model")
    ...
    build: str
    model: str
    def __init__(self, _id: _Optional[str] = ..., scale: _Optional[str] = ..., analyze: _Optional[str] = ..., context: _Optional[str] = ..., build: _Optional[str] = ..., model: _Optional[str] = ...) -> None: ...
