...
class RandomTE:
    ...
    def parse_DEL_ucsc(self):
        ...
        self.DEL
        """
        logging.info(f"Parsing UCSC repeats annotation file: {self.DELfile}")
        self.DEL = []
    ...
    def parse_DEL_repeatmasker(self):
        ...
        self.DEL
        """
        logging.info(f"Parsing repeatmasker annotation file: {self.DELfile}")
        self.DEL = []
