...
#### OAuth authentication (using your own account)
   ...
   ```json
   {
     "mcpServers": {
       "gscServer": {
         "command": "/FULL/PATH/TO/mcp-gsc-main/.venv/bin/python",
         "args": ["-m", "mcp_gsc"],
         "cwd": "/FULL/PATH/TO/mcp-gsc-main",
         "env": {
...
#### Service account authentication
   ...
   **Important:** Replace all paths with the actual locations on your computer:
   ...
   - The `command` path should point to the Python executable inside your virtual environment
   - The `cwd` path should point to the root directory of the mcp-gsc project
   - The credentials path should point to your Google service account credentials JSON file
   
   Examples:
   - Mac: 
     - Python path: `/Users/yourname/Documents/mcp-gsc/.venv/bin/python`
     - Project directory: `/Users/yourname/Documents/mcp-gsc`
     - Credentials path: `/Users/yourname/Documents/mcp-gsc/service_account_credentials.json`
   - Windows: 
     - Python path: `C:\\Users\\yourname\\Documents\\mcp-gsc\\.venv\\Scripts\\python.exe`
     - Project directory: `C:\\Users\\yourname\\Documents\\mcp-gsc`
     - Credentials path: `C:\\Users\\yourname\\Documents\\mcp-gsc\\service_account_credentials.json`
