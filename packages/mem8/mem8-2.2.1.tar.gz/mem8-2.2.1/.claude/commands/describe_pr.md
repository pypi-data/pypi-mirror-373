...
1. **Read the PR description template:**
   ...
   - If it doesn't exist, inform the user that their `mem8` setup is incomplete and they need to create a PR description template at `thoughts/shared/pr_description.md`
