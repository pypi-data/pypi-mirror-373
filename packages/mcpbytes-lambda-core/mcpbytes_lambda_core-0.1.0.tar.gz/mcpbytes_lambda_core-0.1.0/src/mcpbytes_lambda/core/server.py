...
class MCPServer:
    ...
    Example:
        ...
        def lambda_handler(event, context):
            ...
            return mcp.handle(event, ApiGatewayAdapter(), headers=event.get("headers"))
    """
        ...
        *,
        ...
        try:
            ...
            rpc_error = self._protocol.build_error(
                request_id=None, code=-32603, message="Internal server error"
            )
        ...
        try:
            ...
            rpc_error = self._protocol.build_error(
                request_id=None, code=-32603, message=f"Internal error: {e}"
            )
            return adapter.from_core_response(rpc_error)
